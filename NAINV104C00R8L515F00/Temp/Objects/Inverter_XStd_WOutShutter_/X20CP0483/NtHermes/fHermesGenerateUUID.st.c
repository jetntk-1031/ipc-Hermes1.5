...
plcbit fHermesGenerateUUID(plcstring p_sUUID[37], struct DTStructure(* tyDTStructure), unsigned char a_usiMacAddr[6]){plcbit __AS__fHermesGenerateUUID=0;signed long zzIndex00001;signed long zzIndex00000;plcstring sTemp2[3]="";plcstring sTemp4[5]="";{
