...
#include "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/NtHermes/fHermesChkParamSBIQBIst.h"
#line 1 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fHermesChkParamSBIQBI.nodebug"
#line 3 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fHermesChkParamSBIQBI.st"
unsigned long fHermesChkParamSBIQBI(struct tyHermesSendBoardInfo(* tySendBoardInfo), struct tyHermesQueryBoardInfo(* tyQueryBoardInfo)){unsigned long __AS__fHermesChkParamSBIQBI=0;{

(__AS__fHermesChkParamSBIQBI=0);

if((((unsigned long)(unsigned char)((*(tyQueryBoardInfo)).tyAvl.bTopBarcode)==(unsigned long)(unsigned char)1))){

if((((unsigned long)(unsigned char)((*(tySendBoardInfo)).tyAvl.bTopBarcode)==(unsigned long)(unsigned char)1))){

if(((__AS__STRING_CMP(((*(tySendBoardInfo)).tyData.sTopBarcode),((*(tyQueryBoardInfo)).tyData.sTopBarcode))!=0))){

(__AS__fHermesChkParamSBIQBI=2769);

}
}else{
(__AS__fHermesChkParamSBIQBI=2770);
}
}else{
if((((unsigned long)(unsigned char)((*(tySendBoardInfo)).tyAvl.bTopBarcode)==(unsigned long)(unsigned char)1))){
...
if((((unsigned long)(unsigned char)((*(tyQueryBoardInfo)).tyAvl.bBottomBarcode)==(unsigned long)(unsigned char)1))){

if((((unsigned long)(unsigned char)((*(tySendBoardInfo)).tyAvl.bBottomBarcode)==(unsigned long)(unsigned char)1))){

if(((__AS__STRING_CMP(((*(tySendBoardInfo)).tyData.sBottomBarcode),((*(tyQueryBoardInfo)).tyData.sBottomBarcode))!=0))){

(__AS__fHermesChkParamSBIQBI=2771);

}
}else{
(__AS__fHermesChkParamSBIQBI=2772);
}
...
}imp1_else7_0:imp1_end7_0:imp1_end4_0:;return __AS__fHermesChkParamSBIQBI;}
#line 53 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fHermesChkParamSBIQBI.nodebug"

void __AS__ImplInitfHermesChkParamSBIQBI_st(void){}
...
__asm__(".ascii \"iecfile \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/NtHermes/fHermesChkParamSBIQBI.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/NtHermes/fHermesChkParamSBIQBI.st.c\\\" \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fHermesChkParamSBIQBI.st\\\"\\n\"");
