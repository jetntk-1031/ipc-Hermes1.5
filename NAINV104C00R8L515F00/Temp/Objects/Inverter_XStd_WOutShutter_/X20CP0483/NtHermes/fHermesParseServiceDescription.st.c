...
#include "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/NtHermes/fHermesParseServiceDescriptionst.h"
#line 1 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fHermesParseServiceDescription.nodebug"
#line 3 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fHermesParseServiceDescription.st"
plcbit fHermesParseServiceDescription(struct tyHermesServiceDescription(* p_tyServiceDescription), struct tyXMLTableDat(* tyXMLTableCurr), struct tyXMLTableDat(* tyXMLTableNxt), plcstring sCurrValueLowerCase[255]){plcbit __AS__fHermesParseServiceDescription=0;{

(__AS__fHermesParseServiceDescription=1);

if((((__AS__STRING_CMP(((*(tyXMLTableCurr)).sTitle),"AT")==0))&((__AS__STRING_CMP(sCurrValueLowerCase,"laneid")==0)))){

((*(p_tyServiceDescription)).tyAvl.bLaneId=1);

if(((__AS__STRING_CMP(((*(tyXMLTableNxt)).sTitle),"AV")==0))){
((*(p_tyServiceDescription)).tyData.iLaneId=str2int(((*(tyXMLTableNxt)).sValue)));
}

}else if((((__AS__STRING_CMP(((*(tyXMLTableCurr)).sTitle),"AT")==0))&((__AS__STRING_CMP(sCurrValueLowerCase,"machineid")==0)))){

((*(p_tyServiceDescription)).tyAvl.bMachineId=1);

if(((__AS__STRING_CMP(((*(tyXMLTableNxt)).sTitle),"AV")==0))){
{int zzIndex; plcstring* zzLValue=(plcstring*)((*(p_tyServiceDescription)).tyData.sMachineId); plcstring* zzRValue=(plcstring*)((*(tyXMLTableNxt)).sValue); for(zzIndex=0; zzIndex<80l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
}

}else if((((__AS__STRING_CMP(((*(tyXMLTableCurr)).sTitle),"AT")==0))&((__AS__STRING_CMP(sCurrValueLowerCase,"interfaceid")==0)))){

((*(p_tyServiceDescription)).tyAvl.bInterfaceId=1);

if(((__AS__STRING_CMP(((*(tyXMLTableNxt)).sTitle),"AV")==0))){
{int zzIndex; plcstring* zzLValue=(plcstring*)((*(p_tyServiceDescription)).tyData.sInterfaceId); plcstring* zzRValue=(plcstring*)((*(tyXMLTableNxt)).sValue); for(zzIndex=0; zzIndex<80l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
}

}else if((((__AS__STRING_CMP(((*(tyXMLTableCurr)).sTitle),"AT")==0))&((__AS__STRING_CMP(sCurrValueLowerCase,"version")==0)))){

((*(p_tyServiceDescription)).tyAvl.bVersion=1);

if(((__AS__STRING_CMP(((*(tyXMLTableNxt)).sTitle),"AV")==0))){
{int zzIndex; plcstring* zzLValue=(plcstring*)((*(p_tyServiceDescription)).tyData.sVersion); plcstring* zzRValue=(plcstring*)((*(tyXMLTableNxt)).sValue); for(zzIndex=0; zzIndex<7l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
}

}else if((((__AS__STRING_CMP(((*(tyXMLTableCurr)).sTitle),"ST")==0))&((__AS__STRING_CMP(sCurrValueLowerCase,"supportedfeatures")==0)))){

((*(p_tyServiceDescription)).tyAvl.bSupportedFeatures=1);

}else if((((__AS__STRING_CMP(((*(tyXMLTableCurr)).sTitle),"ST")==0))&((__AS__STRING_CMP(sCurrValueLowerCase,"featureboardforecast")==0)))){

((*(p_tyServiceDescription)).tyAvl.tySupportedFeatures.bFeatureBoardForecast=1);
((*(p_tyServiceDescription)).tyData.tySupportedFeatures.bFeatureBoardForecast=1);

}else if((((__AS__STRING_CMP(((*(tyXMLTableCurr)).sTitle),"ST")==0))&((__AS__STRING_CMP(sCurrValueLowerCase,"featurecheckaliveresponse")==0)))){

((*(p_tyServiceDescription)).tyAvl.tySupportedFeatures.bFeatureCheckAliveResponse=1);
((*(p_tyServiceDescription)).tyData.tySupportedFeatures.bFeatureCheckAliveResponse=1);

}else if((((__AS__STRING_CMP(((*(tyXMLTableCurr)).sTitle),"ST")==0))&((__AS__STRING_CMP(sCurrValueLowerCase,"featurequeryboardinfo")==0)))){

((*(p_tyServiceDescription)).tyAvl.tySupportedFeatures.bFeatureQueryBoardInfo=1);
((*(p_tyServiceDescription)).tyData.tySupportedFeatures.bFeatureQueryBoardInfo=1);

}else if((((__AS__STRING_CMP(((*(tyXMLTableCurr)).sTitle),"ST")==0))&((__AS__STRING_CMP(sCurrValueLowerCase,"featuresendboardinfo")==0)))){

((*(p_tyServiceDescription)).tyAvl.tySupportedFeatures.bFeatureSendBoardInfo=1);
((*(p_tyServiceDescription)).tyData.tySupportedFeatures.bFeatureSendBoardInfo=1);

}else if((((__AS__STRING_CMP(((*(tyXMLTableCurr)).sTitle),"ST")==0))&((__AS__STRING_CMP(sCurrValueLowerCase,"featurecommand")==0)))){

((*(p_tyServiceDescription)).tyAvl.tySupportedFeatures.bFeatureCommand=1);
((*(p_tyServiceDescription)).tyData.tySupportedFeatures.bFeatureCommand=1);
}

}imp1_else0_9:imp1_end0_0:;return __AS__fHermesParseServiceDescription;}
#line 69 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fHermesParseServiceDescription.nodebug"

void __AS__ImplInitfHermesParseServiceDescription_st(void){}
...
__asm__(".ascii \"iecfile \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/NtHermes/fHermesParseServiceDescription.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/NtHermes/fHermesParseServiceDescription.st.c\\\" \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fHermesParseServiceDescription.st\\\"\\n\"");
