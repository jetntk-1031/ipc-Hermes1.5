...
unsigned long fHermesChkParamSC(struct tyHermesSetConfiguration(* tySetConfiguration), plcstring sMachineId[81]){unsigned long __AS__fHermesChkParamSC=0;signed long zzIndex00001;signed long zzIndex00000;signed short a_iIPPart[4]={0, 0, 0, 0};signed short i=0;{
