...
#include "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/NtHermes/fbHermesSequenceUSst.h"
#line 1 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fbHermesSequenceUS.nodebug"
#line 3 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fbHermesSequenceUS.st"
void fbHermesSequenceUS(struct fbHermesSequenceUS* inst){struct fbHermesSequenceUS* __inst__=inst;{
...
if(__inst__->bProcessBoardForecastId){

(__inst__->eState=4);

}else if(((((unsigned long)(unsigned char)__inst__->bRdyRcv==(unsigned long)(unsigned char)1))&(((unsigned long)(unsigned char)__inst__->bBlkUS==(unsigned long)(unsigned char)0)))){

(__inst__->eMsgTypeSnd=9);

(__inst__->eState=6);

}else if((((unsigned long)(unsigned char)((*(__inst__->p_tyMsgTypeRcv)).bBoardAvailable)==(unsigned long)(unsigned char)1))){

((*(__inst__->p_tyMsgTypeRcv)).bBoardAvailable=0);

(__inst__->bBoardAvailable=1);
...
if(((((unsigned long)(unsigned char)__inst__->bRdyRcv==(unsigned long)(unsigned char)1))&(((unsigned long)(unsigned char)__inst__->bBlkUS==(unsigned long)(unsigned char)0)))){

(__inst__->eMsgTypeSnd=9);

(__inst__->eState=7);

}else if((((unsigned long)(unsigned char)((*(__inst__->p_tyMsgTypeRcv)).bRevokeBoardAvailable)==(unsigned long)(unsigned char)1))){

((*(__inst__->p_tyMsgTypeRcv)).bRevokeBoardAvailable=0);
...
if((__inst__->bProcessBoardForecastId&~__inst__->zzEdge00000&1?((__inst__->zzEdge00000=__inst__->bProcessBoardForecastId&1),1):((__inst__->zzEdge00000=__inst__->bProcessBoardForecastId&1),0))){

(__inst__->eMsgTypeSnd=10);

(__inst__->eState=4);

}else if(((((unsigned long)(unsigned char)__inst__->bRdyRcv==(unsigned long)(unsigned char)0))|(((unsigned long)(unsigned char)__inst__->bBlkUS==(unsigned long)(unsigned char)1)))){
...
if(((((unsigned long)(unsigned char)__inst__->bRdyRcv==(unsigned long)(unsigned char)0))|(((unsigned long)(unsigned char)__inst__->bBlkUS==(unsigned long)(unsigned char)1)))){
...
}else if(((((unsigned long)(unsigned char)__inst__->bRdyTransport==(unsigned long)(unsigned char)1))&(((unsigned long)(unsigned char)__inst__->bBlkUS==(unsigned long)(unsigned char)0)))){

(__inst__->eMsgTypeSnd=11);
...
if((__inst__->bRcvCompl|__inst__->bRcvIncompl|__inst__->bRcvNotStart)){

(__inst__->eMsgTypeSnd=12);
(__inst__->bStopTransport=(__inst__->bRcvIncompl|__inst__->bRcvNotStart));

(__inst__->eState=9);

}else if((((unsigned long)(unsigned char)((*(__inst__->p_tyMsgTypeRcv)).bTransportFinished)==(unsigned long)(unsigned char)1))){

((*(__inst__->p_tyMsgTypeRcv)).bTransportFinished=0);

(__inst__->eState=10);

}

if((((unsigned long)(unsigned char)((*(__inst__->p_tyMsgTypeRcv)).bBoardAvailable)==(unsigned long)(unsigned char)1))){
...
if((((unsigned long)(unsigned char)((*(__inst__->p_tyMsgTypeRcv)).bRevokeBoardAvailable)==(unsigned long)(unsigned char)1))){
...
if((((unsigned long)(unsigned char)((*(__inst__->p_tyMsgTypeRcv)).bTransportFinished)==(unsigned long)(unsigned char)1))){
...
(__inst__->bNotAvlNotRdy=(((signed long)__inst__->eState==(signed long)4)));
...
#line 207 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fbHermesSequenceUS.nodebug"

void __AS__ImplInitfbHermesSequenceUS_st(void){}
...
__asm__(".ascii \"iecfile \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/NtHermes/fbHermesSequenceUS.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/NtHermes/fbHermesSequenceUS.st.c\\\" \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fbHermesSequenceUS.st\\\"\\n\"");
