...
#include "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/NtHermes/fHermesGetTimestampst.h"
#line 1 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fHermesGetTimestamp.nodebug"
#line 3 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fHermesGetTimestamp.st"
plcbit fHermesGetTimestamp(plcstring p_sTimestamp[24], struct DTStructure(* tyDTStructure)){plcbit __AS__fHermesGetTimestamp=0;plcstring sMillisec[4]="";plcstring sSecond[3]="";plcstring sMinute[3]="";plcstring sHour[3]="";plcstring sDay[3]="";plcstring sMonth[3]="";plcstring sYear[5]="";{

(__AS__fHermesGetTimestamp=1);

__AS__MEMSET(((unsigned long)(p_sTimestamp)),0,24);
__AS__MEMSET(((unsigned long)(&sYear)),0,5);
__AS__MEMSET(((unsigned long)(&sMonth)),0,3);
__AS__MEMSET(((unsigned long)(&sDay)),0,3);
__AS__MEMSET(((unsigned long)(&sHour)),0,3);
__AS__MEMSET(((unsigned long)(&sMinute)),0,3);
__AS__MEMSET(((unsigned long)(&sSecond)),0,3);
__AS__MEMSET(((unsigned long)(&sMillisec)),0,4);


uint2str(((*(tyDTStructure)).year),sYear,5);

if((((unsigned long)(unsigned short)((*(tyDTStructure)).year)<(unsigned long)(unsigned short)10))){
__AS__MEMCPY((((unsigned long)(&sYear))+3),((unsigned long)(&sYear)),1);
__AS__MEMCPY(((unsigned long)(&sYear)),((unsigned long)(&"000")),3);
}else if((((unsigned long)(unsigned short)((*(tyDTStructure)).year)<(unsigned long)(unsigned short)100))){
__AS__MEMCPY((((unsigned long)(&sYear))+2),((unsigned long)(&sYear)),2);
__AS__MEMCPY(((unsigned long)(&sYear)),((unsigned long)(&"000")),2);
}else if((((unsigned long)(unsigned short)((*(tyDTStructure)).year)<(unsigned long)(unsigned short)1000))){
__AS__MEMCPY((((unsigned long)(&sYear))+1),((unsigned long)(&sYear)),3);
__AS__MEMCPY(((unsigned long)(&sYear)),((unsigned long)(&"000")),1);
}


usint2str(((*(tyDTStructure)).month),sMonth,3);

if((((unsigned long)(unsigned char)((*(tyDTStructure)).month)<(unsigned long)(unsigned char)10))){
__AS__MEMCPY((((unsigned long)(&sMonth))+1),((unsigned long)(&sMonth)),1);
__AS__MEMCPY(((unsigned long)(&sMonth)),((unsigned long)(&"0")),1);
}


usint2str(((*(tyDTStructure)).day),sDay,3);

if((((unsigned long)(unsigned char)((*(tyDTStructure)).day)<(unsigned long)(unsigned char)10))){
__AS__MEMCPY((((unsigned long)(&sDay))+1),((unsigned long)(&sDay)),1);
__AS__MEMCPY(((unsigned long)(&sDay)),((unsigned long)(&"0")),1);
}


usint2str(((*(tyDTStructure)).hour),sHour,3);

if((((unsigned long)(unsigned char)((*(tyDTStructure)).hour)<(unsigned long)(unsigned char)10))){
__AS__MEMCPY((((unsigned long)(&sHour))+1),((unsigned long)(&sHour)),1);
__AS__MEMCPY(((unsigned long)(&sHour)),((unsigned long)(&"0")),1);
}


usint2str(((*(tyDTStructure)).minute),sMinute,3);

if((((unsigned long)(unsigned char)((*(tyDTStructure)).minute)<(unsigned long)(unsigned char)10))){
__AS__MEMCPY((((unsigned long)(&sMinute))+1),((unsigned long)(&sMinute)),1);
__AS__MEMCPY(((unsigned long)(&sMinute)),((unsigned long)(&"0")),1);
}


usint2str(((*(tyDTStructure)).second),sSecond,3);

if((((unsigned long)(unsigned char)((*(tyDTStructure)).second)<(unsigned long)(unsigned char)10))){
__AS__MEMCPY((((unsigned long)(&sSecond))+1),((unsigned long)(&sSecond)),1);
__AS__MEMCPY(((unsigned long)(&sSecond)),((unsigned long)(&"0")),1);
}


uint2str(((*(tyDTStructure)).millisec),sMillisec,4);


__AS__MEMCPY((((unsigned long)(p_sTimestamp))+LEN(p_sTimestamp)),((unsigned long)(&sYear)),4);
__AS__MEMCPY((((unsigned long)(p_sTimestamp))+LEN(p_sTimestamp)),((unsigned long)(&"-")),1);
__AS__MEMCPY((((unsigned long)(p_sTimestamp))+LEN(p_sTimestamp)),((unsigned long)(&sMonth)),2);
__AS__MEMCPY((((unsigned long)(p_sTimestamp))+LEN(p_sTimestamp)),((unsigned long)(&"-")),1);
__AS__MEMCPY((((unsigned long)(p_sTimestamp))+LEN(p_sTimestamp)),((unsigned long)(&sDay)),2);
__AS__MEMCPY((((unsigned long)(p_sTimestamp))+LEN(p_sTimestamp)),((unsigned long)(&"T")),1);
__AS__MEMCPY((((unsigned long)(p_sTimestamp))+LEN(p_sTimestamp)),((unsigned long)(&sHour)),2);
__AS__MEMCPY((((unsigned long)(p_sTimestamp))+LEN(p_sTimestamp)),((unsigned long)(&":")),1);
__AS__MEMCPY((((unsigned long)(p_sTimestamp))+LEN(p_sTimestamp)),((unsigned long)(&sMinute)),2);
__AS__MEMCPY((((unsigned long)(p_sTimestamp))+LEN(p_sTimestamp)),((unsigned long)(&":")),1);
__AS__MEMCPY((((unsigned long)(p_sTimestamp))+LEN(p_sTimestamp)),((unsigned long)(&sSecond)),2);
__AS__MEMCPY((((unsigned long)(p_sTimestamp))+LEN(p_sTimestamp)),((unsigned long)(&".")),1);
__AS__MEMCPY((((unsigned long)(p_sTimestamp))+LEN(p_sTimestamp)),((unsigned long)(&sMillisec)),LEN(sMillisec));

}return __AS__fHermesGetTimestamp;}
#line 88 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fHermesGetTimestamp.nodebug"

void __AS__ImplInitfHermesGetTimestamp_st(void){}
...
__asm__(".ascii \"iecfile \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/NtHermes/fHermesGetTimestamp.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/NtHermes/fHermesGetTimestamp.st.c\\\" \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fHermesGetTimestamp.st\\\"\\n\"");
