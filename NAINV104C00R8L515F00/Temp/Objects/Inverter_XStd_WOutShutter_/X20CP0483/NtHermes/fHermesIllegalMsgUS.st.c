...
#include "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/NtHermes/fHermesIllegalMsgUSst.h"
#line 1 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fHermesIllegalMsgUS.nodebug"
#line 3 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fHermesIllegalMsgUS.st"
unsigned long fHermesIllegalMsgUS(eHermesState eState, struct tyHermesMsgType(* tyMsgType), plcbit bBoardAvailable){unsigned long __AS__fHermesIllegalMsgUS=0;{

switch(eState){

case 0:{(__AS__fHermesIllegalMsgUS=fHermesIllegalMsgNotConnectedUS(&((*(tyMsgType)))));
}break;case 2:{(__AS__fHermesIllegalMsgUS=fHermesIllegalMsgSrvcDescripUS(&((*(tyMsgType)))));
}break;case 4:{(__AS__fHermesIllegalMsgUS=fHermesIllegalMsgNotAvlNotRdyUS(&((*(tyMsgType)))));
}break;case 5:{(__AS__fHermesIllegalMsgUS=fHermesIllegalMsgBrdAvlUS(&((*(tyMsgType)))));
}break;case 6:{(__AS__fHermesIllegalMsgUS=fHermesIllegalMsgMcRdyUS(&((*(tyMsgType)))));
}break;case 7:{(__AS__fHermesIllegalMsgUS=fHermesIllegalMsgAvlAndRdyUS(&((*(tyMsgType)))));
}break;case 8:{(__AS__fHermesIllegalMsgUS=fHermesIllegalMsgTransportingUS(&((*(tyMsgType))),bBoardAvailable));
}break;case 10:{(__AS__fHermesIllegalMsgUS=fHermesIllegalMsgTransportFiniUS(&((*(tyMsgType)))));
}break;case 9:{(__AS__fHermesIllegalMsgUS=fHermesIllegalMsgTransportStopUS(&((*(tyMsgType))),bBoardAvailable));

}break;}

}imp1_case0_8:imp1_endcase0_0:;return __AS__fHermesIllegalMsgUS;}
#line 19 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fHermesIllegalMsgUS.nodebug"

void __AS__ImplInitfHermesIllegalMsgUS_st(void){}
...
__asm__(".ascii \"iecfile \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/NtHermes/fHermesIllegalMsgUS.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/NtHermes/fHermesIllegalMsgUS.st.c\\\" \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fHermesIllegalMsgUS.st\\\"\\n\"");
