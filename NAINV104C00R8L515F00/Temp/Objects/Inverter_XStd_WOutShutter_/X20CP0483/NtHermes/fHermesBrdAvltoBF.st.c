...
#include "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/NtHermes/fHermesBrdAvltoBFst.h"
#line 1 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fHermesBrdAvltoBF.nodebug"
#line 3 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fHermesBrdAvltoBF.st"
plcbit fHermesBrdAvltoBF(struct tyHermesBoardForecast(* tyHermesBoardForecast), struct tyHermesBoardAvailable(* tyHermesBoardAvailable)){plcbit __AS__fHermesBrdAvltoBF=0;{

(__AS__fHermesBrdAvltoBF=0);

{int zzIndex; plcstring* zzLValue=(plcstring*)((*(tyHermesBoardForecast)).tyData.sBoardId); plcstring* zzRValue=(plcstring*)((*(tyHermesBoardAvailable)).tyData.sBoardId); for(zzIndex=0; zzIndex<36l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
{int zzIndex; plcstring* zzLValue=(plcstring*)((*(tyHermesBoardForecast)).tyData.sBoardIdCreatedBy); plcstring* zzRValue=(plcstring*)((*(tyHermesBoardAvailable)).tyData.sBoardIdCreatedBy); for(zzIndex=0; zzIndex<80l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
((*(tyHermesBoardForecast)).tyData.eFailedBoard=((*(tyHermesBoardAvailable)).tyData.eFailedBoard));
{int zzIndex; plcstring* zzLValue=(plcstring*)((*(tyHermesBoardForecast)).tyData.sProductTypeId); plcstring* zzRValue=(plcstring*)((*(tyHermesBoardAvailable)).tyData.sProductTypeId); for(zzIndex=0; zzIndex<254l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
((*(tyHermesBoardForecast)).tyData.eFlippedBoard=((*(tyHermesBoardAvailable)).tyData.eFlippedBoard));
{int zzIndex; plcstring* zzLValue=(plcstring*)((*(tyHermesBoardForecast)).tyData.sTopBarcode); plcstring* zzRValue=(plcstring*)((*(tyHermesBoardAvailable)).tyData.sTopBarcode); for(zzIndex=0; zzIndex<254l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
{int zzIndex; plcstring* zzLValue=(plcstring*)((*(tyHermesBoardForecast)).tyData.sBottomBarcode); plcstring* zzRValue=(plcstring*)((*(tyHermesBoardAvailable)).tyData.sBottomBarcode); for(zzIndex=0; zzIndex<254l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
...
{int zzIndex; plcstring* zzLValue=(plcstring*)((*(tyHermesBoardForecast)).tyData.sWorkOrderId); plcstring* zzRValue=(plcstring*)((*(tyHermesBoardAvailable)).tyData.sWorkOrderId); for(zzIndex=0; zzIndex<80l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
{int zzIndex; plcstring* zzLValue=(plcstring*)((*(tyHermesBoardForecast)).tyData.sBatchId); plcstring* zzRValue=(plcstring*)((*(tyHermesBoardAvailable)).tyData.sBatchId); for(zzIndex=0; zzIndex<80l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};

((*(tyHermesBoardForecast)).tyAvl.bBoardId=((__AS__STRING_CMP(((*(tyHermesBoardAvailable)).tyData.sBoardId),"")!=0)));
((*(tyHermesBoardForecast)).tyAvl.bBoardIdCreatedBy=((__AS__STRING_CMP(((*(tyHermesBoardAvailable)).tyData.sBoardIdCreatedBy),"")!=0)));
((*(tyHermesBoardForecast)).tyAvl.bFailedBoard=1);
((*(tyHermesBoardForecast)).tyAvl.bProductTypeId=((__AS__STRING_CMP(((*(tyHermesBoardAvailable)).tyData.sProductTypeId),"")!=0)));
((*(tyHermesBoardForecast)).tyAvl.bFlippedBoard=1);
((*(tyHermesBoardForecast)).tyAvl.bTopBarcode=((__AS__STRING_CMP(((*(tyHermesBoardAvailable)).tyData.sTopBarcode),"")!=0)));
((*(tyHermesBoardForecast)).tyAvl.bBottomBarcode=((__AS__STRING_CMP(((*(tyHermesBoardAvailable)).tyData.sBottomBarcode),"")!=0)));
...
((*(tyHermesBoardForecast)).tyAvl.bWorkOrderId=((__AS__STRING_CMP(((*(tyHermesBoardAvailable)).tyData.sWorkOrderId),"")!=0)));
((*(tyHermesBoardForecast)).tyAvl.bBatchId=((__AS__STRING_CMP(((*(tyHermesBoardAvailable)).tyData.sBatchId),"")!=0)));

}return __AS__fHermesBrdAvltoBF;}
#line 41 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fHermesBrdAvltoBF.nodebug"

void __AS__ImplInitfHermesBrdAvltoBF_st(void){}
...
__asm__(".ascii \"iecfile \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/NtHermes/fHermesBrdAvltoBF.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/NtHermes/fHermesBrdAvltoBF.st.c\\\" \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fHermesBrdAvltoBF.st\\\"\\n\"");
