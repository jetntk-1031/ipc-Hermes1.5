...
#include "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/NtHermes/fHermesIllegalMsgTransportStopDSst.h"
#line 1 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fHermesIllegalMsgTransportStopDS.nodebug"
#line 3 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fHermesIllegalMsgTransportStopDS.st"
unsigned long fHermesIllegalMsgTransportStopDS(struct tyHermesMsgType(* tyMsgType)){unsigned long __AS__fHermesIllegalMsgTransportStopDS=0;{

if((((unsigned long)(unsigned char)((*(tyMsgType)).bServiceDescription)==(unsigned long)(unsigned char)1))){

(__AS__fHermesIllegalMsgTransportStopDS=2903);

}else if((((unsigned long)(unsigned char)((*(tyMsgType)).bBoardAvailable)==(unsigned long)(unsigned char)1))){

(__AS__fHermesIllegalMsgTransportStopDS=2904);

}else if((((unsigned long)(unsigned char)((*(tyMsgType)).bRevokeBoardAvailable)==(unsigned long)(unsigned char)1))){

(__AS__fHermesIllegalMsgTransportStopDS=2905);

}else if((((unsigned long)(unsigned char)((*(tyMsgType)).bMachineReady)==(unsigned long)(unsigned char)1))){

(__AS__fHermesIllegalMsgTransportStopDS=2906);

}else if((((unsigned long)(unsigned char)((*(tyMsgType)).bRevokeMachineReady)==(unsigned long)(unsigned char)1))){

(__AS__fHermesIllegalMsgTransportStopDS=2907);

}else if((((unsigned long)(unsigned char)((*(tyMsgType)).bStartTransport)==(unsigned long)(unsigned char)1))){

(__AS__fHermesIllegalMsgTransportStopDS=2908);

}else if((((unsigned long)(unsigned char)((*(tyMsgType)).bStopTransport)==(unsigned long)(unsigned char)1))){

(__AS__fHermesIllegalMsgTransportStopDS=2909);

}else if((((unsigned long)(unsigned char)((*(tyMsgType)).bTransportFinished)==(unsigned long)(unsigned char)1))){

(__AS__fHermesIllegalMsgTransportStopDS=2910);

}else if((((unsigned long)(unsigned char)((*(tyMsgType)).bBoardForecast)==(unsigned long)(unsigned char)1))){

(__AS__fHermesIllegalMsgTransportStopDS=2911);

}else{

(__AS__fHermesIllegalMsgTransportStopDS=0);

}

}imp1_end0_0:;return __AS__fHermesIllegalMsgTransportStopDS;}
#line 47 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fHermesIllegalMsgTransportStopDS.nodebug"

void __AS__ImplInitfHermesIllegalMsgTransportStopDS_st(void){}
...
__asm__(".ascii \"iecfile \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/NtHermes/fHermesIllegalMsgTransportStopDS.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/NtHermes/fHermesIllegalMsgTransportStopDS.st.c\\\" \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fHermesIllegalMsgTransportStopDS.st\\\"\\n\"");
