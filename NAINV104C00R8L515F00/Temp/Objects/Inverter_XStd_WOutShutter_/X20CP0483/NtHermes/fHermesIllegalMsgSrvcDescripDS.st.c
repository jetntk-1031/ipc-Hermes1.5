...
#include "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/NtHermes/fHermesIllegalMsgSrvcDescripDSst.h"
#line 1 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fHermesIllegalMsgSrvcDescripDS.nodebug"
#line 3 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fHermesIllegalMsgSrvcDescripDS.st"
unsigned long fHermesIllegalMsgSrvcDescripDS(struct tyHermesMsgType(* tyMsgType)){unsigned long __AS__fHermesIllegalMsgSrvcDescripDS=0;{

if((((unsigned long)(unsigned char)((*(tyMsgType)).bServiceDescription)==(unsigned long)(unsigned char)1))){

(__AS__fHermesIllegalMsgSrvcDescripDS=2848);

}else if((((unsigned long)(unsigned char)((*(tyMsgType)).bBoardAvailable)==(unsigned long)(unsigned char)1))){

(__AS__fHermesIllegalMsgSrvcDescripDS=2849);

}else if((((unsigned long)(unsigned char)((*(tyMsgType)).bRevokeBoardAvailable)==(unsigned long)(unsigned char)1))){

(__AS__fHermesIllegalMsgSrvcDescripDS=2850);

}else if((((unsigned long)(unsigned char)((*(tyMsgType)).bMachineReady)==(unsigned long)(unsigned char)1))){

(__AS__fHermesIllegalMsgSrvcDescripDS=2851);

}else if((((unsigned long)(unsigned char)((*(tyMsgType)).bRevokeMachineReady)==(unsigned long)(unsigned char)1))){

(__AS__fHermesIllegalMsgSrvcDescripDS=2852);

}else if((((unsigned long)(unsigned char)((*(tyMsgType)).bStartTransport)==(unsigned long)(unsigned char)1))){

(__AS__fHermesIllegalMsgSrvcDescripDS=2853);

}else if((((unsigned long)(unsigned char)((*(tyMsgType)).bStopTransport)==(unsigned long)(unsigned char)1))){

(__AS__fHermesIllegalMsgSrvcDescripDS=2854);

}else if((((unsigned long)(unsigned char)((*(tyMsgType)).bTransportFinished)==(unsigned long)(unsigned char)1))){

(__AS__fHermesIllegalMsgSrvcDescripDS=2855);

}else if((((unsigned long)(unsigned char)((*(tyMsgType)).bBoardForecast)==(unsigned long)(unsigned char)1))){

(__AS__fHermesIllegalMsgSrvcDescripDS=2856);

}else{

(__AS__fHermesIllegalMsgSrvcDescripDS=0);

}

}imp1_end0_0:;return __AS__fHermesIllegalMsgSrvcDescripDS;}
#line 47 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fHermesIllegalMsgSrvcDescripDS.nodebug"

void __AS__ImplInitfHermesIllegalMsgSrvcDescripDS_st(void){}
...
__asm__(".ascii \"iecfile \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/NtHermes/fHermesIllegalMsgSrvcDescripDS.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/NtHermes/fHermesIllegalMsgSrvcDescripDS.st.c\\\" \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fHermesIllegalMsgSrvcDescripDS.st\\\"\\n\"");
