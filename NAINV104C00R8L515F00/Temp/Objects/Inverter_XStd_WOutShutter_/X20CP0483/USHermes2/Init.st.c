...
#include "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/USHermes2/Initst.h"
#line 1 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/Hermes/USHermes2/Init.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/Hermes/USHermes2/Init.st"
...
(p_USHermes2Stat=((unsigned long)(&eStat)));
(p_USHermes2Status=((unsigned long)(&eMainStatus)));
(p_USHermes2StatTxt=((unsigned long)(&sStatTxt)));


(p_USHermes2AlmData=((unsigned long)(&tyAlmData)));
(p_USHermes2AlmData1=((unsigned long)(&tyAlmData1)));
(p_USHermes2AlmData2=((unsigned long)(&tyAlmData2)));
(p_USHermes2AlmData3=((unsigned long)(&tyAlmData3)));
(p_USHermes2AlmData4=((unsigned long)(&tyAlmData4)));
(p_USHermes2AlmData5=((unsigned long)(&tyAlmData5)));
(p_USHermes2InfoData=((unsigned long)(&tyInfoData)));


(p_USHermes2TableDataBrdAvl=((unsigned long)(&a_tyXMLTableDataBrdAvl)));
(p_USHermes2TableDataBrdAvlTtlIdx=((unsigned long)(&iXMLTableDataBrdAvlTtlIdx)));
(p_USHermes2Connected=((unsigned long)(&bConnected)));
(p_USHermes2HandshakeDone=((unsigned long)(&bHandshakeDone)));
(p_USHermes2AccDataReq=((unsigned long)(&bAccDataReq)));
(p_USHermes2OverWriteSlt=((unsigned long)(&bOverWriteSlt)));
(p_USHermes2OverWriteWidth=((unsigned long)(&bOverWriteWidth)));
(p_USHermes2ReqRecipeNm=((unsigned long)(&sReqRecipeNm)));
(p_USHermes2ReqWidthInUM=((unsigned long)(&diReqWidthInUM)));
(p_USHermes2ReqMinSltValue=((unsigned long)(&diReqMinSltValue)));
(p_USHermes2ReqMaxSltValue=((unsigned long)(&diReqMaxSltValue)));
(p_USHermes2ReqPitch=((unsigned long)(&diReqPitch)));
(p_USHermes2USRdy=((unsigned long)(&bUSRdy)));
(p_USHermes2DSRdy=((unsigned long)(&bDSRdy)));
(p_USHermes2USGdRdy=((unsigned long)(&bUSGdRdy)));
(p_USHermes2DSGdRdy=((unsigned long)(&bDSGdRdy)));
(p_USHermes2Transporting=((unsigned long)(&bTransporting)));
(p_USHermes2StopTransport=((unsigned long)(&bStopTransport)));
(p_USHermes2BlkUS=((unsigned long)(&bBlkUS)));
(p_USHermes2InternalSnd=((unsigned long)(&sInternalSnd)));
(p_USHermes2AccDataMnl=((unsigned long)(&bAccDataMnl)));
(p_USHermes2StopTransportSnd=((unsigned long)(&bStopTransportSnd)));


(p_USHermes2tyBoardAvailable=((unsigned long)(&tyBoardAvailableRcv)));
(p_USHermes2RcvBoardInfoOk=((unsigned long)(&bRcvBoardInfoOk)));
(p_USHermes2RcvbBoardInfoIncompl=((unsigned long)(&bRcvBoardInfoIncompl)));
(p_USHermes2BoardInfoData=((unsigned long)(&tySendBoardInfoAcc)));
(p_USHermes2BoardArrivedData=((unsigned long)(&tyBoardArrivedInfo)));


(p_USHermes2CommandParam=((unsigned long)(&tyCommandParam)));


(p_USHermes2ReverseDSSendBFId=((unsigned long)(&bReverseDSSndBfWBrdID)));
(p_USHermes2ProcessRouteTrigger=((unsigned long)(&bTriggerUpdateRoute)));



(p_USHermes2SwitchtoReverseRcv=((unsigned long)(&bSwitchtoReverseReceive)));

(p_USHermes2BrdForecast=((unsigned long)(&tyBoardForecastRcv)));
(p_USHermes2BrdForecastRcv=((unsigned long)(&bBrdForecastRcv)));
(p_USHermes2StopTransportSent=((unsigned long)(&bStopTransportSent)));
(p_USHermes2StopTransportSentMsg=((unsigned long)(&tyStopTransport)));
(p_USHermes2BoardAvailableRcved=((unsigned long)(&bBoardAvailableRcved)));
}}
#line 68 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/Hermes/USHermes2/Init.nodebug"
...
__asm__(".ascii \"iecfile \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/USHermes2/Init.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/USHermes2/Init.st.c\\\" \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/Hermes/USHermes2/Init.st\\\"\\n\"");
__asm__(".previous");
