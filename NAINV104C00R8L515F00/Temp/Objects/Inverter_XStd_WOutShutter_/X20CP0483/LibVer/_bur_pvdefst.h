...
#ifndef __AS__TYPE_MoVerStruc_typ
#define __AS__TYPE_MoVerStruc_typ
...
#ifndef __AS__TYPE_tyLibrariesInternal
#define __AS__TYPE_tyLibrariesInternal
...
{	plcstring sVersion[11];
	...
	signed long di;
	MoVerStruc_typ tyMoVer;
} tyLibrariesInternal;
#endif

#ifndef __AS__TYPE_tyLibrariesVer
#define __AS__TYPE_tyLibrariesVer
...
_BUR_LOCAL eLibVerAction(* p_eAct);
_BUR_LOCAL unsigned long(* p_udiRstErr);
_BUR_LOCAL struct tyLibrariesVer(* pa_tyInfoIn)[101];
_BUR_LOCAL plcstring(* p_sProgNm)[16];
_BUR_LOCAL plcbit(* p_bNtSettingsLoadDone);
_BUR_LOCAL eLibVerAction eAct;
_BUR_LOCAL eLibVerAction eStat;
...
_GLOBAL signed long c_diLibNum;
