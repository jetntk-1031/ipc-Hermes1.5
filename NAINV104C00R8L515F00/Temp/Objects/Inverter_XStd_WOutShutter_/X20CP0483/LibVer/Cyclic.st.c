...
#include "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/LibVer/Cyclicst.h"
#line 1 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/LibVer/LibVer/Cyclic.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/LibVer/LibVer/Cyclic.st"
...
#line 28 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/LibVer/LibVer/Cyclic.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/LibVer/LibVer/Act_InitGlobal.st"
...
(p_eAct=p_StartupLibVerAct);
(p_sProgNm=p_NtParamLibVersionProgNm);
(p_bNtSettingsLoadDone=p_StartupNtSettingsLoadDone);



}}
#line 29 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/LibVer/LibVer/Cyclic.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/LibVer/LibVer/Act_LinkAction.st"
static void __AS__Action__Act_LinkAction(void){
{
}}
#line 29 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/LibVer/LibVer/Cyclic.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/LibVer/LibVer/Act_Link.st"
...
#line 29 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/LibVer/LibVer/Cyclic.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/LibVer/LibVer/Act_RstErr.st"
...
#line 29 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/LibVer/LibVer/Cyclic.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/LibVer/LibVer/Act_InitLocal.st"
static void __AS__Action__Act_InitLocal(void){
{

(p_eAct=((unsigned long)(&eAct)));
(p_udiRstErr=((unsigned long)(&udiRstErr)));
(pa_tyInfoIn=((unsigned long)(&a_tyInfoIn)));
(p_sProgNm=((unsigned long)(&sProgNm)));
(p_bNtSettingsLoadDone=((unsigned long)(&bNtSettingsLoadDone)));

}}
#line 29 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/LibVer/LibVer/Cyclic.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/LibVer/LibVer/Act_Initial.st"
...
{int zzIndex; plcstring* zzLValue=(plcstring*)fbDirCreate2.sDirName; plcstring* zzRValue=(plcstring*)"LibrariesVersion"; for(zzIndex=0; zzIndex<16l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
(fbDirCreate2.bEn=0);;fbDirCreate(&fbDirCreate2);

{int zzIndex; plcstring* zzLValue=(plcstring*)fbFileRead1.sDevice; plcstring* zzRValue=(plcstring*)"LibVer"; for(zzIndex=0; zzIndex<6l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
{int zzIndex; plcstring* zzLValue=(plcstring*)fbFileRead1.sFile; plcstring* zzRValue=(plcstring*)"LibrariesVersion.dat"; for(zzIndex=0; zzIndex<20l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
(fbFileRead1.udiOffset=0);
(fbFileRead1.p_Dest=((unsigned long)(&a_tyInfoOut)));
(fbFileRead1.udiLen=2222);
(fbFileRead1.bEn=0);;fbFileFullRead(&fbFileRead1);

{int zzIndex; plcstring* zzLValue=(plcstring*)fbFileWrite1.sDevice; plcstring* zzRValue=(plcstring*)"LibVer"; for(zzIndex=0; zzIndex<6l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
{int zzIndex; plcstring* zzLValue=(plcstring*)fbFileWrite1.sFile; plcstring* zzRValue=(plcstring*)"LibrariesVersion.dat"; for(zzIndex=0; zzIndex<20l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
(fbFileWrite1.udiOffset=0);
(fbFileWrite1.p_Src=((unsigned long)(&((*(pa_tyInfoIn))))));
(fbFileWrite1.udiLen=2222);
(fbFileWrite1.udiOption=0);
(fbFileWrite1.bEn=0);;fbFileFullWrite(&fbFileWrite1);

(fbChkLibVerFile.bEn=0);;fbChkFileValidity(&fbChkLibVerFile);

((*(unsigned long*)&(fbChkLibVer.pa_bVerMismatch))=((unsigned long)(&a_bVerMismatch)));
(fbChkLibVer.bEn=0);;fbChkLibrariesVer(&fbChkLibVer);

}}
#line 29 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/LibVer/LibVer/Cyclic.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/LibVer/LibVer/Act_Action.st"
...
#line 29 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/LibVer/LibVer/Cyclic.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/LibVer/LibVer/Act_Main.st"
...
(fbChkLibVer.bEn=0);;fbChkLibrariesVer(&fbChkLibVer);
(usiStep=0);
__AS__MEMSET(((unsigned long)(&a_bVerMismatch)),0,101);
...
{int zzIndex; unsigned char* zzLValue=(unsigned char*)fbChkLibVerFile.a_tyLibraryVer; unsigned char* zzRValue=(unsigned char*)a_tyInfoOut; for(zzIndex=0; zzIndex<2222l; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex];};

(fbChkLibVerFile.bEn=1);;fbChkFileValidity(&fbChkLibVerFile);
if((((unsigned long)fbChkLibVerFile.udiStatus==(unsigned long)0))){
(usiStep=2);
}else if((((unsigned long)fbChkLibVerFile.udiStatus<(unsigned long)65534))){
(eStatus=3);

if((((unsigned long)fbChkLibVerFile.udiStatus==(unsigned long)1001))){
(udiStatus=10016);
}
}
...
{int zzIndex; unsigned char* zzLValue=(unsigned char*)fbChkLibVer.a_tyLibraryVer; unsigned char* zzRValue=(unsigned char*)a_tyInfoOut; for(zzIndex=0; zzIndex<2222l; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex];};

(fbChkLibVer.bEn=1);;fbChkLibrariesVer(&fbChkLibVer);
if((((unsigned long)fbChkLibVer.udiStatus==(unsigned long)0))){
(eStatus=1);
}else if((((unsigned long)fbChkLibVer.udiStatus<(unsigned long)65534))){
(eStatus=3);

if((((unsigned long)fbChkLibVer.udiStatus==(unsigned long)1002))){
(udiStatus=10012);
}
}
...
}imp8_case0_4:imp8_endcase0_0:;}
#line 29 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/LibVer/LibVer/Cyclic.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/LibVer/LibVer/Act_Alarm.st"
...
{int zzIndex; plcstring* zzLValue=(plcstring*)g_sLibVerProgNm; plcstring* zzRValue=(plcstring*)((*(p_sProgNm))); for(zzIndex=0; zzIndex<15l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};

if((((unsigned long)tyAlmData.udiCode==(unsigned long)10012))){
...
for((di=0);di<=c_diLibNum;di+=1){
if((((unsigned long)(unsigned char)a_bVerMismatch[di]==(unsigned long)(unsigned char)1))){
{int zzIndex; plcstring* zzLValue=(plcstring*)tyAlmData.sAlmMsg; plcstring* zzRValue=(plcstring*)CONCAT(tyAlmData.sAlmMsg," ("); for(zzIndex=0; zzIndex<200l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
{int zzIndex; plcstring* zzLValue=(plcstring*)tyAlmData.sAlmMsg; plcstring* zzRValue=(plcstring*)CONCAT(tyAlmData.sAlmMsg,a_tyInfoOut[di].sName); for(zzIndex=0; zzIndex<200l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
{int zzIndex; plcstring* zzLValue=(plcstring*)tyAlmData.sAlmMsg; plcstring* zzRValue=(plcstring*)CONCAT(tyAlmData.sAlmMsg,")"); for(zzIndex=0; zzIndex<200l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
{int zzIndex; plcstring* zzLValue=(plcstring*)g_sLiberWarnName; plcstring* zzRValue=(plcstring*)a_tyInfoOut[di].sName; for(zzIndex=0; zzIndex<10l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
goto imp2_endfor2_0;
}
}imp2_endfor2_0:;
...
__asm__(".ascii \"iecfile \\\"Logical/LibVer/LibVer/InputRef_Link.var\\\" scope \\\"local\\\"\\n\"");
...
__asm__(".ascii \"iecfile \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/LibVer/Cyclic.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/LibVer/Cyclic.st.c\\\" \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/LibVer/LibVer/Cyclic.st\\\"\\n\"");
__asm__(".ascii \"iecfile \\\"Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/LibVer/Cyclic.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".previous");

__asm__(".section \".plciec\"");
__asm__(".ascii \"plcdata_const 'pa_tyInfoIn'\\n\"");
__asm__(".ascii \"plcdata_const 'a_tyInfoOut'\\n\"");
__asm__(".ascii \"plcdata_const 'a_bVerMismatch'\\n\"");
__asm__(".ascii \"plcdata_const 'c_diLibNum'\\n\"");
__asm__(".previous");
