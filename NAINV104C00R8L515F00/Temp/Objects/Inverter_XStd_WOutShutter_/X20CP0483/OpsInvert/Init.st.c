...
#include "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/OpsInvert/Initst.h"
#line 1 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/Operations/OpsInvert/Init.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/Operations/OpsInvert/Init.st"
...
(p_OpsInvertAlmData=((unsigned long)(&tyAlmData)));
(p_OpsInvertAlmData1=((unsigned long)(&tyAlmData1)));


(p_OpsInvertStepTxt=((unsigned long)(&sStepTxt)));
(p_OpsInvertPaused=((unsigned long)(&bPaused)));
(p_OpsInvertGdBrd=((unsigned long)(&bGdBrd)));
(p_OpsInvertHvBrd=((unsigned long)(&bHvBrd)));

(p_OpsInvertUSSMEMAAct=((unsigned long)(&eUSSMEMAAct)));
(p_OpsInvertDSSMEMAAct=((unsigned long)(&eDSSMEMAAct)));
(p_OpsInvertConvAct=((unsigned long)(&eConvAct)));
(p_OpsInvertStopperAct=((unsigned long)(&eStopperAct)));
(p_OpsInvertInvertAct=((unsigned long)(&eInvertAct)));
(p_OpsInvertAWAct=((unsigned long)(&eAWAct)));
(p_OpsInvertClampAct=((unsigned long)(&eClampAct)));
(p_OpsInvertInletShutterAct=((unsigned long)(&eInletShutterAct)));
(p_OpsInvertOutletShutterAct=((unsigned long)(&eOutletShutterAct)));
(p_OpsInvertClamp1Act=((unsigned long)(&eClamp1Act)));
(p_OpsInvertClamp2Act=((unsigned long)(&eClamp2Act)));
(p_OpsInvertClamp3Act=((unsigned long)(&eClamp3Act)));

(p_OpsInvertStepInitConv=((unsigned long)(&bStepInitConv)));
(p_OpsInvertStepInitAwayStpr=((unsigned long)(&bStepInitAwayStopper)));
(p_OpsInvertStepInitTwdStpr=((unsigned long)(&bStepInitTwdStopper)));
(p_OpsInvertStepInitDone=((unsigned long)(&bStepInitDone)));
(p_OpsInvertStepUSStandby=((unsigned long)(&bStepUSStandby)));
(p_OpsInvertStepUSCommTmr=((unsigned long)(&bStepUSCommTmr)));
(p_OpsInvertStepEntToEnd=((unsigned long)(&bStepEntToEnd)));
(p_OpsInvertStepEntToInOff=((unsigned long)(&bStepEntToInOff)));
(p_OpsInvertStepRev=((unsigned long)(&bStepRev)));
(p_OpsInvertStepPreExit=((unsigned long)(&bStepPreExit)));
(p_OpsInvertStepDSStandby=((unsigned long)(&bStepDSStandby)));
(p_OpsInvertStepDSCommTmr=((unsigned long)(&bStepDSCommTmr)));
(p_OpsInvertStepExitBrd=((unsigned long)(&bStepExitBrd)));
(p_OpsInvertStepInvert=((unsigned long)(&bStepInvert)));
(p_OpsInvertStepAWMove=((unsigned long)(&bStepAWMov)));
(p_OpsInvertStepOpsSafeMode=((unsigned long)(&bStepSafeMode)));

(p_OpsInvertBrdInserted=((unsigned long)(&bBrdInserted)));
(p_OpsInvertBrdRemoved=((unsigned long)(&bBrdRemoved)));

(p_OpsInvertInvertCurrPos=((unsigned long)(&eInvertCurrPos)));

(p_OpsInvertUSSMEMA2Act=((unsigned long)(&eUSSMEMA2Act)));
(p_OpsInvertOnceTwicePCBOut=((unsigned long)(&bInvOnceTwicePCBOut)));
(p_OpsInvertStepInvRtrnUSStandby=((unsigned long)(&bStepInvRtrnUSStandby)));
(p_OpsInvertStepInvRtrnUSCommTmr=((unsigned long)(&bStepInvRtrnUSCommTmr)));
(p_OpsInvertStepInvRtrnEntToEnd=((unsigned long)(&bStepInvRtrnEntToEnd)));
(p_OpsInvertStepInvRtrnEntToInOff=((unsigned long)(&bStepInvRtrnEntToInOff)));




}}
#line 64 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/Operations/OpsInvert/Init.nodebug"
...
__asm__(".ascii \"iecfile \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/OpsInvert/Init.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/OpsInvert/Init.st.c\\\" \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/Operations/OpsInvert/Init.st\\\"\\n\"");
__asm__(".previous");
