...
_BUR_PUBLIC plcbit fHermesGenerateBrdXmlTbl(struct tyHermesBrdAvlDat(* p_tyHermesBrdAvlDat), struct tyHermesBAMsgAttribAddr(* tyHermesBAMsgAttribAddr));
...
_BUR_LOCAL unsigned long udiHermesAttributeEndIdx;
_BUR_LOCAL unsigned long udiHermesBAEndIdx;
...
_LOCAL plcbit Edge0001100001;
_LOCAL plcbit Edge0001100002;
_LOCAL plcbit Edge0001100003;
