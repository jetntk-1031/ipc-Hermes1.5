...
#include "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/MpProdRcp/Cyclicst.h"
#line 1 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/MpProdRcp/MpProdRcp/Cyclic.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/MpProdRcp/MpProdRcp/Cyclic.st"
...
#line 28 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/MpProdRcp/MpProdRcp/Cyclic.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/MpProdRcp/MpProdRcp/Act_InitGlobal.st"
...
(pa_tyMpProdRcp=p_ProdRcpCurrList);
(p_sPVName=p_NtParamMpProdRcpPVNm);
(p_sFileName=p_NtParamMpProdRcpFileNm);
(p_sProgNm=p_NtParamMpProdRcpProgNm);
(p_bNtSettingsLoadDone=p_StartupNtSettingsLoadDone);



}}
#line 29 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/MpProdRcp/MpProdRcp/Cyclic.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/MpProdRcp/MpProdRcp/Act_LinkAction.st"
static void __AS__Action__Act_LinkAction(void){
{
if((((unsigned long)(unsigned char)((*(p_bLinkStartupRun)))==(unsigned long)(unsigned char)1))){
(p_eAct=p_StartupMpProdRcpAct);
}else{
(p_eAct=p_UIMpProdRcpAct);
}

}imp7_end0_0:;}
#line 29 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/MpProdRcp/MpProdRcp/Cyclic.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/MpProdRcp/MpProdRcp/Act_Link.st"
static void __AS__Action__Act_Link(void){
{
}}
#line 29 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/MpProdRcp/MpProdRcp/Cyclic.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/MpProdRcp/MpProdRcp/Act_RstErr.st"
...
#line 29 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/MpProdRcp/MpProdRcp/Cyclic.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/MpProdRcp/MpProdRcp/Act_InitLocal.st"
static void __AS__Action__Act_InitLocal(void){
{

(p_eAct=((unsigned long)(&eAct)));
(p_udiRstErr=((unsigned long)(&udiRstErr)));
(pa_tyMpProdRcp=((unsigned long)(&a_tyMpProdRcp)));
(p_tyMpProdRcpMpLink=((unsigned long)(&tyMpProdRcpMpLink)));
...
#line 29 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/MpProdRcp/MpProdRcp/Cyclic.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/MpProdRcp/MpProdRcp/Act_Initial.st"
...
{int zzIndex; plcstring* zzLValue=(plcstring*)fbDirCreate2.sDirName; plcstring* zzRValue=(plcstring*)"ProductRecipeXml"; for(zzIndex=0; zzIndex<16l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
(fbDirCreate2.bEn=0);;fbDirCreate(&fbDirCreate2);

(tyMpProdRcpMpLink=*(struct MpComIdentType*)&gRecipeXml);

((*(unsigned long*)&(fbMpRecipeRegPar.MpLink))=((unsigned long)(&((*(p_tyMpProdRcpMpLink))))));
((*(unsigned long*)&(fbMpRecipeRegPar.PVName))=((unsigned long)(&((*(p_sPVName))))));
(fbMpRecipeRegPar.Enable=0);;MpRecipeRegPar(&fbMpRecipeRegPar);

((*(unsigned long*)&(fbMpRecipeXml.MpLink))=((unsigned long)(&((*(p_tyMpProdRcpMpLink))))));
((*(unsigned long*)&(fbMpRecipeXml.DeviceName))=((unsigned long)(&"MpProdRcp")));
((*(unsigned long*)&(fbMpRecipeXml.FileName))=((unsigned long)(&((*(p_sFileName))))));
(fbMpRecipeXml.Enable=0);;MpRecipeXml(&fbMpRecipeXml);

}}
#line 29 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/MpProdRcp/MpProdRcp/Cyclic.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/MpProdRcp/MpProdRcp/Act_Action.st"
...
#line 29 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/MpProdRcp/MpProdRcp/Cyclic.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/MpProdRcp/MpProdRcp/Act_Main.st"
...
switch(usiStep){
case 0:{
(fbMpRecipeRegPar.Enable=1);;MpRecipeRegPar(&fbMpRecipeRegPar);

if(((((unsigned long)(unsigned char)fbMpRecipeRegPar.Active==(unsigned long)(unsigned char)1))&(((signed long)fbMpRecipeRegPar.StatusID==(signed long)0)))){
(usiStep=1);
}else if((((signed long)fbMpRecipeRegPar.StatusID!=(signed long)0))){
(eStatus=3);
(udiStatus=10002);
}

}break;case 1:{
(fbMpRecipeXml.Load=1);
(fbMpRecipeXml.Save=0);
(fbMpRecipeXml.Enable=1);;MpRecipeXml(&fbMpRecipeXml);

if(((((unsigned long)(unsigned char)fbMpRecipeXml.Active==(unsigned long)(unsigned char)1))&(((unsigned long)(unsigned char)fbMpRecipeXml.CommandDone==(unsigned long)(unsigned char)1))&(((signed long)fbMpRecipeXml.StatusID==(signed long)0)))){
(eStatus=1);
{int zzIndex; unsigned char* zzLValue=(unsigned char*)((*(pa_tyMpProdRcp))); unsigned char* zzRValue=(unsigned char*)a_tyMpProdRcp1; for(zzIndex=0; zzIndex<664000l; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex];};
}else if((((signed long)fbMpRecipeXml.StatusID!=(signed long)0))){
(eStatus=3);
(udiStatus=10003);
}
...
switch(usiStep){
case 0:{
{int zzIndex; unsigned char* zzLValue=(unsigned char*)a_tyMpProdRcp1; unsigned char* zzRValue=(unsigned char*)((*(pa_tyMpProdRcp))); for(zzIndex=0; zzIndex<664000l; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex];};
(fbMpRecipeRegPar.Enable=1);;MpRecipeRegPar(&fbMpRecipeRegPar);
...
(fbMpRecipeXml.Load=0);
(fbMpRecipeXml.Save=1);
(fbMpRecipeXml.Enable=1);;MpRecipeXml(&fbMpRecipeXml);
...
#line 29 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/MpProdRcp/MpProdRcp/Cyclic.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/MpProdRcp/MpProdRcp/Act_Alarm.st"
...
{int zzIndex; plcstring* zzLValue=(plcstring*)g_sMpProdRcpProgNm; plcstring* zzRValue=(plcstring*)((*(p_sProgNm))); for(zzIndex=0; zzIndex<15l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
...
__asm__(".ascii \"iecfile \\\"Logical/MpProdRcp/MpProdRcp/InputRef_Link.var\\\" scope \\\"local\\\"\\n\"");
...
__asm__(".ascii \"iecfile \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/MpProdRcp/Cyclic.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/MpProdRcp/Cyclic.st.c\\\" \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/MpProdRcp/MpProdRcp/Cyclic.st\\\"\\n\"");
__asm__(".ascii \"iecfile \\\"Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/MpProdRcp/Cyclic.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".previous");

__asm__(".section \".plciec\"");
__asm__(".ascii \"plcdata_const 'c_udiMpProdRcpMax'\\n\"");
__asm__(".previous");
