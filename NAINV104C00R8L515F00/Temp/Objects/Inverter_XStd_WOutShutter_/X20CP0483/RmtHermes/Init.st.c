...
#include "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/RmtHermes/Initst.h"
#line 1 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/Hermes/RmtHermes/Init.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/Hermes/RmtHermes/Init.st"
...
(p_RmtHermesStat=((unsigned long)(&eStat)));
(p_RmtHermesStatus=((unsigned long)(&eMainStatus)));
(p_RmtHermesStatTxt=((unsigned long)(&sStatTxt)));
(p_RmtHermesAct=((unsigned long)(&eHermesAct)));
(p_RmtHermesMcParamAct=((unsigned long)(&eMcParamAct)));


(p_RmtHermesAlmData=((unsigned long)(&tyAlmData)));
(p_RmtHermesAlmData1=((unsigned long)(&tyAlmData1)));
(p_RmtHermesAlmData2=((unsigned long)(&tyAlmData2)));
(p_RmtHermesAlmData3=((unsigned long)(&tyAlmData3)));
(p_RmtHermesInfoData=((unsigned long)(&tyInfoData)));


(p_RmtHermesFileNotFound=((unsigned long)(&bFileNotFound)));
(p_RmtHermesConnected=((unsigned long)(&bConnected)));
(p_RmtHermesSetConfiguration=((unsigned long)(&tySetConfiguration)));
(p_RmtHermesWriteConfig=((unsigned long)(&bWriteConfig)));
(p_RmtHermesUpdateUIData=((unsigned long)(&bUpdateUIData)));


(p_RmtHermesFoundIndexUS1=((unsigned long)(&bFoundIndexUS1)));
(p_RmtHermesFoundIndexUS2=((unsigned long)(&bFoundIndexUS2)));
(p_RmtHermesFoundIndexUS3=((unsigned long)(&bFoundIndexUS3)));
(p_RmtHermesFoundIndexUS4=((unsigned long)(&bFoundIndexUS4)));
(p_RmtHermesFoundIndexDS1=((unsigned long)(&bFoundIndexDS1)));
(p_RmtHermesFoundIndexDS2=((unsigned long)(&bFoundIndexDS2)));
(p_RmtHermesFoundIndexDS3=((unsigned long)(&bFoundIndexDS3)));
(p_RmtHermesFoundIndexDS4=((unsigned long)(&bFoundIndexDS4)));
(p_RmtHermesIndexUS1=((unsigned long)(&udiFoundIndexUS1)));
(p_RmtHermesIndexUS2=((unsigned long)(&udiFoundIndexUS2)));
(p_RmtHermesIndexUS3=((unsigned long)(&udiFoundIndexUS3)));
(p_RmtHermesIndexUS4=((unsigned long)(&udiFoundIndexUS4)));
(p_RmtHermesIndexDS1=((unsigned long)(&udiFoundIndexDS1)));
(p_RmtHermesIndexDS2=((unsigned long)(&udiFoundIndexDS2)));
(p_RmtHermesIndexDS3=((unsigned long)(&udiFoundIndexDS3)));
(p_RmtHermesIndexDS4=((unsigned long)(&udiFoundIndexDS4)));




}}
#line 49 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/Hermes/RmtHermes/Init.nodebug"
...
__asm__(".ascii \"iecfile \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/RmtHermes/Init.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/RmtHermes/Init.st.c\\\" \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/Hermes/RmtHermes/Init.st\\\"\\n\"");
__asm__(".previous");
