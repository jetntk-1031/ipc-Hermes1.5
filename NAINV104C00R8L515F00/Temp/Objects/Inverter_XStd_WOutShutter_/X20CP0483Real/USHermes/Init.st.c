...
#include "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/USHermes/Initst.h"
#line 1 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/Hermes/USHermes/Init.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/Hermes/USHermes/Init.st"
...
(p_USHermesStat=((unsigned long)(&eStat)));
(p_USHermesStatus=((unsigned long)(&eMainStatus)));
(p_USHermesStatTxt=((unsigned long)(&sStatTxt)));


(p_USHermesAlmData=((unsigned long)(&tyAlmData)));
(p_USHermesAlmData1=((unsigned long)(&tyAlmData1)));
(p_USHermesAlmData2=((unsigned long)(&tyAlmData2)));
(p_USHermesAlmData3=((unsigned long)(&tyAlmData3)));
(p_USHermesAlmData4=((unsigned long)(&tyAlmData4)));
(p_USHermesAlmData5=((unsigned long)(&tyAlmData5)));
(p_USHermesInfoData=((unsigned long)(&tyInfoData)));


(p_USHermesTableDataBrdAvl=((unsigned long)(&a_tyXMLTableDataBrdAvl)));
(p_USHermesTableDataBrdAvlTtlIdx=((unsigned long)(&iXMLTableDataBrdAvlTtlIdx)));
(p_USHermesConnected=((unsigned long)(&bConnected)));
(p_USHermesHandshakeDone=((unsigned long)(&bHandshakeDone)));
(p_USHermesAccDataReq=((unsigned long)(&bAccDataReq)));
(p_USHermesOverWriteSlt=((unsigned long)(&bOverWriteSlt)));
(p_USHermesOverWriteWidth=((unsigned long)(&bOverWriteWidth)));
(p_USHermesReqRecipeNm=((unsigned long)(&sReqRecipeNm)));
(p_USHermesReqWidthInUM=((unsigned long)(&diReqWidthInUM)));
(p_USHermesReqMinSltValue=((unsigned long)(&diReqMinSltValue)));
(p_USHermesReqMaxSltValue=((unsigned long)(&diReqMaxSltValue)));
(p_USHermesReqPitch=((unsigned long)(&diReqPitch)));
(p_USHermesUSRdy=((unsigned long)(&bUSRdy)));
(p_USHermesDSRdy=((unsigned long)(&bDSRdy)));
(p_USHermesUSGdRdy=((unsigned long)(&bUSGdRdy)));
(p_USHermesDSGdRdy=((unsigned long)(&bDSGdRdy)));
(p_USHermesTransporting=((unsigned long)(&bTransporting)));
(p_USHermesStopTransport=((unsigned long)(&bStopTransport)));
(p_USHermesBlkUS=((unsigned long)(&bBlkUS)));
(p_USHermesInternalSnd=((unsigned long)(&sInternalSnd)));
(p_USHermesAccDataMnl=((unsigned long)(&bAccDataMnl)));
(p_USHermesStopTransportSnd=((unsigned long)(&bStopTransportSnd)));

(p_USHermestyBoardAvailable=((unsigned long)(&tyBoardAvailableRcv)));
(p_USHermesRcvBoardInfoOk=((unsigned long)(&bRcvBoardInfoOk)));
(p_USHermesRcvbBoardInfoIncompl=((unsigned long)(&bRcvBoardInfoIncompl)));
(p_USHermesBoardInfoData=((unsigned long)(&tySendBoardInfoAcc)));
(p_USHermesBoardArrivedData=((unsigned long)(&tyBoardArrivedInfo)));




(p_USHermesCommandParam=((unsigned long)(&tyCommandParam)));


(p_USHermesReverseDSSendBFId=((unsigned long)(&bReverseDSSndBfWBrdID)));
(p_USHermesProcessRouteTrigger=((unsigned long)(&bTriggerUpdateRoute)));


(p_USHermesAction=((unsigned long)(&iAction)));




(p_USHermesBrdForecast=((unsigned long)(&tyBoardForecastRcv)));
(p_USHermesBrdForecastRcv=((unsigned long)(&bBrdForecastRcv)));
(p_USHermesStopTransportSent=((unsigned long)(&bStopTransportSent)));
(p_USHermesStopTransportSentMsg=((unsigned long)(&tyStopTransport)));
(p_USHermesBoardAvailableRcved=((unsigned long)(&bBoardAvailableRcved)));
}}
#line 71 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/Hermes/USHermes/Init.nodebug"
...
__asm__(".ascii \"iecfile \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/USHermes/Init.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/USHermes/Init.st.c\\\" \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/Hermes/USHermes/Init.st\\\"\\n\"");
__asm__(".previous");
