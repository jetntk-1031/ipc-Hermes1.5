...
#ifndef __AS__TYPE_tyStringSearchInternal
#define __AS__TYPE_tyStringSearchInternal
...
_BUR_PUBLIC unsigned long fStringSearch(unsigned long p_StringChk, unsigned long udiStringChkSize, plcstring sSearch[256]);
