...
#include "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/NtGeneral/fValidCharStringInChkrst.h"
#line 1 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtGeneral/fValidCharStringInChkr.nodebug"
#line 3 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtGeneral/fValidCharStringInChkr.st"
plcbit fValidCharStringInChkr(plcstring p_sMismatchChar[2], plcstring sInChk[256], plcstring sValidMember[129]){plcbit __AS__fValidCharStringInChkr=0;tyValidCharChkrInternal tyInternal={ "", "", 0, 0 };{





(__AS__fValidCharStringInChkr=1);
{int zzIndex; plcstring* zzLValue=(plcstring*)p_sMismatchChar; plcstring* zzRValue=(plcstring*)""; for(zzIndex=0; zzIndex<0l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};

for((tyInternal.i=0);tyInternal.i<=(LEN(sInChk)-1);tyInternal.i+=1){
memmove(((unsigned long)(&tyInternal.sCharChk)),(((unsigned long)(sInChk))+(unsigned long)tyInternal.i),1);

(__AS__fValidCharStringInChkr=0);

for((tyInternal.j=0);tyInternal.j<=(LEN(sValidMember)-1);tyInternal.j+=1){
memmove(((unsigned long)(&tyInternal.sValidChar)),(((unsigned long)(sValidMember))+(unsigned long)tyInternal.j),1);

if((((signed long)memcmp(((unsigned long)(&tyInternal.sCharChk)),((unsigned long)(&tyInternal.sValidChar)),1)==(signed long)0))){
(__AS__fValidCharStringInChkr=1);
goto imp1_endfor1_0;
}
}imp1_endfor1_0:;

if((((unsigned long)(unsigned char)__AS__fValidCharStringInChkr==(unsigned long)(unsigned char)0))){
{int zzIndex; plcstring* zzLValue=(plcstring*)p_sMismatchChar; plcstring* zzRValue=(plcstring*)tyInternal.sCharChk; for(zzIndex=0; zzIndex<1l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
goto imp1_endfor0_0;
}
}imp1_endfor0_0:;

}return __AS__fValidCharStringInChkr;}
#line 32 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtGeneral/fValidCharStringInChkr.nodebug"

void __AS__ImplInitfValidCharStringInChkr_st(void){}
...
__asm__(".ascii \"iecfile \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/NtGeneral/fValidCharStringInChkr.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/NtGeneral/fValidCharStringInChkr.st.c\\\" \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtGeneral/fValidCharStringInChkr.st\\\"\\n\"");
