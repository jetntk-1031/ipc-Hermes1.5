...
#include "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/NtGeneral/fInvalidCharStringInChkrst.h"
#line 1 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtGeneral/fInvalidCharStringInChkr.nodebug"
#line 3 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtGeneral/fInvalidCharStringInChkr.st"
plcbit fInvalidCharStringInChkr(plcstring p_sInvalidChar[2], plcstring sInChk[256], plcstring sInvalidMember[129]){plcbit __AS__fInvalidCharStringInChkr=0;tyInvalidCharChkrInternal tyInternal={ "", "", 0, 0 };{
...
{int zzIndex; plcstring* zzLValue=(plcstring*)p_sInvalidChar; plcstring* zzRValue=(plcstring*)""; for(zzIndex=0; zzIndex<0l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};

for((tyInternal.i=0);tyInternal.i<=(LEN(sInChk)-1);tyInternal.i+=1){
memmove(((unsigned long)(&tyInternal.sCharChk)),(((unsigned long)(sInChk))+tyInternal.i),1);
(__AS__fInvalidCharStringInChkr=0);

for((tyInternal.j=0);tyInternal.j<=(LEN(sInvalidMember)-1);tyInternal.j+=1){
memmove(((unsigned long)(&tyInternal.sInvalidChar)),(((unsigned long)(sInvalidMember))+tyInternal.j),1);

if((((signed long)memcmp(((unsigned long)(&tyInternal.sCharChk)),((unsigned long)(&tyInternal.sInvalidChar)),1)==(signed long)0))){
(__AS__fInvalidCharStringInChkr=1);
goto imp1_endfor1_0;
}
}imp1_endfor1_0:;

if(__AS__fInvalidCharStringInChkr){
{int zzIndex; plcstring* zzLValue=(plcstring*)p_sInvalidChar; plcstring* zzRValue=(plcstring*)tyInternal.sCharChk; for(zzIndex=0; zzIndex<1l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
goto imp1_endfor0_0;
}
}imp1_endfor0_0:;

}return __AS__fInvalidCharStringInChkr;}
#line 31 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtGeneral/fInvalidCharStringInChkr.nodebug"

void __AS__ImplInitfInvalidCharStringInChkr_st(void){}
...
__asm__(".ascii \"iecfile \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/NtGeneral/fInvalidCharStringInChkr.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/NtGeneral/fInvalidCharStringInChkr.st.c\\\" \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtGeneral/fInvalidCharStringInChkr.st\\\"\\n\"");
