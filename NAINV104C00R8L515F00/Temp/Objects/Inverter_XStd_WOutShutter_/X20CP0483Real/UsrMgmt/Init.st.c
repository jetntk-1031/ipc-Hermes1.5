...
#include "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/UsrMgmt/Initst.h"
#line 1 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/UsrMgmt/UsrMgmt/Init.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/UsrMgmt/UsrMgmt/Init.st"
...
(p_UsrMgmtStat=((unsigned long)(&eStat)));
(p_UsrMgmtStatus=((unsigned long)(&eStatus)));
(p_UsrMgmtStatTxt=((unsigned long)(&sStatTxt)));


(p_UsrMgmtAlmData=((unsigned long)(&tyAlmData)));


(p_UsrMgmtCurrAccessRight=((unsigned long)(&tyCurrAccessRight)));
(p_UsrMgmtCurrUsr=((unsigned long)(&tyCurrUsr)));
(p_UsrMgmtFullData=((unsigned long)(&tyFullData)));
(p_UsrMgmtAllList=((unsigned long)(&tyFullData.a_tyAllList)));
(p_UsrMgmtAccessRightLvl1=((unsigned long)(&tyFullData.tyAccessRightLvl1)));
(p_UsrMgmtAccessRightLvl2=((unsigned long)(&tyFullData.tyAccessRightLvl2)));
(p_UsrMgmtAccessRightLvl3=((unsigned long)(&tyFullData.tyAccessRightLvl3)));
(p_UsrMgmtLvl2List=((unsigned long)(&a_tyLvl2List)));
(p_UsrMgmtLvl3List=((unsigned long)(&a_tyLvl3List)));
(p_UsrMgmtAdminList=((unsigned long)(&a_tyAdminList)));
(p_UsrMgmtLastAdmin=((unsigned long)(&bLastAdmin)));
(p_UsrMgmtUnableDelete=((unsigned long)(&bUnableDelete)));
(p_UsrMgmtLoginSuccess=((unsigned long)(&bLoginSuccess)));
(p_UsrMgmtNmExist=((unsigned long)(&bNmExist)));
(p_UsrMgmtNmNotExist=((unsigned long)(&bNmNotExist)));
(p_UsrMgmtPwMismatch=((unsigned long)(&bPwMismatch)));
(p_UsrMgmtNmEmpty=((unsigned long)(&bNmEmpty)));
(p_UsrMgmtListFull=((unsigned long)(&bListFull)));
(p_UsrMgmtFileNotFound=((unsigned long)(&bFileNotFound)));



}}
#line 38 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/UsrMgmt/UsrMgmt/Init.nodebug"
...
__asm__(".ascii \"iecfile \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/UsrMgmt/Init.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/UsrMgmt/Init.st.c\\\" \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/UsrMgmt/UsrMgmt/Init.st\\\"\\n\"");
__asm__(".previous");
