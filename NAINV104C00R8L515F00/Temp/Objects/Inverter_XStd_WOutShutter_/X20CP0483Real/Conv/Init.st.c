...
#include "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/Conv/Initst.h"
#line 1 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/Conv/Conv/Init.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/Conv/Conv/Init.st"
...
(p_ConvStat=((unsigned long)(&eStat)));
(p_ConvStatus=((unsigned long)(&eStatus)));
(p_ConvStatTxt=((unsigned long)(&sStatTxt)));


(p_ConvAlmData=((unsigned long)(&tyAlmData)));


(p_ConvHvBrd=((unsigned long)(&bHvBrd)));
(p_ConvRejHvBrd=((unsigned long)(&bRejHvBrd)));
(p_ConvInspHvBrd=((unsigned long)(&bInspHvBrd)));
(p_ConvGdBrd=((unsigned long)(&bGdBrd)));
(p_ConvLmtSenActivated=((unsigned long)(&bLmtSenActivated)));
(p_ConvMtrSigOnOrLToR=((unsigned long)(&bMtrSigOnOrLToR)));
(p_ConvMtrDirOrRToL=((unsigned long)(&bMtrDirOrRToL)));

(p_ConvPshrExtCtrl=((unsigned long)(&bPshrExtCtrl)));
(p_ConvPshrTwoOutputControl=((unsigned long)(&bPshrTwoOutputControl)));
(p_ConvPshrExtended=((unsigned long)(&bPshrExtended)));
(p_ConvPshrRetracted=((unsigned long)(&bPshrRetracted)));

(p_ConvPullerExtCtrl=((unsigned long)(&bPullerExtCtrl)));
(p_ConvPullerRetCtrl=((unsigned long)(&bPullerRetCtrl)));
(p_ConvPullerTwoOutputControl=((unsigned long)(&bPullerTwoOutputControl)));
(p_ConvPullerExtended=((unsigned long)(&bPullerExtended)));
(p_ConvPullerRetracted=((unsigned long)(&bPullerRetracted)));

(p_ConvRotRemoteCtrl=((unsigned long)(&bRotRemoteCtrl)));
(p_ConvRotTwoOutputControl=((unsigned long)(&bRotTwoOutputControl)));
(p_ConvRotAtRemote=((unsigned long)(&bRotAtRemote)));
(p_ConvRotAtHome=((unsigned long)(&bRotAtHome)));

(p_ConvRejectUpCtrl=((unsigned long)(&bRejectUpCtrl)));
(p_ConvRejectDownCtrl=((unsigned long)(&bRejectDownCtrl)));
(p_ConvRejectTwoOutputControl=((unsigned long)(&bRejectTwoOutputControl)));
(p_ConvRejectAtUp=((unsigned long)(&bRejectAtUp)));
(p_ConvRejectAtDown=((unsigned long)(&bRejectAtDown)));



}}
#line 51 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/Conv/Conv/Init.nodebug"
...
__asm__(".ascii \"iecfile \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/Conv/Init.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/Conv/Init.st.c\\\" \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/Conv/Conv/Init.st\\\"\\n\"");
__asm__(".previous");
