...
#include "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/NtHermes/fHermesChkParamSCst.h"
#line 1 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fHermesChkParamSC.nodebug"
#line 3 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fHermesChkParamSC.st"
unsigned long fHermesChkParamSC(struct tyHermesSetConfiguration(* tySetConfiguration), plcstring sMachineId[81]){unsigned long __AS__fHermesChkParamSC=0;signed long zzIndex00003;signed long zzIndex00002;signed long zzIndex00001;signed long zzIndex00000;signed short a_iIPPart[4]={0, 0, 0, 0};signed short i=0;{

(__AS__fHermesChkParamSC=0);

if((((unsigned long)__AS__fHermesChkParamSC==(unsigned long)0))){

if((((unsigned long)(unsigned char)((*(tySetConfiguration)).tyAvl.bMachineId)==(unsigned long)(unsigned char)1))){

if(((__AS__STRING_CMP(((*(tySetConfiguration)).tyData.sMachineId),sMachineId)!=0))){

(__AS__fHermesChkParamSC=2746);

}

}else{

(__AS__fHermesChkParamSC=2747);
...
for((i=0);i<=((*(tySetConfiguration)).tyAvl.iUpstreamConfigurations);i+=1){

if((((unsigned long)(unsigned char)((*(tySetConfiguration)).tyAvl.a_tyUpstreamConfigurations[i].bUpstreamLaneId)==(unsigned long)(unsigned char)1))){

if((((signed long)(signed long)(short)((*(tySetConfiguration)).tyData.a_tyUpstreamConfigurations[i].iUpstreamLaneId)<=(signed long)(signed long)(short)0))){

(__AS__fHermesChkParamSC=2748);
goto imp1_endfor4_0;
...
(__AS__fHermesChkParamSC=2749);
goto imp1_endfor4_0;

}

if((((unsigned long)(unsigned char)((*(tySetConfiguration)).tyAvl.a_tyUpstreamConfigurations[i].bHostAddress)==(unsigned long)(unsigned char)1))){

if((((unsigned long)fIPValid(((*(tySetConfiguration)).tyData.a_tyUpstreamConfigurations[i].sHostAddress),((unsigned long)(&a_iIPPart)))==(unsigned long)(unsigned char)0))){

(__AS__fHermesChkParamSC=2750);
goto imp1_endfor4_0;
...
for((i=0);i<=((*(tySetConfiguration)).tyAvl.iDownstreamConfigurations);i+=1){

if((((unsigned long)(unsigned char)((*(tySetConfiguration)).tyAvl.a_tyDownstreamConfigurations[i].bDownstreamLaneId)==(unsigned long)(unsigned char)1))){

if((((signed long)(signed long)(short)((*(tySetConfiguration)).tyData.a_tyDownstreamConfigurations[i].iDownstreamLaneId)<=(signed long)(signed long)(short)0))){

(__AS__fHermesChkParamSC=2752);
...
(__AS__fHermesChkParamSC=2753);
goto imp1_endfor10_0;

}

if((((unsigned long)(unsigned char)((*(tySetConfiguration)).tyAvl.a_tyDownstreamConfigurations[i].bClientAddress)==(unsigned long)(unsigned char)1))){

if((((unsigned long)fIPValid(((*(tySetConfiguration)).tyData.a_tyDownstreamConfigurations[i].sClientAddress),((unsigned long)(&a_iIPPart)))==(unsigned long)(unsigned char)0))){

(__AS__fHermesChkParamSC=2754);
goto imp1_endfor10_0;
...
}imp1_else9_0:imp1_end9_0:;return __AS__fHermesChkParamSC;}
#line 102 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fHermesChkParamSC.nodebug"

void __AS__ImplInitfHermesChkParamSC_st(void){}
...
__asm__(".ascii \"iecfile \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/NtHermes/fHermesChkParamSC.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/NtHermes/fHermesChkParamSC.st.c\\\" \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fHermesChkParamSC.st\\\"\\n\"");
