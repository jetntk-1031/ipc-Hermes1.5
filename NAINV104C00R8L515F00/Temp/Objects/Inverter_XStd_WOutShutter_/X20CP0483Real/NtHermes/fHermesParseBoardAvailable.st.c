...
#include "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/NtHermes/fHermesParseBoardAvailablest.h"
#line 1 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fHermesParseBoardAvailable.nodebug"
#line 3 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fHermesParseBoardAvailable.st"
plcbit fHermesParseBoardAvailable(struct tyHermesBoardAvailable(* p_tyBoardAvailable), struct tyXMLTableDat(* tyXMLTableCurr), struct tyXMLTableDat(* tyXMLTableNxt), plcstring sCurrValueLowerCase[255], signed short(* iSubBoardCntr)){plcbit __AS__fHermesParseBoardAvailable=0;{


(__AS__fHermesParseBoardAvailable=1);

if((((__AS__STRING_CMP(((*(tyXMLTableCurr)).sTitle),"AT")==0))&((__AS__STRING_CMP(sCurrValueLowerCase,"boardid")==0)))){

((*(p_tyBoardAvailable)).tyAvl.bBoardId=1);

if(((__AS__STRING_CMP(((*(tyXMLTableNxt)).sTitle),"AV")==0))){
{int zzIndex; plcstring* zzLValue=(plcstring*)((*(p_tyBoardAvailable)).tyData.sBoardId); plcstring* zzRValue=(plcstring*)((*(tyXMLTableNxt)).sValue); for(zzIndex=0; zzIndex<36l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
}

}else if((((__AS__STRING_CMP(((*(tyXMLTableCurr)).sTitle),"AT")==0))&((__AS__STRING_CMP(sCurrValueLowerCase,"boardidcreatedby")==0)))){

((*(p_tyBoardAvailable)).tyAvl.bBoardIdCreatedBy=1);

if(((__AS__STRING_CMP(((*(tyXMLTableNxt)).sTitle),"AV")==0))){
{int zzIndex; plcstring* zzLValue=(plcstring*)((*(p_tyBoardAvailable)).tyData.sBoardIdCreatedBy); plcstring* zzRValue=(plcstring*)((*(tyXMLTableNxt)).sValue); for(zzIndex=0; zzIndex<80l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
}

}else if((((__AS__STRING_CMP(((*(tyXMLTableCurr)).sTitle),"AT")==0))&((__AS__STRING_CMP(sCurrValueLowerCase,"failedboard")==0)))){

((*(p_tyBoardAvailable)).tyAvl.bFailedBoard=1);

if(((__AS__STRING_CMP(((*(tyXMLTableNxt)).sTitle),"AV")==0))){
if(((__AS__STRING_CMP(((*(tyXMLTableNxt)).sValue),"1")==0))){
((*(p_tyBoardAvailable)).tyData.eFailedBoard=1);
}else if(((__AS__STRING_CMP(((*(tyXMLTableNxt)).sValue),"2")==0))){
((*(p_tyBoardAvailable)).tyData.eFailedBoard=2);
}else{
((*(p_tyBoardAvailable)).tyData.eFailedBoard=0);
}
}

}else if((((__AS__STRING_CMP(((*(tyXMLTableCurr)).sTitle),"AT")==0))&((__AS__STRING_CMP(sCurrValueLowerCase,"producttypeid")==0)))){

((*(p_tyBoardAvailable)).tyAvl.bProductTypeId=1);

if(((__AS__STRING_CMP(((*(tyXMLTableNxt)).sTitle),"AV")==0))){
{int zzIndex; plcstring* zzLValue=(plcstring*)((*(p_tyBoardAvailable)).tyData.sProductTypeId); plcstring* zzRValue=(plcstring*)((*(tyXMLTableNxt)).sValue); for(zzIndex=0; zzIndex<254l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
}

}else if((((__AS__STRING_CMP(((*(tyXMLTableCurr)).sTitle),"AT")==0))&((__AS__STRING_CMP(sCurrValueLowerCase,"flippedboard")==0)))){

((*(p_tyBoardAvailable)).tyAvl.bFlippedBoard=1);

if(((__AS__STRING_CMP(((*(tyXMLTableNxt)).sTitle),"AV")==0))){
if(((__AS__STRING_CMP(((*(tyXMLTableNxt)).sValue),"1")==0))){
((*(p_tyBoardAvailable)).tyData.eFlippedBoard=1);
}else if(((__AS__STRING_CMP(((*(tyXMLTableNxt)).sValue),"2")==0))){
((*(p_tyBoardAvailable)).tyData.eFlippedBoard=2);
}else{
((*(p_tyBoardAvailable)).tyData.eFlippedBoard=0);
}
}

}else if((((__AS__STRING_CMP(((*(tyXMLTableCurr)).sTitle),"AT")==0))&((__AS__STRING_CMP(sCurrValueLowerCase,"topbarcode")==0)))){

((*(p_tyBoardAvailable)).tyAvl.bTopBarcode=1);

if(((__AS__STRING_CMP(((*(tyXMLTableNxt)).sTitle),"AV")==0))){
{int zzIndex; plcstring* zzLValue=(plcstring*)((*(p_tyBoardAvailable)).tyData.sTopBarcode); plcstring* zzRValue=(plcstring*)((*(tyXMLTableNxt)).sValue); for(zzIndex=0; zzIndex<254l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
}

}else if((((__AS__STRING_CMP(((*(tyXMLTableCurr)).sTitle),"AT")==0))&((__AS__STRING_CMP(sCurrValueLowerCase,"bottombarcode")==0)))){

((*(p_tyBoardAvailable)).tyAvl.bBottomBarcode=1);

if(((__AS__STRING_CMP(((*(tyXMLTableNxt)).sTitle),"AV")==0))){
{int zzIndex; plcstring* zzLValue=(plcstring*)((*(p_tyBoardAvailable)).tyData.sBottomBarcode); plcstring* zzRValue=(plcstring*)((*(tyXMLTableNxt)).sValue); for(zzIndex=0; zzIndex<254l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
}

}else if((((__AS__STRING_CMP(((*(tyXMLTableCurr)).sTitle),"AT")==0))&((__AS__STRING_CMP(sCurrValueLowerCase,"length")==0)))){

((*(p_tyBoardAvailable)).tyAvl.bLength=1);

if(((__AS__STRING_CMP(((*(tyXMLTableNxt)).sTitle),"AV")==0))){
((*(p_tyBoardAvailable)).tyData.rLength=str2real(((*(tyXMLTableNxt)).sValue)));
}

}else if((((__AS__STRING_CMP(((*(tyXMLTableCurr)).sTitle),"AT")==0))&((__AS__STRING_CMP(sCurrValueLowerCase,"width")==0)))){

((*(p_tyBoardAvailable)).tyAvl.bWidth=1);

if(((__AS__STRING_CMP(((*(tyXMLTableNxt)).sTitle),"AV")==0))){
((*(p_tyBoardAvailable)).tyData.rWidth=str2real(((*(tyXMLTableNxt)).sValue)));
}

}else if((((__AS__STRING_CMP(((*(tyXMLTableCurr)).sTitle),"AT")==0))&((__AS__STRING_CMP(sCurrValueLowerCase,"thickness")==0)))){

((*(p_tyBoardAvailable)).tyAvl.bThickness=1);

if(((__AS__STRING_CMP(((*(tyXMLTableNxt)).sTitle),"AV")==0))){
((*(p_tyBoardAvailable)).tyData.rThickness=str2real(((*(tyXMLTableNxt)).sValue)));
}

}else if((((__AS__STRING_CMP(((*(tyXMLTableCurr)).sTitle),"AT")==0))&((__AS__STRING_CMP(sCurrValueLowerCase,"conveyorspeed")==0)))){

((*(p_tyBoardAvailable)).tyAvl.bConveyorSpeed=1);

if(((__AS__STRING_CMP(((*(tyXMLTableNxt)).sTitle),"AV")==0))){
((*(p_tyBoardAvailable)).tyData.rConveyorSpeed=str2real(((*(tyXMLTableNxt)).sValue)));
}

}else if((((__AS__STRING_CMP(((*(tyXMLTableCurr)).sTitle),"AT")==0))&((__AS__STRING_CMP(sCurrValueLowerCase,"topclearanceheight")==0)))){

((*(p_tyBoardAvailable)).tyAvl.bTopClearanceHeight=1);

if(((__AS__STRING_CMP(((*(tyXMLTableNxt)).sTitle),"AV")==0))){
((*(p_tyBoardAvailable)).tyData.rTopClearanceHeight=str2real(((*(tyXMLTableNxt)).sValue)));
}

}else if((((__AS__STRING_CMP(((*(tyXMLTableCurr)).sTitle),"AT")==0))&((__AS__STRING_CMP(sCurrValueLowerCase,"bottomclearanceheight")==0)))){

((*(p_tyBoardAvailable)).tyAvl.bBottomClearanceHeight=1);

if(((__AS__STRING_CMP(((*(tyXMLTableNxt)).sTitle),"AV")==0))){
((*(p_tyBoardAvailable)).tyData.rBottomClearanceHeight=str2real(((*(tyXMLTableNxt)).sValue)));
}

}else if((((__AS__STRING_CMP(((*(tyXMLTableCurr)).sTitle),"AT")==0))&((__AS__STRING_CMP(sCurrValueLowerCase,"weight")==0)))){

((*(p_tyBoardAvailable)).tyAvl.bWeight=1);

if(((__AS__STRING_CMP(((*(tyXMLTableNxt)).sTitle),"AV")==0))){
((*(p_tyBoardAvailable)).tyData.rWeight=str2real(((*(tyXMLTableNxt)).sValue)));
}

}else if((((__AS__STRING_CMP(((*(tyXMLTableCurr)).sTitle),"AT")==0))&((__AS__STRING_CMP(sCurrValueLowerCase,"workorderid")==0)))){

((*(p_tyBoardAvailable)).tyAvl.bWorkOrderId=1);

if(((__AS__STRING_CMP(((*(tyXMLTableNxt)).sTitle),"AV")==0))){
{int zzIndex; plcstring* zzLValue=(plcstring*)((*(p_tyBoardAvailable)).tyData.sWorkOrderId); plcstring* zzRValue=(plcstring*)((*(tyXMLTableNxt)).sValue); for(zzIndex=0; zzIndex<80l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
}

}else if((((__AS__STRING_CMP(((*(tyXMLTableCurr)).sTitle),"AT")==0))&((__AS__STRING_CMP(sCurrValueLowerCase,"batchid")==0)))){

((*(p_tyBoardAvailable)).tyAvl.bBatchId=1);

if(((__AS__STRING_CMP(((*(tyXMLTableNxt)).sTitle),"AV")==0))){
{int zzIndex; plcstring* zzLValue=(plcstring*)((*(p_tyBoardAvailable)).tyData.sBatchId); plcstring* zzRValue=(plcstring*)((*(tyXMLTableNxt)).sValue); for(zzIndex=0; zzIndex<80l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
}
}else if((((__AS__STRING_CMP(((*(tyXMLTableCurr)).sTitle),"AT")==0))&((__AS__STRING_CMP(sCurrValueLowerCase,"route")==0)))){

((*(p_tyBoardAvailable)).tyAvl.bRoute=1);

if(((__AS__STRING_CMP(((*(tyXMLTableNxt)).sTitle),"AV")==0))){
((*(p_tyBoardAvailable)).tyData.iRoute=str2int(((*(tyXMLTableNxt)).sValue)));
}
}else if((((__AS__STRING_CMP(((*(tyXMLTableCurr)).sTitle),"AT")==0))&((__AS__STRING_CMP(sCurrValueLowerCase,"action")==0)))){

((*(p_tyBoardAvailable)).tyAvl.bAction=1);

if(((__AS__STRING_CMP(((*(tyXMLTableNxt)).sTitle),"AV")==0))){
((*(p_tyBoardAvailable)).tyData.iAction=str2int(((*(tyXMLTableNxt)).sValue)));
}
}else if((((__AS__STRING_CMP(((*(tyXMLTableCurr)).sTitle),"ST")==0))&((__AS__STRING_CMP(sCurrValueLowerCase,"sb")==0)))){
((*(iSubBoardCntr))=(((*(iSubBoardCntr)))+1));
}else if((((__AS__STRING_CMP(((*(tyXMLTableCurr)).sTitle),"AT")==0))&((__AS__STRING_CMP(sCurrValueLowerCase,"pos")==0)))){
((*(p_tyBoardAvailable)).tyAvl.tySubBoards.bSubBoardsPos[((*(iSubBoardCntr)))]=1);

if(((__AS__STRING_CMP(((*(tyXMLTableNxt)).sTitle),"AV")==0))){
((*(p_tyBoardAvailable)).tyData.tySubBoards.iSubBoardsPos[((*(iSubBoardCntr)))]=str2int(((*(tyXMLTableNxt)).sValue)));
}
}else if((((__AS__STRING_CMP(((*(tyXMLTableCurr)).sTitle),"AT")==0))&((__AS__STRING_CMP(sCurrValueLowerCase,"bc")==0)))){

((*(p_tyBoardAvailable)).tyAvl.tySubBoards.bSubBoardsBc[((*(iSubBoardCntr)))]=1);

if(((__AS__STRING_CMP(((*(tyXMLTableNxt)).sTitle),"AV")==0))){
{int zzIndex; plcstring* zzLValue=(plcstring*)((*(p_tyBoardAvailable)).tyData.tySubBoards.sSubBoardsBc[((*(iSubBoardCntr)))]); plcstring* zzRValue=(plcstring*)((*(tyXMLTableNxt)).sValue); for(zzIndex=0; zzIndex<80l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
}
}else if((((__AS__STRING_CMP(((*(tyXMLTableCurr)).sTitle),"AT")==0))&((__AS__STRING_CMP(sCurrValueLowerCase,"st")==0)))){

((*(p_tyBoardAvailable)).tyAvl.tySubBoards.bSubBoardsSt[((*(iSubBoardCntr)))]=1);

if(((__AS__STRING_CMP(((*(tyXMLTableNxt)).sTitle),"AV")==0))){
((*(p_tyBoardAvailable)).tyData.tySubBoards.iSubBoardsSt[((*(iSubBoardCntr)))]=str2int(((*(tyXMLTableNxt)).sValue)));
}
}

}imp1_else23_0:imp1_end23_0:imp1_else0_21:imp1_end0_0:;return __AS__fHermesParseBoardAvailable;}
#line 185 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fHermesParseBoardAvailable.nodebug"

void __AS__ImplInitfHermesParseBoardAvailable_st(void){}
...
__asm__(".ascii \"iecfile \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/NtHermes/fHermesParseBoardAvailable.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/NtHermes/fHermesParseBoardAvailable.st.c\\\" \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fHermesParseBoardAvailable.st\\\"\\n\"");
