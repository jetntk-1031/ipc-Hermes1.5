...
#include "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/NtHermes/fbHermesProcessCmdst.h"
#line 1 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/Command/fbHermesProcessCmd.nodebug"
#line 3 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/Command/fbHermesProcessCmd.st"
plcbit fHermesProcessCmd(struct tyHermesCmdProcessList tyCommandProcessList[7], struct tyHermesCommandPause tyHermesCmdPause[7], unsigned char a_usiCommandIdx[7]){plcbit __AS__fHermesProcessCmd=0;unsigned char usiPrevCmdIdx=0;unsigned char usiCmpIdx=0;unsigned char usiIdx=0;unsigned long(* p_udiComMode);plcstring(* p_sInterface)[81];plcstring(* p_sCmpInterface)[81];struct tyHermesCommandPause(* p_tyHermesCmdPause);struct tyHermesCommandParam(* p_udiHermesCmpCmdParam);struct tyHermesCommandParam(* p_tyHermesCmdParam);{

for((usiIdx=0);usiIdx<=7;usiIdx+=1){
if(((((unsigned long)tyCommandProcessList[usiIdx].udiCommandParam!=(unsigned long)0))&(((unsigned long)tyCommandProcessList[usiIdx].udiComMode!=(unsigned long)0))&(((unsigned long)tyCommandProcessList[usiIdx].udiInterfaceString!=(unsigned long)0)))){
(p_tyHermesCmdParam=tyCommandProcessList[usiIdx].udiCommandParam);
(p_tyHermesCmdPause=((unsigned long)(&tyHermesCmdPause[usiIdx])));


if((((unsigned long)(unsigned char)((*(p_tyHermesCmdParam)).usiCommandIdx)!=(unsigned long)(unsigned char)a_usiCommandIdx[usiIdx]))){
...
if((((unsigned long)(unsigned char)usiPrevCmdIdx!=(unsigned long)(unsigned char)a_usiCommandIdx[usiIdx]))){
for((usiCmpIdx=0);usiCmpIdx<=7;usiCmpIdx+=1){
if((((unsigned long)(unsigned char)usiIdx!=(unsigned long)(unsigned char)usiCmpIdx))){
(p_sCmpInterface=tyCommandProcessList[usiCmpIdx].udiCommandParam);
(p_udiComMode=tyCommandProcessList[usiCmpIdx].udiComMode);
if((((__AS__STRING_CMP(((*(p_sInterface))),((*(p_sCmpInterface))))!=0))&(((unsigned long)((*(p_udiComMode)))==(unsigned long)0)))){
(p_udiHermesCmpCmdParam=tyCommandProcessList[usiCmpIdx].udiCommandParam);
...
}return __AS__fHermesProcessCmd;}
#line 58 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/Command/fbHermesProcessCmd.nodebug"

void __AS__ImplInitfbHermesProcessCmd_st(void){}
...
__asm__(".ascii \"iecfile \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/NtHermes/fbHermesProcessCmd.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/NtHermes/fbHermesProcessCmd.st.c\\\" \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/Command/fbHermesProcessCmd.st\\\"\\n\"");
