...
#include "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/NtHermes/fbHermesGetSndConfigst.h"
#line 1 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fbHermesGetSndConfig.nodebug"
#line 3 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fbHermesGetSndConfig.st"
void fbHermesGetSndConfig(struct fbHermesGetSndConfig* inst){struct fbHermesGetSndConfig* __inst__=inst;{
...
if((((unsigned long)(unsigned char)((*(__inst__->p_tyMsgTypeRcv)).bGetConfiguration)==(unsigned long)(unsigned char)1))){

((*(__inst__->p_tyMsgTypeRcv)).bGetConfiguration=0);


((*(__inst__->p_tyMsgTypeSnd)).bCurrentConfiguration=1);

(__inst__->tyCurrentConfiguration.tyData=*(struct tyHermesCurrentConfigurationData*)&__inst__->tyCurrentConfigurationData);

if(((__AS__STRING_CMP(__inst__->tyCurrentConfiguration.tyData.sMachineId,"")!=0))){
(__inst__->tyCurrentConfiguration.tyAvl.bMachineId=1);
}

for((__inst__->di=0);__inst__->di<=3;__inst__->di+=1){

if((((signed long)(signed long)(short)__inst__->tyCurrentConfiguration.tyData.a_tyUpstreamConfigurations[__inst__->di].iUpstreamLaneId!=(signed long)(signed long)(short)0))){
(__inst__->tyCurrentConfiguration.tyAvl.a_tyUpstreamConfigurations[__inst__->di].bUpstreamLaneId=1);
(__inst__->tyCurrentConfiguration.tyAvl.bUpstreamConfigurations=1);
(__inst__->tyCurrentConfiguration.tyAvl.iUpstreamConfigurations=((signed short)__inst__->di+1));

if(((__AS__STRING_CMP(__inst__->tyCurrentConfiguration.tyData.a_tyUpstreamConfigurations[__inst__->di].sUpstreamInterfaceId,"")!=0))){
(__inst__->tyCurrentConfiguration.tyAvl.a_tyUpstreamConfigurations[__inst__->di].bUpstreamInterfaceId=1);
}

if(((__AS__STRING_CMP(__inst__->tyCurrentConfiguration.tyData.a_tyUpstreamConfigurations[__inst__->di].sHostAddress,"")!=0))){
(__inst__->tyCurrentConfiguration.tyAvl.a_tyUpstreamConfigurations[__inst__->di].bHostAddress=1);
}

if((((unsigned long)(unsigned short)__inst__->tyCurrentConfiguration.tyData.a_tyUpstreamConfigurations[__inst__->di].uiPort!=(unsigned long)(unsigned short)0))){
(__inst__->tyCurrentConfiguration.tyAvl.a_tyUpstreamConfigurations[__inst__->di].bPort=1);
}
...
if((((signed long)(signed long)(short)__inst__->tyCurrentConfiguration.tyData.a_tyDownstreamConfigurations[__inst__->di].iDownstreamLaneId!=(signed long)(signed long)(short)0))){
(__inst__->tyCurrentConfiguration.tyAvl.a_tyDownstreamConfigurations[__inst__->di].bDownstreamLaneId=1);
(__inst__->tyCurrentConfiguration.tyAvl.bDownstreamConfigurations=1);
(__inst__->tyCurrentConfiguration.tyAvl.iDownstreamConfigurations=((signed short)__inst__->di+1));

if(((__AS__STRING_CMP(__inst__->tyCurrentConfiguration.tyData.a_tyDownstreamConfigurations[__inst__->di].sDownstreamInterfaceId,"")!=0))){
(__inst__->tyCurrentConfiguration.tyAvl.a_tyDownstreamConfigurations[__inst__->di].bDownstreamInterfaceId=1);
}

if(((__AS__STRING_CMP(__inst__->tyCurrentConfiguration.tyData.a_tyDownstreamConfigurations[__inst__->di].sClientAddress,"")!=0))){
(__inst__->tyCurrentConfiguration.tyAvl.a_tyDownstreamConfigurations[__inst__->di].bClientAddress=1);
}

if((((unsigned long)(unsigned short)__inst__->tyCurrentConfiguration.tyData.a_tyDownstreamConfigurations[__inst__->di].uiPort!=(unsigned long)(unsigned short)0))){
(__inst__->tyCurrentConfiguration.tyAvl.a_tyDownstreamConfigurations[__inst__->di].bPort=1);
}
...
#line 86 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fbHermesGetSndConfig.nodebug"

void __AS__ImplInitfbHermesGetSndConfig_st(void){}
...
__asm__(".ascii \"iecfile \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/NtHermes/fbHermesGetSndConfig.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/NtHermes/fbHermesGetSndConfig.st.c\\\" \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fbHermesGetSndConfig.st\\\"\\n\"");
