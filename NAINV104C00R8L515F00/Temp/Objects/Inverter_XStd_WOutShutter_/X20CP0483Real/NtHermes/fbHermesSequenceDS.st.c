...
#include "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/NtHermes/fbHermesSequenceDSst.h"
#line 1 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fbHermesSequenceDS.nodebug"
#line 3 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fbHermesSequenceDS.st"
void fbHermesSequenceDS(struct fbHermesSequenceDS* inst){struct fbHermesSequenceDS* __inst__=inst;{

if(((((unsigned long)(unsigned char)__inst__->bEn==(unsigned long)(unsigned char)1))&(((unsigned long)__inst__->udiStatus>=(unsigned long)65534)))){

(__inst__->udiStatus=65535);

if(((((unsigned long)(unsigned char)__inst__->bRstState==(unsigned long)(unsigned char)1))&(((signed long)__inst__->eState!=(signed long)0))&(((signed long)__inst__->eState!=(signed long)2)))){
(__inst__->eState=4);
}

(__inst__->eMsgTypeSnd=0);

switch(__inst__->eState){

case 0:{
if((((unsigned long)(unsigned char)((*(__inst__->p_tyMsgTypeRcv)).bServiceDescription)==(unsigned long)(unsigned char)1))){

((*(__inst__->p_tyMsgTypeRcv)).bServiceDescription=0);
...
(__inst__->eMsgTypeSnd=4);

(__inst__->eState=4);

}break;case 4:{

if((((unsigned long)(unsigned char)__inst__->bFeatureBoardForecast==(unsigned long)(unsigned char)1))){
if(__inst__->bOpsRun){
if(((((unsigned long)(unsigned char)__inst__->bSendBFId==(unsigned long)(unsigned char)1))&(((unsigned long)(unsigned char)__inst__->bBFIdSent==(unsigned long)(unsigned char)0)))){
(__inst__->eMsgTypeSnd=18);

}else if(((((unsigned long)(unsigned char)__inst__->bSendBFId==(unsigned long)(unsigned char)0))&(__inst__->bSendBFNoID&~__inst__->zzEdge00000&1?((__inst__->zzEdge00000=__inst__->bSendBFNoID&1),1):((__inst__->zzEdge00000=__inst__->bSendBFNoID&1),0)))){
(__inst__->eMsgTypeSnd=19);
...
if(((((unsigned long)(unsigned char)__inst__->bRdySnd==(unsigned long)(unsigned char)1))&(((unsigned long)(unsigned char)__inst__->bBlkDS==(unsigned long)(unsigned char)0))&(((unsigned long)(unsigned char)__inst__->bSendBFId==(unsigned long)(unsigned char)0))&(((unsigned long)(unsigned char)__inst__->bFeatureBoardForecast==(unsigned long)(unsigned char)1)))){

(__inst__->eMsgTypeSnd=7);

(__inst__->eState=5);

}else if(((((unsigned long)(unsigned char)__inst__->bRdySnd==(unsigned long)(unsigned char)1))&(((unsigned long)(unsigned char)__inst__->bBlkDS==(unsigned long)(unsigned char)0))&(((unsigned long)(unsigned char)__inst__->bSendBFId==(unsigned long)(unsigned char)0))&(((unsigned long)(unsigned char)__inst__->bFeatureBoardForecast==(unsigned long)(unsigned char)0)))){

(__inst__->eMsgTypeSnd=7);

(__inst__->eState=5);

}else if((((unsigned long)(unsigned char)((*(__inst__->p_tyMsgTypeRcv)).bMachineReady)==(unsigned long)(unsigned char)1))){

((*(__inst__->p_tyMsgTypeRcv)).bMachineReady=0);
...
if((((((unsigned long)(unsigned char)__inst__->bRdySnd==(unsigned long)(unsigned char)0))|(((unsigned long)(unsigned char)__inst__->bBlkDS==(unsigned long)(unsigned char)1)))&(((unsigned long)(unsigned char)__inst__->bSendBFId==(unsigned long)(unsigned char)0)))){

(__inst__->eMsgTypeSnd=8);
...
}else if(((((unsigned long)(unsigned char)__inst__->bSendBFId==(unsigned long)(unsigned char)0))&(__inst__->bSendBFNoID&~__inst__->zzEdge00001&1?((__inst__->zzEdge00001=__inst__->bSendBFNoID&1),1):((__inst__->zzEdge00001=__inst__->bSendBFNoID&1),0)))){
...
}else if((((unsigned long)(unsigned char)((*(__inst__->p_tyMsgTypeRcv)).bRevokeMachineReady)==(unsigned long)(unsigned char)1))){

((*(__inst__->p_tyMsgTypeRcv)).bRevokeMachineReady=0);

(__inst__->eState=4);

}else if(((((unsigned long)(unsigned char)((*(__inst__->p_tyMsgTypeRcv)).bStartTransport)==(unsigned long)(unsigned char)1))&(((unsigned long)(unsigned char)__inst__->bSendBFId==(unsigned long)(unsigned char)0)))){

((*(__inst__->p_tyMsgTypeRcv)).bStartTransport=0);
(__inst__->bStopTransport=0);
...
if(((((unsigned long)(unsigned char)__inst__->bRdySnd==(unsigned long)(unsigned char)0))|(((unsigned long)(unsigned char)__inst__->bBlkDS==(unsigned long)(unsigned char)1)))){
...
}else if((((unsigned long)(unsigned char)((*(__inst__->p_tyMsgTypeRcv)).bStartTransport)==(unsigned long)(unsigned char)1))){
...
if((__inst__->bSndCompl|__inst__->bSndIncompl|__inst__->bSndNotStart)){

(__inst__->eMsgTypeSnd=13);
(__inst__->bStopTransport=(__inst__->bSndIncompl|__inst__->bSndNotStart));

(__inst__->eState=10);

}else if((((unsigned long)(unsigned char)((*(__inst__->p_tyMsgTypeRcv)).bStopTransport)==(unsigned long)(unsigned char)1))){

((*(__inst__->p_tyMsgTypeRcv)).bStopTransport=0);
...
if((((unsigned long)(unsigned char)((*(__inst__->p_tyMsgTypeRcv)).bStopTransport)==(unsigned long)(unsigned char)1))){
...
(__inst__->bUSRdy=((((signed long)__inst__->eState==(signed long)5))|(((signed long)__inst__->eState==(signed long)7))|(((signed long)__inst__->eState>=(signed long)8))));
(__inst__->bDSRdy=((((signed long)__inst__->eState==(signed long)6))|(((signed long)__inst__->eState==(signed long)7))|(((signed long)__inst__->eState>=(signed long)8))));
(__inst__->bTransporting=(((signed long)__inst__->eState>=(signed long)8)));

}else if(((((unsigned long)(unsigned char)__inst__->bEn==(unsigned long)(unsigned char)0))&(((unsigned long)__inst__->udiStatus!=(unsigned long)65534)))){

(__inst__->udiStatus=65534);

(__inst__->bUSRdy=0);
(__inst__->bDSRdy=0);
(__inst__->bTransporting=0);
(__inst__->bStopTransport=0);
...
#line 202 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fbHermesSequenceDS.nodebug"

void __AS__ImplInitfbHermesSequenceDS_st(void){}
...
__asm__(".ascii \"iecfile \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/NtHermes/fbHermesSequenceDS.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/NtHermes/fbHermesSequenceDS.st.c\\\" \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fbHermesSequenceDS.st\\\"\\n\"");
