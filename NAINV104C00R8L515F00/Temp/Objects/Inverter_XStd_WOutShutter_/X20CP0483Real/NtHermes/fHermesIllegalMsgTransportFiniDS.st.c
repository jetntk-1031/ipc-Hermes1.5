...
#include "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/NtHermes/fHermesIllegalMsgTransportFiniDSst.h"
#line 1 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fHermesIllegalMsgTransportFiniDS.nodebug"
#line 3 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fHermesIllegalMsgTransportFiniDS.st"
unsigned long fHermesIllegalMsgTransportFiniDS(struct tyHermesMsgType(* tyMsgType)){unsigned long __AS__fHermesIllegalMsgTransportFiniDS=0;{

if((((unsigned long)(unsigned char)((*(tyMsgType)).bServiceDescription)==(unsigned long)(unsigned char)1))){

(__AS__fHermesIllegalMsgTransportFiniDS=2895);

}else if((((unsigned long)(unsigned char)((*(tyMsgType)).bBoardAvailable)==(unsigned long)(unsigned char)1))){

(__AS__fHermesIllegalMsgTransportFiniDS=2896);

}else if((((unsigned long)(unsigned char)((*(tyMsgType)).bRevokeBoardAvailable)==(unsigned long)(unsigned char)1))){

(__AS__fHermesIllegalMsgTransportFiniDS=2897);

}else if((((unsigned long)(unsigned char)((*(tyMsgType)).bMachineReady)==(unsigned long)(unsigned char)1))){

(__AS__fHermesIllegalMsgTransportFiniDS=2898);

}else if((((unsigned long)(unsigned char)((*(tyMsgType)).bRevokeMachineReady)==(unsigned long)(unsigned char)1))){

(__AS__fHermesIllegalMsgTransportFiniDS=2899);

}else if((((unsigned long)(unsigned char)((*(tyMsgType)).bStartTransport)==(unsigned long)(unsigned char)1))){

(__AS__fHermesIllegalMsgTransportFiniDS=2900);

}else if((((unsigned long)(unsigned char)((*(tyMsgType)).bTransportFinished)==(unsigned long)(unsigned char)1))){

(__AS__fHermesIllegalMsgTransportFiniDS=2901);

}else if((((unsigned long)(unsigned char)((*(tyMsgType)).bBoardForecast)==(unsigned long)(unsigned char)1))){

(__AS__fHermesIllegalMsgTransportFiniDS=2902);

}else{

(__AS__fHermesIllegalMsgTransportFiniDS=0);

}

}imp1_end0_0:;return __AS__fHermesIllegalMsgTransportFiniDS;}
#line 43 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fHermesIllegalMsgTransportFiniDS.nodebug"

void __AS__ImplInitfHermesIllegalMsgTransportFiniDS_st(void){}
...
__asm__(".ascii \"iecfile \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/NtHermes/fHermesIllegalMsgTransportFiniDS.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/NtHermes/fHermesIllegalMsgTransportFiniDS.st.c\\\" \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fHermesIllegalMsgTransportFiniDS.st\\\"\\n\"");
