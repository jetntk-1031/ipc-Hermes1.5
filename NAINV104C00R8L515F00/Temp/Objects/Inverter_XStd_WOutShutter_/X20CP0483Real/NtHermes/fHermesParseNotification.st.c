...
#include "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/NtHermes/fHermesParseNotificationst.h"
#line 1 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fHermesParseNotification.nodebug"
#line 3 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fHermesParseNotification.st"
plcbit fHermesParseNotification(struct tyHermesNotification(* p_tyNotification), struct tyXMLTableDat(* tyXMLTableCurr), struct tyXMLTableDat(* tyXMLTableNxt), plcstring sCurrValueLowerCase[255]){plcbit __AS__fHermesParseNotification=0;{

(__AS__fHermesParseNotification=1);

if((((__AS__STRING_CMP(((*(tyXMLTableCurr)).sTitle),"AT")==0))&((__AS__STRING_CMP(sCurrValueLowerCase,"notificationcode")==0)))){

((*(p_tyNotification)).tyAvl.bNotificationCode=1);

if(((__AS__STRING_CMP(((*(tyXMLTableNxt)).sTitle),"AV")==0))){
((*(p_tyNotification)).tyData.iNotificationCode=str2int(((*(tyXMLTableNxt)).sValue)));
}

}else if((((__AS__STRING_CMP(((*(tyXMLTableCurr)).sTitle),"AT")==0))&((__AS__STRING_CMP(sCurrValueLowerCase,"severity")==0)))){

((*(p_tyNotification)).tyAvl.bSeverity=1);

if(((__AS__STRING_CMP(((*(tyXMLTableNxt)).sTitle),"AV")==0))){
if(((__AS__STRING_CMP(((*(tyXMLTableNxt)).sValue),"1")==0))){
((*(p_tyNotification)).tyData.eSeverity=1);
}else if(((__AS__STRING_CMP(((*(tyXMLTableNxt)).sValue),"2")==0))){
((*(p_tyNotification)).tyData.eSeverity=2);
}else if(((__AS__STRING_CMP(((*(tyXMLTableNxt)).sValue),"3")==0))){
((*(p_tyNotification)).tyData.eSeverity=3);
}else{
((*(p_tyNotification)).tyData.eSeverity=4);
}
}

}else if((((__AS__STRING_CMP(((*(tyXMLTableCurr)).sTitle),"AT")==0))&((__AS__STRING_CMP(sCurrValueLowerCase,"description")==0)))){

((*(p_tyNotification)).tyAvl.bDescription=1);

if(((__AS__STRING_CMP(((*(tyXMLTableNxt)).sTitle),"AV")==0))){
{int zzIndex; plcstring* zzLValue=(plcstring*)((*(p_tyNotification)).tyData.sDescription); plcstring* zzRValue=(plcstring*)((*(tyXMLTableNxt)).sValue); for(zzIndex=0; zzIndex<254l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
}

}

}imp1_else4_0:imp1_end4_0:imp1_else0_2:imp1_end0_0:;return __AS__fHermesParseNotification;}
#line 41 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fHermesParseNotification.nodebug"

void __AS__ImplInitfHermesParseNotification_st(void){}
...
__asm__(".ascii \"iecfile \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/NtHermes/fHermesParseNotification.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/NtHermes/fHermesParseNotification.st.c\\\" \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fHermesParseNotification.st\\\"\\n\"");
