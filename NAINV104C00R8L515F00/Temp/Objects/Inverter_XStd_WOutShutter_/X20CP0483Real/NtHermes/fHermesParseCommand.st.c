...
#include "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/NtHermes/fHermesParseCommandst.h"
#line 1 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fHermesParseCommand.nodebug"
#line 3 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fHermesParseCommand.st"
plcbit fHermesParseCommand(struct tyHermesCommand(* p_tyCommand), struct tyXMLTableDat(* tyXMLTableCurr), struct tyXMLTableDat(* tyXMLTableNxt), plcstring sCurrValueLowerCase[255]){plcbit __AS__fHermesParseCommand=0;{

(__AS__fHermesParseCommand=1);

if((((__AS__STRING_CMP(((*(tyXMLTableCurr)).sTitle),"AT")==0))&((__AS__STRING_CMP(sCurrValueLowerCase,"command")==0)))){

((*(p_tyCommand)).tyAvl.bCommand=1);

if(((__AS__STRING_CMP(((*(tyXMLTableNxt)).sTitle),"AV")==0))){
if(((__AS__STRING_CMP(((*(tyXMLTableNxt)).sValue),"0")==0))){
((*(p_tyCommand)).tyData.eCommand=0);
}else if(((__AS__STRING_CMP(((*(tyXMLTableNxt)).sValue),"1")==0))){
((*(p_tyCommand)).tyData.eCommand=1);
}else if(((__AS__STRING_CMP(((*(tyXMLTableNxt)).sValue),"2")==0))){
((*(p_tyCommand)).tyData.eCommand=2);
}else if(((__AS__STRING_CMP(((*(tyXMLTableNxt)).sValue),"3")==0))){
((*(p_tyCommand)).tyData.eCommand=3);
}else if(((__AS__STRING_CMP(((*(tyXMLTableNxt)).sValue),"4")==0))){
((*(p_tyCommand)).tyData.eCommand=4);
}else if(((__AS__STRING_CMP(((*(tyXMLTableNxt)).sValue),"5")==0))){
((*(p_tyCommand)).tyData.eCommand=5);
}else if(((__AS__STRING_CMP(((*(tyXMLTableNxt)).sValue),"1000")==0))){
((*(p_tyCommand)).tyData.eCommand=1000);
}else if(((__AS__STRING_CMP(((*(tyXMLTableNxt)).sValue),"1001")==0))){
((*(p_tyCommand)).tyData.eCommand=1001);
}
}
...
}imp1_else2_7:imp1_end2_0:imp1_else1_0:imp1_end1_0:imp1_else0_0:imp1_end0_0:;return __AS__fHermesParseCommand;}
#line 34 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fHermesParseCommand.nodebug"

void __AS__ImplInitfHermesParseCommand_st(void){}
...
__asm__(".ascii \"iecfile \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/NtHermes/fHermesParseCommand.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/NtHermes/fHermesParseCommand.st.c\\\" \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fHermesParseCommand.st\\\"\\n\"");
