...
#include "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/NtHermes/fHermesChkParamBAMRst.h"
#line 1 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fHermesChkParamBAMR.nodebug"
#line 3 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fHermesChkParamBAMR.st"
unsigned long fHermesChkParamBAMR(struct tyHermesBoardAvailable(* tyBoardAvailable), struct tyHermesMachineReady(* tyMachineReady)){unsigned long __AS__fHermesChkParamBAMR=0;signed long zzIndex00003;signed long zzIndex00002;signed long zzIndex00001;signed long zzIndex00000;{

(__AS__fHermesChkParamBAMR=0);

if((((unsigned long)__AS__fHermesChkParamBAMR==(unsigned long)0))){

if(((((unsigned long)(unsigned char)((*(tyBoardAvailable)).tyAvl.bBoardId)==(unsigned long)(unsigned char)1))&(((unsigned long)(unsigned char)((*(tyMachineReady)).tyAvl.bBoardId)==(unsigned long)(unsigned char)1)))){

if(((__AS__STRING_CMP(((*(tyBoardAvailable)).tyData.sBoardId),((*(tyMachineReady)).tyData.sBoardId))!=0))){

(__AS__fHermesChkParamBAMR=2700);
...
if(((((unsigned long)(unsigned char)((*(tyBoardAvailable)).tyAvl.bProductTypeId)==(unsigned long)(unsigned char)1))&(((unsigned long)(unsigned char)((*(tyMachineReady)).tyAvl.bProductTypeId)==(unsigned long)(unsigned char)1)))){

if(((__AS__STRING_CMP(((*(tyBoardAvailable)).tyData.sProductTypeId),((*(tyMachineReady)).tyData.sProductTypeId))!=0))){

(__AS__fHermesChkParamBAMR=2701);
...
if(((((unsigned long)(unsigned char)((*(tyBoardAvailable)).tyAvl.bFlippedBoard)==(unsigned long)(unsigned char)1))&(((unsigned long)(unsigned char)((*(tyMachineReady)).tyAvl.bFlippedBoard)==(unsigned long)(unsigned char)1)))){

if((((signed long)((*(tyBoardAvailable)).tyData.eFlippedBoard)!=(signed long)((*(tyMachineReady)).tyData.eFlippedBoard)))){

(__AS__fHermesChkParamBAMR=2702);
...
if(((((unsigned long)(unsigned char)((*(tyBoardAvailable)).tyAvl.bLength)==(unsigned long)(unsigned char)1))&(((unsigned long)(unsigned char)((*(tyMachineReady)).tyAvl.bLength)==(unsigned long)(unsigned char)1)))){

if(((((*(tyBoardAvailable)).tyData.rLength)!=((*(tyMachineReady)).tyData.rLength)))){

(__AS__fHermesChkParamBAMR=2703);
...
if(((((unsigned long)(unsigned char)((*(tyBoardAvailable)).tyAvl.bWidth)==(unsigned long)(unsigned char)1))&(((unsigned long)(unsigned char)((*(tyMachineReady)).tyAvl.bWidth)==(unsigned long)(unsigned char)1)))){

if(((((*(tyBoardAvailable)).tyData.rWidth)!=((*(tyMachineReady)).tyData.rWidth)))){

(__AS__fHermesChkParamBAMR=2704);
...
if(((((unsigned long)(unsigned char)((*(tyBoardAvailable)).tyAvl.bThickness)==(unsigned long)(unsigned char)1))&(((unsigned long)(unsigned char)((*(tyMachineReady)).tyAvl.bThickness)==(unsigned long)(unsigned char)1)))){

if(((((*(tyBoardAvailable)).tyData.rThickness)!=((*(tyMachineReady)).tyData.rThickness)))){

(__AS__fHermesChkParamBAMR=2705);
...
if(((((unsigned long)(unsigned char)((*(tyBoardAvailable)).tyAvl.bConveyorSpeed)==(unsigned long)(unsigned char)1))&(((unsigned long)(unsigned char)((*(tyMachineReady)).tyAvl.bConveyorSpeed)==(unsigned long)(unsigned char)1)))){

if(((((*(tyBoardAvailable)).tyData.rConveyorSpeed)!=((*(tyMachineReady)).tyData.rConveyorSpeed)))){

(__AS__fHermesChkParamBAMR=2706);
...
if(((((unsigned long)(unsigned char)((*(tyBoardAvailable)).tyAvl.bTopClearanceHeight)==(unsigned long)(unsigned char)1))&(((unsigned long)(unsigned char)((*(tyMachineReady)).tyAvl.bTopClearanceHeight)==(unsigned long)(unsigned char)1)))){

if(((((*(tyBoardAvailable)).tyData.rTopClearanceHeight)!=((*(tyMachineReady)).tyData.rTopClearanceHeight)))){

(__AS__fHermesChkParamBAMR=2707);
...
if(((((unsigned long)(unsigned char)((*(tyBoardAvailable)).tyAvl.bBottomClearanceHeight)==(unsigned long)(unsigned char)1))&(((unsigned long)(unsigned char)((*(tyMachineReady)).tyAvl.bBottomClearanceHeight)==(unsigned long)(unsigned char)1)))){

if(((((*(tyBoardAvailable)).tyData.rBottomClearanceHeight)!=((*(tyMachineReady)).tyData.rBottomClearanceHeight)))){

(__AS__fHermesChkParamBAMR=2708);
...
if(((((unsigned long)(unsigned char)((*(tyBoardAvailable)).tyAvl.bWeight)==(unsigned long)(unsigned char)1))&(((unsigned long)(unsigned char)((*(tyMachineReady)).tyAvl.bWeight)==(unsigned long)(unsigned char)1)))){

if(((((*(tyBoardAvailable)).tyData.rWeight)!=((*(tyMachineReady)).tyData.rWeight)))){

(__AS__fHermesChkParamBAMR=2709);
...
}imp1_else29_0:imp1_end29_0:imp1_else28_0:imp1_end28_0:imp1_else27_0:imp1_end27_0:;return __AS__fHermesChkParamBAMR;}
#line 156 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fHermesChkParamBAMR.nodebug"

void __AS__ImplInitfHermesChkParamBAMR_st(void){}
...
__asm__(".ascii \"iecfile \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/NtHermes/fHermesChkParamBAMR.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/NtHermes/fHermesChkParamBAMR.st.c\\\" \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fHermesChkParamBAMR.st\\\"\\n\"");
