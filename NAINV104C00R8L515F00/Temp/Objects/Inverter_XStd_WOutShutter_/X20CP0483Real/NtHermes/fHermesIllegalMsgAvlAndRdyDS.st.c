...
#include "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/NtHermes/fHermesIllegalMsgAvlAndRdyDSst.h"
#line 1 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fHermesIllegalMsgAvlAndRdyDS.nodebug"
#line 3 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fHermesIllegalMsgAvlAndRdyDS.st"
unsigned long fHermesIllegalMsgAvlAndRdyDS(struct tyHermesMsgType(* tyMsgType)){unsigned long __AS__fHermesIllegalMsgAvlAndRdyDS=0;{

if((((unsigned long)(unsigned char)((*(tyMsgType)).bServiceDescription)==(unsigned long)(unsigned char)1))){

(__AS__fHermesIllegalMsgAvlAndRdyDS=2880);

}else if((((unsigned long)(unsigned char)((*(tyMsgType)).bBoardAvailable)==(unsigned long)(unsigned char)1))){

(__AS__fHermesIllegalMsgAvlAndRdyDS=2881);

}else if((((unsigned long)(unsigned char)((*(tyMsgType)).bRevokeBoardAvailable)==(unsigned long)(unsigned char)1))){

(__AS__fHermesIllegalMsgAvlAndRdyDS=2882);

}else if((((unsigned long)(unsigned char)((*(tyMsgType)).bMachineReady)==(unsigned long)(unsigned char)1))){

(__AS__fHermesIllegalMsgAvlAndRdyDS=2883);

}else if((((unsigned long)(unsigned char)((*(tyMsgType)).bStopTransport)==(unsigned long)(unsigned char)1))){

(__AS__fHermesIllegalMsgAvlAndRdyDS=2884);

}else if((((unsigned long)(unsigned char)((*(tyMsgType)).bTransportFinished)==(unsigned long)(unsigned char)1))){

(__AS__fHermesIllegalMsgAvlAndRdyDS=2885);

}else if((((unsigned long)(unsigned char)((*(tyMsgType)).bBoardForecast)==(unsigned long)(unsigned char)1))){

(__AS__fHermesIllegalMsgAvlAndRdyDS=2886);

}else{

(__AS__fHermesIllegalMsgAvlAndRdyDS=0);

}

}imp1_end0_0:;return __AS__fHermesIllegalMsgAvlAndRdyDS;}
#line 39 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fHermesIllegalMsgAvlAndRdyDS.nodebug"

void __AS__ImplInitfHermesIllegalMsgAvlAndRdyDS_st(void){}
...
__asm__(".ascii \"iecfile \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/NtHermes/fHermesIllegalMsgAvlAndRdyDS.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/NtHermes/fHermesIllegalMsgAvlAndRdyDS.st.c\\\" \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fHermesIllegalMsgAvlAndRdyDS.st\\\"\\n\"");
