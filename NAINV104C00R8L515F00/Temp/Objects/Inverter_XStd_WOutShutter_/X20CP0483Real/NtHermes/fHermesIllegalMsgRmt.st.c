...
#include "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/NtHermes/fHermesIllegalMsgRmtst.h"
#line 1 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fHermesIllegalMsgRmt.nodebug"
#line 3 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fHermesIllegalMsgRmt.st"
unsigned long fHermesIllegalMsgRmt(struct tyHermesMsgType(* tyMsgType)){unsigned long __AS__fHermesIllegalMsgRmt=0;{

if((((unsigned long)(unsigned char)((*(tyMsgType)).bCheckAlive)==(unsigned long)(unsigned char)1))){

(__AS__fHermesIllegalMsgRmt=2925);

}else if((((unsigned long)(unsigned char)((*(tyMsgType)).bCheckAlivePing)==(unsigned long)(unsigned char)1))){

(__AS__fHermesIllegalMsgRmt=2926);

}else if((((unsigned long)(unsigned char)((*(tyMsgType)).bCheckAlivePong)==(unsigned long)(unsigned char)1))){

(__AS__fHermesIllegalMsgRmt=2927);

}else if((((unsigned long)(unsigned char)((*(tyMsgType)).bServiceDescription)==(unsigned long)(unsigned char)1))){

(__AS__fHermesIllegalMsgRmt=2928);

}else if((((unsigned long)(unsigned char)((*(tyMsgType)).bBoardAvailable)==(unsigned long)(unsigned char)1))){

(__AS__fHermesIllegalMsgRmt=2929);

}else if((((unsigned long)(unsigned char)((*(tyMsgType)).bRevokeBoardAvailable)==(unsigned long)(unsigned char)1))){

(__AS__fHermesIllegalMsgRmt=2930);

}else if((((unsigned long)(unsigned char)((*(tyMsgType)).bMachineReady)==(unsigned long)(unsigned char)1))){

(__AS__fHermesIllegalMsgRmt=2931);

}else if((((unsigned long)(unsigned char)((*(tyMsgType)).bRevokeMachineReady)==(unsigned long)(unsigned char)1))){

(__AS__fHermesIllegalMsgRmt=2932);

}else if((((unsigned long)(unsigned char)((*(tyMsgType)).bStartTransport)==(unsigned long)(unsigned char)1))){

(__AS__fHermesIllegalMsgRmt=2933);

}else if((((unsigned long)(unsigned char)((*(tyMsgType)).bStopTransport)==(unsigned long)(unsigned char)1))){

(__AS__fHermesIllegalMsgRmt=2934);

}else if((((unsigned long)(unsigned char)((*(tyMsgType)).bTransportFinished)==(unsigned long)(unsigned char)1))){

(__AS__fHermesIllegalMsgRmt=2935);

}else if((((unsigned long)(unsigned char)((*(tyMsgType)).bCurrentConfiguration)==(unsigned long)(unsigned char)1))){

(__AS__fHermesIllegalMsgRmt=2936);

}else if((((unsigned long)(unsigned char)((*(tyMsgType)).bBoardForecast)==(unsigned long)(unsigned char)1))){

(__AS__fHermesIllegalMsgRmt=2937);

}else if((((unsigned long)(unsigned char)((*(tyMsgType)).bQueryBoardInfo)==(unsigned long)(unsigned char)1))){

(__AS__fHermesIllegalMsgRmt=2938);

}else if((((unsigned long)(unsigned char)((*(tyMsgType)).bSendBoardInfo)==(unsigned long)(unsigned char)1))){

(__AS__fHermesIllegalMsgRmt=2939);

}else{

(__AS__fHermesIllegalMsgRmt=0);

}

}imp1_end0_0:;return __AS__fHermesIllegalMsgRmt;}
#line 71 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fHermesIllegalMsgRmt.nodebug"

void __AS__ImplInitfHermesIllegalMsgRmt_st(void){}
...
__asm__(".ascii \"iecfile \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/NtHermes/fHermesIllegalMsgRmt.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/NtHermes/fHermesIllegalMsgRmt.st.c\\\" \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fHermesIllegalMsgRmt.st\\\"\\n\"");
