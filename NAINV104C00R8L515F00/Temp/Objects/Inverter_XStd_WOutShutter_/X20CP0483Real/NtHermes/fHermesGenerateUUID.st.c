...
#include "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/NtHermes/fHermesGenerateUUIDst.h"
#line 1 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fHermesGenerateUUID.nodebug"
#line 3 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fHermesGenerateUUID.st"
plcbit fHermesGenerateUUID(plcstring p_sUUID[37], struct DTStructure(* tyDTStructure), unsigned char a_usiMacAddr[6]){plcbit __AS__fHermesGenerateUUID=0;signed long zzIndex00003;signed long zzIndex00002;signed long zzIndex00001;signed long zzIndex00000;plcstring sTemp2[3]="";plcstring sTemp4[5]="";{

(__AS__fHermesGenerateUUID=1);

__AS__MEMSET(((unsigned long)(p_sUUID)),0,37);


fConvertUSINTToHex(((unsigned long)(&sTemp2)),(unsigned char)(((*(tyDTStructure)).year)-1970));
{int zzIndex; plcstring* zzLValue=(plcstring*)p_sUUID; plcstring* zzRValue=(plcstring*)sTemp2; for(zzIndex=0; zzIndex<2l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};


fConvertUSINTToHex(((unsigned long)(&sTemp2)),((*(tyDTStructure)).month));
__AS__MEMCPY((((unsigned long)(p_sUUID))+LEN(p_sUUID)),((unsigned long)(&sTemp2)),2);


fConvertUSINTToHex(((unsigned long)(&sTemp2)),((*(tyDTStructure)).day));
__AS__MEMCPY((((unsigned long)(p_sUUID))+LEN(p_sUUID)),((unsigned long)(&sTemp2)),2);


fConvertUSINTToHex(((unsigned long)(&sTemp2)),((*(tyDTStructure)).hour));
__AS__MEMCPY((((unsigned long)(p_sUUID))+LEN(p_sUUID)),((unsigned long)(&sTemp2)),2);
__AS__MEMCPY((((unsigned long)(p_sUUID))+LEN(p_sUUID)),((unsigned long)(&"-")),1);


fConvertUSINTToHex(((unsigned long)(&sTemp2)),((*(tyDTStructure)).minute));
__AS__MEMCPY((((unsigned long)(p_sUUID))+LEN(p_sUUID)),((unsigned long)(&sTemp2)),2);


fConvertUSINTToHex(((unsigned long)(&sTemp2)),((*(tyDTStructure)).second));
__AS__MEMCPY((((unsigned long)(p_sUUID))+LEN(p_sUUID)),((unsigned long)(&sTemp2)),2);
__AS__MEMCPY((((unsigned long)(p_sUUID))+LEN(p_sUUID)),((unsigned long)(&"-")),1);


fConvertUINTToHex(((unsigned long)(&sTemp4)),((*(tyDTStructure)).millisec));
__AS__MEMCPY((((unsigned long)(p_sUUID))+LEN(p_sUUID)),((unsigned long)(&sTemp4)),4);
__AS__MEMCPY((((unsigned long)(p_sUUID))+LEN(p_sUUID)),((unsigned long)(&"-")),1);


fConvertUINTToHex(((unsigned long)(&sTemp4)),((*(tyDTStructure)).microsec));
__AS__MEMCPY((((unsigned long)(p_sUUID))+LEN(p_sUUID)),((unsigned long)(&sTemp4)),4);
__AS__MEMCPY((((unsigned long)(p_sUUID))+LEN(p_sUUID)),((unsigned long)(&"-")),1);


fConvertUSINTToHex(((unsigned long)(&sTemp2)),a_usiMacAddr[0]);
__AS__MEMCPY((((unsigned long)(p_sUUID))+LEN(p_sUUID)),((unsigned long)(&sTemp2)),2);

fConvertUSINTToHex(((unsigned long)(&sTemp2)),a_usiMacAddr[1]);
__AS__MEMCPY((((unsigned long)(p_sUUID))+LEN(p_sUUID)),((unsigned long)(&sTemp2)),2);

fConvertUSINTToHex(((unsigned long)(&sTemp2)),a_usiMacAddr[2]);
__AS__MEMCPY((((unsigned long)(p_sUUID))+LEN(p_sUUID)),((unsigned long)(&sTemp2)),2);

fConvertUSINTToHex(((unsigned long)(&sTemp2)),a_usiMacAddr[3]);
__AS__MEMCPY((((unsigned long)(p_sUUID))+LEN(p_sUUID)),((unsigned long)(&sTemp2)),2);

fConvertUSINTToHex(((unsigned long)(&sTemp2)),a_usiMacAddr[4]);
__AS__MEMCPY((((unsigned long)(p_sUUID))+LEN(p_sUUID)),((unsigned long)(&sTemp2)),2);

fConvertUSINTToHex(((unsigned long)(&sTemp2)),a_usiMacAddr[5]);
__AS__MEMCPY((((unsigned long)(p_sUUID))+LEN(p_sUUID)),((unsigned long)(&sTemp2)),2);

}return __AS__fHermesGenerateUUID;}
#line 64 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fHermesGenerateUUID.nodebug"

void __AS__ImplInitfHermesGenerateUUID_st(void){}
...
__asm__(".ascii \"iecfile \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/NtHermes/fHermesGenerateUUID.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/NtHermes/fHermesGenerateUUID.st.c\\\" \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fHermesGenerateUUID.st\\\"\\n\"");
