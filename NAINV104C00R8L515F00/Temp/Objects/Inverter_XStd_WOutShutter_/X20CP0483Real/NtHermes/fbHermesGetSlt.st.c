...
#include "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/NtHermes/fbHermesGetSltst.h"
#line 1 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fbHermesGetSlt.nodebug"
#line 3 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fbHermesGetSlt.st"
void fbHermesGetSlt(struct fbHermesGetSlt* inst){struct fbHermesGetSlt* __inst__=inst;{

if((((__inst__->rThicknessInMM<=0))|((__inst__->rTopClearanceHeightInMM<=0))|((__inst__->rBtmClearanceHeightInMM<=0))|(((signed long)__inst__->diTtlSlt<=(signed long)0))|(((signed long)__inst__->diSltToSltInUM<=(signed long)0)))){
(__inst__->diMinSltValue=0);
(__inst__->diMaxSltValue=0);
(__inst__->diPitch=0);
(__inst__->diSltToSltInUM=0);

}else{
(__inst__->diThicknessInUM=(signed long)((__inst__->rThicknessInMM*1000)>=0.0?(__inst__->rThicknessInMM*1000)+0.5:(__inst__->rThicknessInMM*1000)-0.5));
(__inst__->diTopClearanceHeightInUM=(signed long)((__inst__->rTopClearanceHeightInMM*1000)>=0.0?(__inst__->rTopClearanceHeightInMM*1000)+0.5:(__inst__->rTopClearanceHeightInMM*1000)-0.5));
(__inst__->diBtmClearanceHeightInUM=(signed long)((__inst__->rBtmClearanceHeightInMM*1000)>=0.0?(__inst__->rBtmClearanceHeightInMM*1000)+0.5:(__inst__->rBtmClearanceHeightInMM*1000)-0.5));

if((((signed long)__inst__->eFlippedBrd==(signed long)2))){

(__inst__->diMinSltValue=((((signed long)(__inst__->diTopClearanceHeightInUM))/((signed long)(__inst__->diSltToSltInUM)))+1));
(__inst__->diMaxSltValue=(__inst__->diTtlSlt-(((signed long)((__inst__->diBtmClearanceHeightInUM+__inst__->diThicknessInUM)))/((signed long)(__inst__->diSltToSltInUM)))));
(__inst__->diPitch=((((signed long)(((__inst__->diTopClearanceHeightInUM+__inst__->diBtmClearanceHeightInUM)+__inst__->diThicknessInUM)))/((signed long)(__inst__->diSltToSltInUM)))+1));

}else{

(__inst__->diMinSltValue=((((signed long)(__inst__->diBtmClearanceHeightInUM))/((signed long)(__inst__->diSltToSltInUM)))+1));
(__inst__->diMaxSltValue=(__inst__->diTtlSlt-(((signed long)((__inst__->diTopClearanceHeightInUM+__inst__->diThicknessInUM)))/((signed long)(__inst__->diSltToSltInUM)))));
(__inst__->diPitch=((((signed long)(((__inst__->diTopClearanceHeightInUM+__inst__->diBtmClearanceHeightInUM)+__inst__->diThicknessInUM)))/((signed long)(__inst__->diSltToSltInUM)))+1));
...
#line 32 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fbHermesGetSlt.nodebug"

void __AS__ImplInitfbHermesGetSlt_st(void){}
...
__asm__(".ascii \"iecfile \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/NtHermes/fbHermesGetSlt.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/NtHermes/fbHermesGetSlt.st.c\\\" \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fbHermesGetSlt.st\\\"\\n\"");
