...
#include "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/NtHermes/fbHermesCheckAliveSendPingst.h"
#line 1 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fbHermesCheckAliveSendPing.nodebug"
#line 3 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fbHermesCheckAliveSendPing.st"
void fbHermesCheckAliveSendPing(struct fbHermesCheckAliveSendPing* inst){struct fbHermesCheckAliveSendPing* __inst__=inst;{
...
(__inst__->fbSendTm.IN=1);;(__inst__->fbSendTm.PT=__inst__->tSendTm);;TON(&__inst__->fbSendTm);
if((((unsigned long)(unsigned char)__inst__->fbSendTm.Q==(unsigned long)(unsigned char)1))){
(__inst__->fbSendTm.IN=0);;TON(&__inst__->fbSendTm);

(__inst__->bDataSend=1);
(__inst__->tyDataSend.tyAvl.bType=1);
(__inst__->tyDataSend.tyAvl.bId=1);
(__inst__->tyDataSend.tyData.eType=1);
fHermesGetTimestamp(((unsigned long)(&__inst__->tyDataSend.tyData.sId)),&__inst__->tyDTStructure);

}else{
(__inst__->bDataSend=0);
}


(__inst__->fbRcvTO.IN=((__inst__->bDataRcv&~__inst__->zzEdge00000&1?((__inst__->zzEdge00000=__inst__->bDataRcv&1),1):((__inst__->zzEdge00000=__inst__->bDataRcv&1),0))^1));;(__inst__->fbRcvTO.PT=__inst__->tRcvTimeOut);;TON(&__inst__->fbRcvTO);
if((((unsigned long)(unsigned char)__inst__->fbRcvTO.Q==(unsigned long)(unsigned char)1))){
(__inst__->udiStatus=2768);
}

if((__inst__->bDataRcv&~__inst__->zzEdge00001&1?((__inst__->zzEdge00001=__inst__->bDataRcv&1),1):((__inst__->zzEdge00001=__inst__->bDataRcv&1),0))){
if(((__AS__STRING_CMP(__inst__->tyDataRcv.tyData.sId,__inst__->tyDataSend.tyData.sId)!=0))){
(__inst__->udiStatus=2769);
}
}
...
(__inst__->bDataSend=0);
__AS__MEMSET(((unsigned long)(&__inst__->tyDataSend)),0,92);

(__inst__->fbSendTm.IN=0);;TON(&__inst__->fbSendTm);
(__inst__->fbRcvTO.IN=0);;TON(&__inst__->fbRcvTO);

}

}imp1_else0_1:imp1_end0_0:;}
#line 48 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fbHermesCheckAliveSendPing.nodebug"

void __AS__ImplInitfbHermesCheckAliveSendPing_st(void){}
...
__asm__(".ascii \"iecfile \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/NtHermes/fbHermesCheckAliveSendPing.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/NtHermes/fbHermesCheckAliveSendPing.st.c\\\" \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fbHermesCheckAliveSendPing.st\\\"\\n\"");
