...
#include "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/NtHermes/fHermesParseCurrentConfigurationst.h"
#line 1 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fHermesParseCurrentConfiguration.nodebug"
#line 3 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fHermesParseCurrentConfiguration.st"
plcbit fHermesParseCurrentConfiguration(struct tyHermesCurrentConfiguration(* p_tyCurrentConfiguration), struct tyXMLTableDat(* tyXMLTableCurr), struct tyXMLTableDat(* tyXMLTableNxt), plcstring sCurrValueLowerCase[255], plcbit(* bUpstream), plcbit(* bDownstream)){plcbit __AS__fHermesParseCurrentConfiguration=0;{

(__AS__fHermesParseCurrentConfiguration=1);

if((((__AS__STRING_CMP(((*(tyXMLTableCurr)).sTitle),"AT")==0))&((__AS__STRING_CMP(sCurrValueLowerCase,"machineid")==0)))){

((*(p_tyCurrentConfiguration)).tyAvl.bMachineId=1);

if(((__AS__STRING_CMP(((*(tyXMLTableNxt)).sTitle),"AV")==0))){
{int zzIndex; plcstring* zzLValue=(plcstring*)((*(p_tyCurrentConfiguration)).tyData.sMachineId); plcstring* zzRValue=(plcstring*)((*(tyXMLTableNxt)).sValue); for(zzIndex=0; zzIndex<80l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
}

}else if((((__AS__STRING_CMP(((*(tyXMLTableCurr)).sTitle),"AT")==0))&((__AS__STRING_CMP(sCurrValueLowerCase,"supervisorysytemport")==0)))){

((*(p_tyCurrentConfiguration)).tyAvl.bSupervisorySystemPort=1);

if(((__AS__STRING_CMP(((*(tyXMLTableNxt)).sTitle),"AV")==0))){
((*(p_tyCurrentConfiguration)).tyData.uiSupervisorySystemPort=str2uint(((*(tyXMLTableNxt)).sValue)));
}

}else if((((__AS__STRING_CMP(((*(tyXMLTableCurr)).sTitle),"ST")==0))&((__AS__STRING_CMP(sCurrValueLowerCase,"upstreamconfigurations")==0)))){

((*(bUpstream))=1);
((*(bDownstream))=0);

}else if((((__AS__STRING_CMP(((*(tyXMLTableCurr)).sTitle),"ET")==0))&((__AS__STRING_CMP(sCurrValueLowerCase,"upstreamconfigurations")==0)))){

((*(bUpstream))=0);

}else if((((__AS__STRING_CMP(((*(tyXMLTableCurr)).sTitle),"ST")==0))&((__AS__STRING_CMP(sCurrValueLowerCase,"downstreamconfigurations")==0)))){

((*(bUpstream))=0);
((*(bDownstream))=1);

}else if((((__AS__STRING_CMP(((*(tyXMLTableCurr)).sTitle),"ET")==0))&((__AS__STRING_CMP(sCurrValueLowerCase,"downstreamconfigurations")==0)))){

((*(bDownstream))=0);

}else if((((unsigned long)(unsigned char)((*(bUpstream)))==(unsigned long)(unsigned char)1))){

if((((__AS__STRING_CMP(((*(tyXMLTableCurr)).sTitle),"ST")==0))&((__AS__STRING_CMP(sCurrValueLowerCase,"upstreamconfiguration")==0)))){

((*(p_tyCurrentConfiguration)).tyAvl.bUpstreamConfigurations=1);

((*(p_tyCurrentConfiguration)).tyAvl.iUpstreamConfigurations=(((*(p_tyCurrentConfiguration)).tyAvl.iUpstreamConfigurations)+1));
if((((signed long)(signed long)(short)((*(p_tyCurrentConfiguration)).tyAvl.iUpstreamConfigurations)>(signed long)(signed long)(short)3))){
((*(p_tyCurrentConfiguration)).tyAvl.iUpstreamConfigurations=3);
}

}else if((((signed long)(signed long)(short)((*(p_tyCurrentConfiguration)).tyAvl.iUpstreamConfigurations)!=(signed long)(signed long)(short)0))){

if((((__AS__STRING_CMP(((*(tyXMLTableCurr)).sTitle),"AT")==0))&((__AS__STRING_CMP(sCurrValueLowerCase,"upstreamlaneid")==0)))){

((*(p_tyCurrentConfiguration)).tyAvl.a_tyUpstreamConfigurations[(((*(p_tyCurrentConfiguration)).tyAvl.iUpstreamConfigurations)-1)].bUpstreamLaneId=1);

if(((__AS__STRING_CMP(((*(tyXMLTableNxt)).sTitle),"AV")==0))){
((*(p_tyCurrentConfiguration)).tyData.a_tyUpstreamConfigurations[(((*(p_tyCurrentConfiguration)).tyAvl.iUpstreamConfigurations)-1)].iUpstreamLaneId=str2int(((*(tyXMLTableNxt)).sValue)));
}

}else if((((__AS__STRING_CMP(((*(tyXMLTableCurr)).sTitle),"AT")==0))&((__AS__STRING_CMP(sCurrValueLowerCase,"upstreaminterfaceid")==0)))){

((*(p_tyCurrentConfiguration)).tyAvl.a_tyUpstreamConfigurations[(((*(p_tyCurrentConfiguration)).tyAvl.iUpstreamConfigurations)-1)].bUpstreamInterfaceId=1);

if(((__AS__STRING_CMP(((*(tyXMLTableNxt)).sTitle),"AV")==0))){
{int zzIndex; plcstring* zzLValue=(plcstring*)((*(p_tyCurrentConfiguration)).tyData.a_tyUpstreamConfigurations[(((*(p_tyCurrentConfiguration)).tyAvl.iUpstreamConfigurations)-1)].sUpstreamInterfaceId); plcstring* zzRValue=(plcstring*)((*(tyXMLTableNxt)).sValue); for(zzIndex=0; zzIndex<80l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
}

}else if((((__AS__STRING_CMP(((*(tyXMLTableCurr)).sTitle),"AT")==0))&((__AS__STRING_CMP(sCurrValueLowerCase,"hostaddress")==0)))){

((*(p_tyCurrentConfiguration)).tyAvl.a_tyUpstreamConfigurations[(((*(p_tyCurrentConfiguration)).tyAvl.iUpstreamConfigurations)-1)].bHostAddress=1);

if(((__AS__STRING_CMP(((*(tyXMLTableNxt)).sTitle),"AV")==0))){
{int zzIndex; plcstring* zzLValue=(plcstring*)((*(p_tyCurrentConfiguration)).tyData.a_tyUpstreamConfigurations[(((*(p_tyCurrentConfiguration)).tyAvl.iUpstreamConfigurations)-1)].sHostAddress); plcstring* zzRValue=(plcstring*)((*(tyXMLTableNxt)).sValue); for(zzIndex=0; zzIndex<254l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
}

}else if((((__AS__STRING_CMP(((*(tyXMLTableCurr)).sTitle),"AT")==0))&((__AS__STRING_CMP(sCurrValueLowerCase,"port")==0)))){

((*(p_tyCurrentConfiguration)).tyAvl.a_tyUpstreamConfigurations[(((*(p_tyCurrentConfiguration)).tyAvl.iUpstreamConfigurations)-1)].bPort=1);

if(((__AS__STRING_CMP(((*(tyXMLTableNxt)).sTitle),"AV")==0))){
((*(p_tyCurrentConfiguration)).tyData.a_tyUpstreamConfigurations[(((*(p_tyCurrentConfiguration)).tyAvl.iUpstreamConfigurations)-1)].uiPort=str2uint(((*(tyXMLTableNxt)).sValue)));
}
...
}else if((((unsigned long)(unsigned char)((*(bDownstream)))==(unsigned long)(unsigned char)1))){

if((((__AS__STRING_CMP(((*(tyXMLTableCurr)).sTitle),"ST")==0))&((__AS__STRING_CMP(sCurrValueLowerCase,"downstreamconfiguration")==0)))){

((*(p_tyCurrentConfiguration)).tyAvl.bDownstreamConfigurations=1);

((*(p_tyCurrentConfiguration)).tyAvl.iDownstreamConfigurations=(((*(p_tyCurrentConfiguration)).tyAvl.iDownstreamConfigurations)+1));
if((((signed long)(signed long)(short)((*(p_tyCurrentConfiguration)).tyAvl.iDownstreamConfigurations)>(signed long)(signed long)(short)3))){
((*(p_tyCurrentConfiguration)).tyAvl.iDownstreamConfigurations=3);
}

}else if((((signed long)(signed long)(short)((*(p_tyCurrentConfiguration)).tyAvl.iDownstreamConfigurations)!=(signed long)(signed long)(short)0))){

if((((__AS__STRING_CMP(((*(tyXMLTableCurr)).sTitle),"AT")==0))&((__AS__STRING_CMP(sCurrValueLowerCase,"downstreamlaneid")==0)))){

((*(p_tyCurrentConfiguration)).tyAvl.a_tyDownstreamConfigurations[(((*(p_tyCurrentConfiguration)).tyAvl.iDownstreamConfigurations)-1)].bDownstreamLaneId=1);

if(((__AS__STRING_CMP(((*(tyXMLTableNxt)).sTitle),"AV")==0))){
((*(p_tyCurrentConfiguration)).tyData.a_tyDownstreamConfigurations[(((*(p_tyCurrentConfiguration)).tyAvl.iDownstreamConfigurations)-1)].iDownstreamLaneId=str2int(((*(tyXMLTableNxt)).sValue)));
}

}else if((((__AS__STRING_CMP(((*(tyXMLTableCurr)).sTitle),"AT")==0))&((__AS__STRING_CMP(sCurrValueLowerCase,"downstreaminterfaceid")==0)))){

((*(p_tyCurrentConfiguration)).tyAvl.a_tyDownstreamConfigurations[(((*(p_tyCurrentConfiguration)).tyAvl.iDownstreamConfigurations)-1)].bDownstreamInterfaceId=1);

if(((__AS__STRING_CMP(((*(tyXMLTableNxt)).sTitle),"AV")==0))){
{int zzIndex; plcstring* zzLValue=(plcstring*)((*(p_tyCurrentConfiguration)).tyData.a_tyDownstreamConfigurations[(((*(p_tyCurrentConfiguration)).tyAvl.iDownstreamConfigurations)-1)].sDownstreamInterfaceId); plcstring* zzRValue=(plcstring*)((*(tyXMLTableNxt)).sValue); for(zzIndex=0; zzIndex<80l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
}

}else if((((__AS__STRING_CMP(((*(tyXMLTableCurr)).sTitle),"AT")==0))&((__AS__STRING_CMP(sCurrValueLowerCase,"clientaddress")==0)))){

((*(p_tyCurrentConfiguration)).tyAvl.a_tyDownstreamConfigurations[(((*(p_tyCurrentConfiguration)).tyAvl.iDownstreamConfigurations)-1)].bClientAddress=1);

if(((__AS__STRING_CMP(((*(tyXMLTableNxt)).sTitle),"AV")==0))){
{int zzIndex; plcstring* zzLValue=(plcstring*)((*(p_tyCurrentConfiguration)).tyData.a_tyDownstreamConfigurations[(((*(p_tyCurrentConfiguration)).tyAvl.iDownstreamConfigurations)-1)].sClientAddress); plcstring* zzRValue=(plcstring*)((*(tyXMLTableNxt)).sValue); for(zzIndex=0; zzIndex<254l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
}

}else if((((__AS__STRING_CMP(((*(tyXMLTableCurr)).sTitle),"AT")==0))&((__AS__STRING_CMP(sCurrValueLowerCase,"port")==0)))){

((*(p_tyCurrentConfiguration)).tyAvl.a_tyDownstreamConfigurations[(((*(p_tyCurrentConfiguration)).tyAvl.iDownstreamConfigurations)-1)].bPort=1);

if(((__AS__STRING_CMP(((*(tyXMLTableNxt)).sTitle),"AV")==0))){
((*(p_tyCurrentConfiguration)).tyData.a_tyDownstreamConfigurations[(((*(p_tyCurrentConfiguration)).tyAvl.iDownstreamConfigurations)-1)].uiPort=str2uint(((*(tyXMLTableNxt)).sValue)));
}
...
}imp1_else16_0:imp1_end16_0:imp1_else12_3:imp1_end12_0:imp1_else10_1:imp1_end10_0:imp1_else0_7:imp1_end0_0:;return __AS__fHermesParseCurrentConfiguration;}
#line 141 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fHermesParseCurrentConfiguration.nodebug"

void __AS__ImplInitfHermesParseCurrentConfiguration_st(void){}
...
__asm__(".ascii \"iecfile \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/NtHermes/fHermesParseCurrentConfiguration.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/NtHermes/fHermesParseCurrentConfiguration.st.c\\\" \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fHermesParseCurrentConfiguration.st\\\"\\n\"");
