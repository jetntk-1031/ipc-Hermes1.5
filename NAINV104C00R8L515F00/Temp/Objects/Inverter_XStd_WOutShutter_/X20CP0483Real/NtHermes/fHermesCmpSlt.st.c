...
#include "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/NtHermes/fHermesCmpSltst.h"
#line 1 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fHermesCmpSlt.nodebug"
#line 3 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fHermesCmpSlt.st"
unsigned long fHermesCmpSlt(eHermesFlippedBoard eHermesFlippedBrd, float rHermesThicknessInMM, float rHermesTopClearanceHeightInMM, float rHermesBtmClearanceHeightInMM, signed long diRcpMinSltValue, signed long diRcpMaxSltValue, signed long diRcpPitch, signed long diRcpSltToSltInUM, signed long diRcpTtlSlt){unsigned long __AS__fHermesCmpSlt=0;struct fbHermesGetSlt fbGetSlt={ 0, 0.00000000000000000000E+00, 0.00000000000000000000E+00, 0.00000000000000000000E+00, 0, 0, 0, 0, 0, 0, 0, 0 };{

(__AS__fHermesCmpSlt=0);

if((((signed long)diRcpMinSltValue<=(signed long)0))){
(__AS__fHermesCmpSlt=2914);

}else if((((signed long)diRcpMaxSltValue<=(signed long)0))){
(__AS__fHermesCmpSlt=2915);

}else if((((signed long)diRcpPitch<=(signed long)0))){
(__AS__fHermesCmpSlt=2916);

}else if((((signed long)diRcpSltToSltInUM<=(signed long)0))){
(__AS__fHermesCmpSlt=2917);

}else if((((signed long)diRcpTtlSlt<=(signed long)0))){
(__AS__fHermesCmpSlt=2918);

}else if(((rHermesThicknessInMM<=0))){
(__AS__fHermesCmpSlt=2919);

}else if(((rHermesTopClearanceHeightInMM<=0))){
(__AS__fHermesCmpSlt=2920);

}else if(((rHermesBtmClearanceHeightInMM<=0))){
(__AS__fHermesCmpSlt=2921);
...
if((((unsigned long)__AS__fHermesCmpSlt==(unsigned long)0))){
if((((signed long)diRcpMinSltValue<(signed long)fbGetSlt.diMinSltValue))){
(__AS__fHermesCmpSlt=2922);
}
}

if((((unsigned long)__AS__fHermesCmpSlt==(unsigned long)0))){
if((((signed long)diRcpMaxSltValue>(signed long)fbGetSlt.diMaxSltValue))){
(__AS__fHermesCmpSlt=2923);
}
}

if((((unsigned long)__AS__fHermesCmpSlt==(unsigned long)0))){
if((((signed long)diRcpPitch<(signed long)fbGetSlt.diPitch))){
(__AS__fHermesCmpSlt=2924);
}
}

}

}imp1_else6_0:imp1_end6_0:imp1_else5_0:imp1_end5_0:imp1_end0_0:;return __AS__fHermesCmpSlt;}
#line 60 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fHermesCmpSlt.nodebug"

void __AS__ImplInitfHermesCmpSlt_st(void){}
...
__asm__(".ascii \"iecfile \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/NtHermes/fHermesCmpSlt.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/NtHermes/fHermesCmpSlt.st.c\\\" \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fHermesCmpSlt.st\\\"\\n\"");
