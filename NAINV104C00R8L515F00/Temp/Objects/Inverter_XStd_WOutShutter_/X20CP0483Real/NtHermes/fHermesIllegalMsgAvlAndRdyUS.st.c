...
#include "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/NtHermes/fHermesIllegalMsgAvlAndRdyUSst.h"
#line 1 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fHermesIllegalMsgAvlAndRdyUS.nodebug"
#line 3 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fHermesIllegalMsgAvlAndRdyUS.st"
unsigned long fHermesIllegalMsgAvlAndRdyUS(struct tyHermesMsgType(* tyMsgType)){unsigned long __AS__fHermesIllegalMsgAvlAndRdyUS=0;{

if((((unsigned long)(unsigned char)((*(tyMsgType)).bServiceDescription)==(unsigned long)(unsigned char)1))){

(__AS__fHermesIllegalMsgAvlAndRdyUS=2809);

}else if((((unsigned long)(unsigned char)((*(tyMsgType)).bBoardAvailable)==(unsigned long)(unsigned char)1))){

(__AS__fHermesIllegalMsgAvlAndRdyUS=2810);

}else if((((unsigned long)(unsigned char)((*(tyMsgType)).bMachineReady)==(unsigned long)(unsigned char)1))){

(__AS__fHermesIllegalMsgAvlAndRdyUS=2811);

}else if((((unsigned long)(unsigned char)((*(tyMsgType)).bRevokeMachineReady)==(unsigned long)(unsigned char)1))){

(__AS__fHermesIllegalMsgAvlAndRdyUS=2812);

}else if((((unsigned long)(unsigned char)((*(tyMsgType)).bStartTransport)==(unsigned long)(unsigned char)1))){

(__AS__fHermesIllegalMsgAvlAndRdyUS=2813);

}else if((((unsigned long)(unsigned char)((*(tyMsgType)).bStopTransport)==(unsigned long)(unsigned char)1))){

(__AS__fHermesIllegalMsgAvlAndRdyUS=2814);

}else if((((unsigned long)(unsigned char)((*(tyMsgType)).bTransportFinished)==(unsigned long)(unsigned char)1))){

(__AS__fHermesIllegalMsgAvlAndRdyUS=2815);
...
(__AS__fHermesIllegalMsgAvlAndRdyUS=0);

}

}imp1_end0_0:;return __AS__fHermesIllegalMsgAvlAndRdyUS;}
#line 43 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fHermesIllegalMsgAvlAndRdyUS.nodebug"

void __AS__ImplInitfHermesIllegalMsgAvlAndRdyUS_st(void){}
...
__asm__(".ascii \"iecfile \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/NtHermes/fHermesIllegalMsgAvlAndRdyUS.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/NtHermes/fHermesIllegalMsgAvlAndRdyUS.st.c\\\" \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fHermesIllegalMsgAvlAndRdyUS.st\\\"\\n\"");
