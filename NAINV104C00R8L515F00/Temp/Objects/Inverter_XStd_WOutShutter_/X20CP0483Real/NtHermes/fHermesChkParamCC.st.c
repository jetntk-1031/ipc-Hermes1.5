...
#include "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/NtHermes/fHermesChkParamCCst.h"
#line 1 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fHermesChkParamCC.nodebug"
#line 3 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fHermesChkParamCC.st"
unsigned long fHermesChkParamCC(struct tyHermesCurrentConfiguration(* tyCurrentConfiguration), plcstring sMachineId[81]){unsigned long __AS__fHermesChkParamCC=0;signed long zzIndex00003;signed long zzIndex00002;signed long zzIndex00001;signed long zzIndex00000;signed short a_iIPPart[4]={0, 0, 0, 0};signed short i=0;{

(__AS__fHermesChkParamCC=0);

if((((unsigned long)__AS__fHermesChkParamCC==(unsigned long)0))){

if((((unsigned long)(unsigned char)((*(tyCurrentConfiguration)).tyAvl.bMachineId)==(unsigned long)(unsigned char)1))){

if(((__AS__STRING_CMP(((*(tyCurrentConfiguration)).tyData.sMachineId),sMachineId)!=0))){

(__AS__fHermesChkParamCC=2755);

}

}else{

(__AS__fHermesChkParamCC=2756);
...
for((i=0);i<=((*(tyCurrentConfiguration)).tyAvl.iUpstreamConfigurations);i+=1){

if((((unsigned long)(unsigned char)((*(tyCurrentConfiguration)).tyAvl.a_tyUpstreamConfigurations[i].bUpstreamLaneId)==(unsigned long)(unsigned char)1))){

if((((signed long)(signed long)(short)((*(tyCurrentConfiguration)).tyData.a_tyUpstreamConfigurations[i].iUpstreamLaneId)<=(signed long)(signed long)(short)0))){

(__AS__fHermesChkParamCC=2757);
goto imp1_endfor4_0;
...
(__AS__fHermesChkParamCC=2758);
goto imp1_endfor4_0;

}

if((((unsigned long)(unsigned char)((*(tyCurrentConfiguration)).tyAvl.a_tyUpstreamConfigurations[i].bHostAddress)==(unsigned long)(unsigned char)1))){

if((((unsigned long)fIPValid(((*(tyCurrentConfiguration)).tyData.a_tyUpstreamConfigurations[i].sHostAddress),((unsigned long)(&a_iIPPart)))==(unsigned long)(unsigned char)0))){

(__AS__fHermesChkParamCC=2759);
goto imp1_endfor4_0;
...
for((i=0);i<=((*(tyCurrentConfiguration)).tyAvl.iDownstreamConfigurations);i+=1){

if((((unsigned long)(unsigned char)((*(tyCurrentConfiguration)).tyAvl.a_tyDownstreamConfigurations[i].bDownstreamLaneId)==(unsigned long)(unsigned char)1))){

if((((signed long)(signed long)(short)((*(tyCurrentConfiguration)).tyData.a_tyDownstreamConfigurations[i].iDownstreamLaneId)<=(signed long)(signed long)(short)0))){

(__AS__fHermesChkParamCC=2761);
...
(__AS__fHermesChkParamCC=2762);
goto imp1_endfor10_0;

}

if((((unsigned long)(unsigned char)((*(tyCurrentConfiguration)).tyAvl.a_tyDownstreamConfigurations[i].bClientAddress)==(unsigned long)(unsigned char)1))){

if((((unsigned long)fIPValid(((*(tyCurrentConfiguration)).tyData.a_tyDownstreamConfigurations[i].sClientAddress),((unsigned long)(&a_iIPPart)))==(unsigned long)(unsigned char)0))){

(__AS__fHermesChkParamCC=2763);
goto imp1_endfor10_0;
...
}imp1_else9_0:imp1_end9_0:;return __AS__fHermesChkParamCC;}
#line 102 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fHermesChkParamCC.nodebug"

void __AS__ImplInitfHermesChkParamCC_st(void){}
...
__asm__(".ascii \"iecfile \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/NtHermes/fHermesChkParamCC.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/NtHermes/fHermesChkParamCC.st.c\\\" \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fHermesChkParamCC.st\\\"\\n\"");
