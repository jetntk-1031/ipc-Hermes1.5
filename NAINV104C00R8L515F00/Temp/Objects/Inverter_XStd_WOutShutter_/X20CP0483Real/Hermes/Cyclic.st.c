...
if(((((unsigned long)(unsigned char)((*(p_bLinkOpsInvertStepExitBrd)))==(unsigned long)(unsigned char)1))&(~((*(p_bLinkConvHvBrd)))&Edge0001100002&1?((Edge0001100002=((*(p_bLinkConvHvBrd)))&1),1):((Edge0001100002=((*(p_bLinkConvHvBrd)))&1),0)))){
(a_tyHermesBrdAvlData[1].bNewBrdAvl=1);
