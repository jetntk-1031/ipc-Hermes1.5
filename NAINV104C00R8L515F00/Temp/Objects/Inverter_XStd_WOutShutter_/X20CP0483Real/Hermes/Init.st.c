...
#include "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/Hermes/Initst.h"
#line 1 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/Hermes/Hermes/Init.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/Hermes/Hermes/Init.st"
...
(p_HermesStat=((unsigned long)(&eStat)));
(p_HermesStatus=((unsigned long)(&eStatus)));
(p_HermesStatTxt=((unsigned long)(&sStatTxt)));


(p_HermesAlmData=((unsigned long)(&tyAlmData)));


(p_HermesFileNotFound=((unsigned long)(&bFileNotFound)));
(p_HermesConfiguration=((unsigned long)(&tyCurrConfiguration)));
(p_HermesConfigurationWr=((unsigned long)(&tyConfigurationWr)));
(p_HermesUSParam1=((unsigned long)(&tyCurrConfiguration.a_tyUSParam[0])));
(p_HermesUSParam2=((unsigned long)(&tyCurrConfiguration.a_tyUSParam[1])));
(p_HermesUSParam3=((unsigned long)(&tyCurrConfiguration.a_tyUSParam[2])));
(p_HermesDSParam1=((unsigned long)(&tyCurrConfiguration.a_tyDSParam[0])));
(p_HermesDSParam2=((unsigned long)(&tyCurrConfiguration.a_tyDSParam[1])));
(p_HermesDSParam3=((unsigned long)(&tyCurrConfiguration.a_tyDSParam[2])));
(p_HermesSvyParam=((unsigned long)(&tyCurrConfiguration.tySvyParam)));
(p_HermesBrdAvlDataTable1stZ=((unsigned long)(&a_tyHermesBrdAvlData[1].a_tyXMLTableDataBrdAvl)));
(p_HermesBrdAvlDataTtlIdx1stZ=((unsigned long)(&a_tyHermesBrdAvlData[1].iXMLTableDataBrdAvlTtlIdx)));
(p_HermesBrdAvlDataNewBrdAvl1stZ=((unsigned long)(&a_tyHermesBrdAvlData[1].bNewBrdAvl)));
(p_HermesBrdAvlDataTableLastZ=((unsigned long)(&a_tyHermesBrdAvlData[1].a_tyXMLTableDataBrdAvl)));
(p_HermesBrdAvlDataTtlIdxLastZ=((unsigned long)(&a_tyHermesBrdAvlData[1].iXMLTableDataBrdAvlTtlIdx)));
(p_HermesBrdAvlDataNewBrdAvlLastZ=((unsigned long)(&a_tyHermesBrdAvlData[1].bNewBrdAvl)));

(p_HermesCmdInitialCompl=((unsigned long)(&bCmdInitialCompl)));


(pa_HermesDSParam=((unsigned long)(&tyCurrConfiguration.a_tyDSParam)));


(p_HermesReverseDS1SendBFId=((unsigned long)(&usiReverseDS1SndBfWBrdID)));
(p_HermesReverseDS2SendBFId=((unsigned long)(&usiReverseDS2SndBfWBrdID)));

(p_HermesSwitchtoReverseTransport=((unsigned long)(&bSwitchtoReverseTransport)));
(p_HermesEntToReversePosition=((unsigned long)(&bEntToReversePosition)));

}}
#line 45 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/Hermes/Hermes/Init.nodebug"
...
__asm__(".ascii \"iecfile \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/Hermes/Init.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XStd_WOutShutter_/X20CP0483/Hermes/Init.st.c\\\" \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/Hermes/Hermes/Init.st\\\"\\n\"");
__asm__(".previous");
