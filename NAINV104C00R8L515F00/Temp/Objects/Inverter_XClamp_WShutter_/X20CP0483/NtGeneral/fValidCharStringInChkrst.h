...
#ifndef __AS__TYPE_tyValidCharChkrInternal
#define __AS__TYPE_tyValidCharChkrInternal
...
_BUR_PUBLIC plcbit fValidCharStringInChkr(plcstring p_sMismatchChar[2], plcstring sInChk[256], plcstring sValidMember[129]);
