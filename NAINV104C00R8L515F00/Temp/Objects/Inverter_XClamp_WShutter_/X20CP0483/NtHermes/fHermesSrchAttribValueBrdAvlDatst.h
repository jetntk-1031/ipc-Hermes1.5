...
_BUR_PUBLIC plcbit fHermesSrchAttribValueBrdAvlDat(struct tyHermesBrdAvlDat(* p_tyHermesBrdAvlDat), plcstring sAttributeTiltle[81], plcstring sAttributeValue[81]);
