...
plcbit fHermesSrchAttribValueBrdAvlDat(struct tyHermesBrdAvlDat(* p_tyHermesBrdAvlDat), plcstring sAttributeTiltle[81], plcstring sAttributeValue[81]){plcbit __AS__fHermesSrchAttribValueBrdAvlDat=0;plcstring sTitleLowerCase[81]="";plcstring sLowerCase[81]="";signed short i=0;{

(__AS__fHermesSrchAttribValueBrdAvlDat=0);
...
{int zzIndex; plcstring* zzLValue=(plcstring*)sAttributeValue; plcstring* zzRValue=(plcstring*)((*(p_tyHermesBrdAvlDat)).a_tyXMLTableDataBrdAvl[(i+1)].sValue); for(zzIndex=0; zzIndex<80l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
