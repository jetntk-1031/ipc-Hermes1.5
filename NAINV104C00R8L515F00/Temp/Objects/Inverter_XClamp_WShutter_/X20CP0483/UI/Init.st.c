...
#include "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XClamp_WShutter_/X20CP0483/UI/Initst.h"
#line 1 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/UI/UI/Init.nodebug"
#line 2 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/UI/UI/Init.st"
...
(p_UIStat=((unsigned long)(&eStat)));
(p_UIStatus=((unsigned long)(&eStatus)));
(p_UIStatTxt=((unsigned long)(&sStatTxt)));




(p_UIStartupAct=((unsigned long)(&eStartupAct)));
(p_UIHWInfoAct=((unsigned long)(&eHWInfoAct)));
(p_UITLBuzAct=((unsigned long)(&eTLBuzAct)));
(p_UIRstErrAct=((unsigned long)(&eRstErrAct)));
(p_UIProdRcpAct=((unsigned long)(&eProdRcpAct)));
(p_UIMpProdRcpAct=((unsigned long)(&eMpProdRcpAct)));
(p_UIMcParamAct=((unsigned long)(&eMcParamAct)));
(p_UIUsrMgmtAct=((unsigned long)(&eUsrMgmtAct)));
(p_UIUSSMEMAAct=((unsigned long)(&eUSSMEMAAct)));
(p_UIDSSMEMAAct=((unsigned long)(&eDSSMEMAAct)));
(p_UIUSSMEMA2Act=((unsigned long)(&eUSSMEMA2Act)));
(p_UIStopperAct=((unsigned long)(&eStopperAct)));
(p_UIConvAct=((unsigned long)(&eConvAct)));
(p_UIAWOpenAct=((unsigned long)(&eAWOpenAct)));
(p_UIInvertAct=((unsigned long)(&eInvertAct)));
(p_UIOpsAct=((unsigned long)(&eOpsAct)));
(p_UIHermesAct=((unsigned long)(&eHermesAct)));
(p_UILFLeaderAct=((unsigned long)(&eLFLeaderAct)));
(p_UIDOAct=((unsigned long)(&eDOAct)));
(p_UIClampAct=((unsigned long)(&eClampAct)));
(p_UIInShutterAct=((unsigned long)(&eInShutterAct)));
(p_UIOutShutterAct=((unsigned long)(&eOutShutterAct)));
(p_UIClamp1Act=((unsigned long)(&eClamp1Act)));
(p_UIClamp2Act=((unsigned long)(&eClamp2Act)));
(p_UIClamp3Act=((unsigned long)(&eClamp3Act)));

(p_UIMcParamWr=((unsigned long)(&tyMcParamWr)));

(p_UIProdRcpInfoIn=((unsigned long)(&tyProdRcpInfoIn)));
(p_UIProdRcpSearch=((unsigned long)(&sProdRcpSearch)));
(p_UIProdRcpScan=((unsigned long)(&sProdRcpScan)));
(p_UIProdRcpCurrRcpWr=((unsigned long)(&tyProdRcpCurrRcpWr)));

(p_UIUsrMgmtInfoIn=((unsigned long)(&tyUsrMgmtInfoIn)));
(p_UIUsrMgmtAccessRightLvl1Wr=((unsigned long)(&tyUsrMgmtAccessRightLvl1Wr)));
(p_UIUsrMgmtAccessRightLvl2Wr=((unsigned long)(&tyUsrMgmtAccessRightLvl2Wr)));
(p_UIUsrMgmtAccessRightLvl3Wr=((unsigned long)(&tyUsrMgmtAccessRightLvl3Wr)));

(p_UIHermesUSParamWr=((unsigned long)(&a_tyHermesUSParamWr)));
(p_UIHermesDSParamWr=((unsigned long)(&a_tyHermesDSParamWr)));
(p_UIHermesSvyParamWr=((unsigned long)(&tyHermesSvyParamWr)));

(p_UISetIPAddr=((unsigned long)(&sSetIPAddr)));
(p_UISetSubnetMask=((unsigned long)(&sSetSubnetMask)));
(p_UINetworkMode=((unsigned long)(&usiNetworkModeSelected)));

(p_UIMnlMod=((unsigned long)(&bManualMod)));
(p_UIUIMnlMod=((unsigned long)(&bUIManualMod)));
(p_UIMuteBuz=((unsigned long)(&bMuteBuz)));

(p_UIMnlAWGoWidth=((unsigned long)(&diMnlAWGoWidth)));
(p_UIMnlAWNomSpd=((unsigned long)(&diMnlAWNomSpd)));
(p_UIMnlAWTargetPos=((unsigned long)(&diMnlAWTargetPos)));
(p_UIMnlAWStepSize=((unsigned long)(&diMnlAWStepSize)));
(p_UIMnlAWJogSpd=((unsigned long)(&diMnlAWJogSpd)));

(p_UIMnlInvertNomSpd=((unsigned long)(&diMnlInvertNomSpd)));
(p_UIMnlInvertTargetPos=((unsigned long)(&diMnlInvertTargetPos)));
(p_UIMnlInvertStepSize=((unsigned long)(&diMnlInvertStepSize)));
(p_UIMnlInvertJogSpd=((unsigned long)(&diMnlInvertJogSpd)));

(p_UIVSMEMAUSEn=((unsigned long)(&bVSMEMAUSEn)));
(p_UIVSMEMADSEn=((unsigned long)(&bVSMEMADSEn)));
(p_UIVSMEMAUBA=((unsigned long)(&bVSMEMAUBA)));
(p_UIVSMEMAUBAStat=((unsigned long)(&bVSMEMAUBAStat)));
(p_UIVSMEMADSB=((unsigned long)(&bVSMEMADSB)));

(p_UIVSMEMAUS2En=((unsigned long)(&bVSMEMAUS2En)));
(p_UIVSMEMAUBA2=((unsigned long)(&bVSMEMAUBA2)));
(p_UIVSMEMAUBAStat2=((unsigned long)(&bVSMEMAUBAStat2)));

(p_UILeaderRun=((unsigned long)(&bLeaderRun)));

(p_UIProdAccData=((unsigned long)(&bProdAccData)));

(p_UIOpsBypsInitConv=((unsigned long)(&bOpsBypsInitConv)));

(p_UIRlsNewProd=((unsigned long)(&bRlsNewProd)));

(p_UIConvDCCtrl=((unsigned long)(&tyP0931ConvInv.tyConvCom.tyBtnDCCtrl.bValue)));
...
(p_UIMismatchOverWriteConfig=((unsigned long)(&bMismatchOverWriteConfig)));
(p_UITempAddrFillDone=((unsigned long)(&bTempAddrFillDone)));
(p_UIIPConfigChgDone=((unsigned long)(&bIPConfigChgDone)));
(p_UIOverwriteIP=((unsigned long)(&bOverwriteIP)));
(p_UIOverwriteSubnet=((unsigned long)(&bOverwriteSubnet)));
(p_UIOverwriteEthMode=((unsigned long)(&bOverwriteEthMode)));


(p_UISongTitile=((unsigned long)(&uiSongIndex)));
(p_UISongPlay=((unsigned long)(&bSongEn)));


(p_UIBypassTopCover1=((unsigned long)(&bBypassTopCover1)));
(p_UIMachineSafetySigToDS=((unsigned long)(&bMachineSafetySigToDS)));
(p_UIMachineSafetySigToUS=((unsigned long)(&bMachineSafetySigToUS)));
(p_UISafetyTopCoverSWCoil1=((unsigned long)(&bTopCoverSwitchCoil1)));
(p_UITopCvrUnlckToUS=((unsigned long)(&bUnlockCover1Req)));
(p_UITopCvrUnlckToDS=((unsigned long)(&bUnlockCover1Req)));
(p_UICoverPBLED1=((unsigned long)(&bCoverPBLED1)));

(p_UIMnlModBypassTopCover1=((unsigned long)(&bMnlModBypassTopCover1)));
(p_UIMnlModMachineSafetySigToDS=((unsigned long)(&bMnlModMachineSafetySigToDS)));
(p_UIMnlModMachineSafetySigToUS=((unsigned long)(&bMnlModMachineSafetySigToDS)));
(p_UIMnlModSafetyTopCoverSWCoil1=((unsigned long)(&bMnlModTopCoverSwitch1)));
(p_UIMnlModTopCvrUnlckToUS=((unsigned long)(&bMnlModUnlockCover1Req)));
(p_UIMnlModTopCvrUnlckToDS=((unsigned long)(&bMnlModUnlockCover1Req)));
(p_UIMnlModCoverPBLED1=((unsigned long)(&bMnlModCoverPBLED1)));



(p_UIDSTranErr=((unsigned long)(&bDSTranErr)));


(p_UIRtnBrdReset=((unsigned long)(&bRtnBrdReset)));
(p_UIRtnBrdResetBtn=((unsigned long)(&tyP0200OpsGen.tyOps.tyBtnPCBReset.bValue)));

(p_UISimuAct=((unsigned long)(&eSimuAct)));
(p_UIMnlSimu=((unsigned long)(&bSimuMod)));

(P_UISectionLdr=((unsigned long)(&tyP1022McSetVComm.tyLF.tyBtnSectionLdr.bValue)));


(p_UISaveHMIConfigure=((unsigned long)(&bSaveHMIConfigure)));
(p_UISaveHMISvyConfig=((unsigned long)(&bSaveHMISvyConfig)));
(p_UIQueryBoardInfo=((unsigned long)(&bQueryBoardInfo)));



}}
#line 149 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/UI/UI/Init.nodebug"
...
__asm__(".ascii \"iecfile \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XClamp_WShutter_/X20CP0483/UI/Init.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XClamp_WShutter_/X20CP0483/UI/Init.st.c\\\" \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/UI/UI/Init.st\\\"\\n\"");
__asm__(".previous");
