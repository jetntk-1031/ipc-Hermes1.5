...
#include "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XClamp_WShutter_/X20CP0483/Hermes/Cyclicst.h"
...
if((a_bOpsDsStandByStep[usiZone-1]&~Edge0000400003&1?((Edge0000400003=a_bOpsDsStandByStep[usiZone-1]&1),1):((Edge0000400003=a_bOpsDsStandByStep[usiZone-1]&1),0))){
(a_bUIPromptActionSelect[usiZone-1]=1);
}

if((~a_bUIPromptActionSelect[usiZone-1]&Edge0000400004&1?((Edge0000400004=a_bUIPromptActionSelect[usiZone-1]&1),1):((Edge0000400004=a_bUIPromptActionSelect[usiZone-1]&1),0))){
...
if((((unsigned long)(unsigned char)a_bLinkOpsGConvStepInitDone[1][usiZone-1]==(unsigned long)(unsigned char)a_bLinkOpsGConvStepInitDone[0][usiZone-1]))){
(bCurrZoneConvInitDone=0);
}else{
if(a_bLinkOpsGConvStepInitDone[1][usiZone-1]){
(bCurrZoneConvInitDone=1);
}
(a_bLinkOpsGConvStepInitDone[0][usiZone-1]=a_bLinkOpsGConvStepInitDone[1][usiZone-1]);
}



if(((bCurrZoneConvInitDone&~Edge0000400005&1?((Edge0000400005=bCurrZoneConvInitDone&1),1):((Edge0000400005=bCurrZoneConvInitDone&1),0))&(((unsigned long)(unsigned char)a_bLinkOpsGConvHvBrd[1][usiZone-1]==(unsigned long)(unsigned char)0)))){
__AS__MEMSET(((unsigned long)(&a_tyActionReservedForZone[usiZone-1])),0,88);
}

if((((unsigned long)(unsigned char)usiZoneSupported==(unsigned long)(unsigned char)usiZone))){
(usiLeftmostBlockedZone=usiZoneSupported);
}
...
if((((unsigned long)(unsigned char)usiLeftmostBlockedZone<(unsigned long)(unsigned char)usiZone))){
(usiBrdChkZone=usiLeftmostBlockedZone);
}else{
(usiBrdChkZone=usiZone);
}

for((usiBrdZone=usiBrdChkZone);usiBrdZone>=1;usiBrdZone+=-1){


if((((unsigned long)(unsigned char)a_bLinkOpsGConvHvBrd[1][usiBrdZone-1]==(unsigned long)(unsigned char)a_bLinkOpsGConvHvBrd[0][usiBrdZone-1]))){
(bCurrZoneOpsGConvHvBrd=0);
}else{
if(a_bLinkOpsGConvHvBrd[1][usiBrdZone-1]){
(bCurrZoneOpsGConvHvBrd=1);
}
(a_bLinkOpsGConvHvBrd[0][usiBrdZone-1]=a_bLinkOpsGConvHvBrd[1][usiBrdZone-1]);
}



if(((bCurrZoneOpsGConvHvBrd&~Edge0000400006&1?((Edge0000400006=bCurrZoneOpsGConvHvBrd&1),1):((Edge0000400006=bCurrZoneOpsGConvHvBrd&1),0))&(((unsigned long)(unsigned char)a_bLinkOpsGConvStepInitDone[1][usiBrdZone-1]==(unsigned long)(unsigned char)1)))){

if(a_tyHermesBrdAvlData[usiBrdZone].bNewBrdAvl){
goto imp4_endfor13_0;
}
for((i=0);i<=200;i+=1){
if(((__AS__STRING_CMP(a_tyHermesBrdAvlData[usiBrdZone].a_tyXMLTableDataBrdAvl[i].sTitle,"AT")==0))){
fConvertToLower_254(((unsigned long)(&sLowerCase)),a_tyHermesBrdAvlData[usiBrdZone].a_tyXMLTableDataBrdAvl[i].sValue);
if(((__AS__STRING_CMP(sLowerCase,"boardid")==0))){
if(((__AS__STRING_CMP(a_tyHermesBrdAvlData[usiBrdZone].a_tyXMLTableDataBrdAvl[(i+1)].sTitle,"AV")==0))){
{int zzIndex; plcstring* zzLValue=(plcstring*)sTempBoardId; plcstring* zzRValue=(plcstring*)a_tyHermesBrdAvlData[usiBrdZone].a_tyXMLTableDataBrdAvl[(i+1)].sValue; for(zzIndex=0; zzIndex<80l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
}
}else if(((__AS__STRING_CMP(sLowerCase,"action")==0))){
if(((__AS__STRING_CMP(a_tyHermesBrdAvlData[usiBrdZone].a_tyXMLTableDataBrdAvl[(i+1)].sTitle,"AV")==0))){
if(((__AS__STRING_CMP(a_tyHermesBrdAvlData[usiBrdZone].a_tyXMLTableDataBrdAvl[(i+1)].sValue,"0")==0))){
goto imp4_endfor18_0;
}else{
(iActionOnBrd=str2int(a_tyHermesBrdAvlData[usiBrdZone].a_tyXMLTableDataBrdAvl[(i+1)].sValue));
if(((((signed long)(signed long)(short)1<=(signed long)(signed long)(short)iActionOnBrd))&(((signed long)(signed long)(short)iActionOnBrd<=(signed long)(unsigned char)usiMaxActionSupported)))){
...
(a_tyActionReservedForZone[usiZone-1].iAttributeIdx=(i+1));
{int zzIndex; plcstring* zzLValue=(plcstring*)a_tyActionReservedForZone[usiZone-1].sBoardId; plcstring* zzRValue=(plcstring*)sTempBoardId; for(zzIndex=0; zzIndex<80l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
}
}
}
}
...
__asm__(".ascii \"iecfile \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XClamp_WShutter_/X20CP0483/Hermes/Cyclic.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XClamp_WShutter_/X20CP0483/Hermes/Cyclic.st.c\\\" \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/Hermes/Hermes/Cyclic.st\\\"\\n\"");
