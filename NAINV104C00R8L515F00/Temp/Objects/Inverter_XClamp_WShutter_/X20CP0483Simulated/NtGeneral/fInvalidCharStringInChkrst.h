...
#ifndef __AS__TYPE_tyInvalidCharChkrInternal
#define __AS__TYPE_tyInvalidCharChkrInternal
...
_BUR_PUBLIC plcbit fInvalidCharStringInChkr(plcstring p_sInvalidChar[2], plcstring sInChk[256], plcstring sInvalidMember[129]);
