...
unsigned long fHermesChkParamCC(struct tyHermesCurrentConfiguration(* tyCurrentConfiguration), plcstring sMachineId[81]){unsigned long __AS__fHermesChkParamCC=0;signed long zzIndex00000;signed short a_iIPPart[4]={0, 0, 0, 0};signed short i=0;{
