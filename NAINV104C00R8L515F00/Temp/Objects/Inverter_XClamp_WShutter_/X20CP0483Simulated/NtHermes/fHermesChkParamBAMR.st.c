...
unsigned long fHermesChkParamBAMR(struct tyHermesBoardAvailable(* tyBoardAvailable), struct tyHermesMachineReady(* tyMachineReady)){unsigned long __AS__fHermesChkParamBAMR=0;signed long zzIndex00000;{
