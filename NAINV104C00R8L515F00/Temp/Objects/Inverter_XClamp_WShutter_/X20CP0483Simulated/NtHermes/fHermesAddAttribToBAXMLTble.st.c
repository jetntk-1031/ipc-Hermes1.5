...
#include "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XClamp_WShutter_/X20CP0483/NtHermes/fHermesAddAttribToBAXMLTblest.h"
#line 1 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fHermesAddAttribToBAXMLTble.nodebug"
#line 3 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fHermesAddAttribToBAXMLTble.st"
plcbit fHermesAddEditAttribToBAXMLTble(struct tyHermesBrdAvlDat(* p_tyHermesBrdAvlDat), plcstring sAttributeTiltle[81], plcstring sAttributeValue[81]){plcbit __AS__fHermesAddEditAttribToBAXMLTble=0;plcstring sTitleLowerCase[81]="";plcstring sLowerCase[81]="";signed short i=0;unsigned long udiHermesAttributeEndIdx=0;unsigned long udiHermesBAEndIdx=0;{

(__AS__fHermesAddEditAttribToBAXMLTble=0);
fConvertToLower_254(((unsigned long)(&sTitleLowerCase)),sAttributeTiltle);

for((i=0);i<=200;i+=1){
if(((__AS__STRING_CMP(((*(p_tyHermesBrdAvlDat)).a_tyXMLTableDataBrdAvl[i].sTitle),"AT")==0))){
fConvertToLower_254(((unsigned long)(&sLowerCase)),((*(p_tyHermesBrdAvlDat)).a_tyXMLTableDataBrdAvl[i].sValue));
if(((__AS__STRING_CMP(sLowerCase,sTitleLowerCase)==0))){
if(((__AS__STRING_CMP(((*(p_tyHermesBrdAvlDat)).a_tyXMLTableDataBrdAvl[(i+1)].sTitle),"AV")==0))){
{int zzIndex; plcstring* zzLValue=(plcstring*)((*(p_tyHermesBrdAvlDat)).a_tyXMLTableDataBrdAvl[(i+1)].sValue); plcstring* zzRValue=(plcstring*)sAttributeValue; for(zzIndex=0; zzIndex<80l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
goto imp1_endfor0_0;
}
}
}else if((((__AS__STRING_CMP(((*(p_tyHermesBrdAvlDat)).a_tyXMLTableDataBrdAvl[i].sTitle),"EN")==0))&((__AS__STRING_CMP(((*(p_tyHermesBrdAvlDat)).a_tyXMLTableDataBrdAvl[(i+1)].sTitle),"ST")==0)))){
fConvertToLower_254(((unsigned long)(&sLowerCase)),((*(p_tyHermesBrdAvlDat)).a_tyXMLTableDataBrdAvl[(i+1)].sValue));
if(((__AS__STRING_CMP(sLowerCase,"subboards")==0))){
(udiHermesAttributeEndIdx=i);
}
}else if((((__AS__STRING_CMP(((*(p_tyHermesBrdAvlDat)).a_tyXMLTableDataBrdAvl[i].sTitle),"ES")==0))&((__AS__STRING_CMP(((*(p_tyHermesBrdAvlDat)).a_tyXMLTableDataBrdAvl[(i+1)].sTitle),"ET")==0)))){
fConvertToLower_254(((unsigned long)(&sLowerCase)),((*(p_tyHermesBrdAvlDat)).a_tyXMLTableDataBrdAvl[(i+1)].sValue));
if(((__AS__STRING_CMP(sLowerCase,"hermes")==0))){
(udiHermesAttributeEndIdx=i);
}
}else if((((__AS__STRING_CMP(((*(p_tyHermesBrdAvlDat)).a_tyXMLTableDataBrdAvl[i].sTitle),"ET")==0))&((__AS__STRING_CMP(((*(p_tyHermesBrdAvlDat)).a_tyXMLTableDataBrdAvl[(i+1)].sTitle),"EN")==0)))){
fConvertToLower_254(((unsigned long)(&sLowerCase)),((*(p_tyHermesBrdAvlDat)).a_tyXMLTableDataBrdAvl[i].sValue));
if(((__AS__STRING_CMP(sLowerCase,"hermes")==0))){
...
__AS__MEMCPY((((unsigned long)(&((*(p_tyHermesBrdAvlDat)).a_tyXMLTableDataBrdAvl[udiHermesAttributeEndIdx])))+520),((unsigned long)(&((*(p_tyHermesBrdAvlDat)).a_tyXMLTableDataBrdAvl[udiHermesAttributeEndIdx]))),((udiHermesBAEndIdx-udiHermesAttributeEndIdx)*260));
{int zzIndex; plcstring* zzLValue=(plcstring*)((*(p_tyHermesBrdAvlDat)).a_tyXMLTableDataBrdAvl[udiHermesAttributeEndIdx].sTitle); plcstring* zzRValue=(plcstring*)"AT"; for(zzIndex=0; zzIndex<2l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
{int zzIndex; plcstring* zzLValue=(plcstring*)((*(p_tyHermesBrdAvlDat)).a_tyXMLTableDataBrdAvl[udiHermesAttributeEndIdx].sValue); plcstring* zzRValue=(plcstring*)sAttributeTiltle; for(zzIndex=0; zzIndex<80l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
...
{int zzIndex; plcstring* zzLValue=(plcstring*)((*(p_tyHermesBrdAvlDat)).a_tyXMLTableDataBrdAvl[(udiHermesAttributeEndIdx+1)].sTitle); plcstring* zzRValue=(plcstring*)"AV"; for(zzIndex=0; zzIndex<2l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
{int zzIndex; plcstring* zzLValue=(plcstring*)((*(p_tyHermesBrdAvlDat)).a_tyXMLTableDataBrdAvl[(udiHermesAttributeEndIdx+1)].sValue); plcstring* zzRValue=(plcstring*)sAttributeValue; for(zzIndex=0; zzIndex<80l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
...
}imp1_else7_0:imp1_end7_0:;return __AS__fHermesAddEditAttribToBAXMLTble;}
#line 46 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fHermesAddAttribToBAXMLTble.nodebug"

void __AS__ImplInitfHermesAddAttribToBAXMLTble_st(void){}
...
__asm__(".ascii \"iecfile \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XClamp_WShutter_/X20CP0483/NtHermes/fHermesAddAttribToBAXMLTble.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XClamp_WShutter_/X20CP0483/NtHermes/fHermesAddAttribToBAXMLTble.st.c\\\" \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fHermesAddAttribToBAXMLTble.st\\\"\\n\"");
...
__asm__(".ascii \"plcexport \\\"fHermesGenerateBAXmlTbl\\\" FUN\\n\"");
__asm__(".ascii \"plcexport \\\"fHermesAddEditAttribToBAXMLTble\\\" FUN\\n\"");
