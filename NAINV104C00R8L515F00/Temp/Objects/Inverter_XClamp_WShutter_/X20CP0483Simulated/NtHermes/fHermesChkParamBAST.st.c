...
unsigned long fHermesChkParamBAST(struct tyHermesBoardAvailable(* tyBoardAvailable), struct tyHermesStartTransport(* tyStartTransport)){unsigned long __AS__fHermesChkParamBAST=0;signed long zzIndex00000;{
