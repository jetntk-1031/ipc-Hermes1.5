...
#include "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XClamp_WShutter_/X20CP0483/NtHermes/fHermesParseSServiceDescriptionst.h"
#line 1 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fHermesParseSServiceDescription.nodebug"
#line 3 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fHermesParseSServiceDescription.st"
plcbit fHermesParseSServiceDescription(struct tyHermesSServiceDescription(* p_tySServiceDescription), struct tyXMLTableDat(* tyXMLTableCurr), struct tyXMLTableDat(* tyXMLTableNxt), plcstring sCurrValueLowerCase[255]){plcbit __AS__fHermesParseSServiceDescription=0;{

(__AS__fHermesParseSServiceDescription=1);

if((((__AS__STRING_CMP(((*(tyXMLTableCurr)).sTitle),"AT")==0))&((__AS__STRING_CMP(sCurrValueLowerCase,"systemid")==0)))){

((*(p_tySServiceDescription)).tyAvl.bSystemId=1);

if(((__AS__STRING_CMP(((*(tyXMLTableNxt)).sTitle),"AV")==0))){
{int zzIndex; plcstring* zzLValue=(plcstring*)((*(p_tySServiceDescription)).tyData.sSystemId); plcstring* zzRValue=(plcstring*)((*(tyXMLTableNxt)).sValue); for(zzIndex=0; zzIndex<80l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
}


}else if((((__AS__STRING_CMP(((*(tyXMLTableCurr)).sTitle),"AT")==0))&((__AS__STRING_CMP(sCurrValueLowerCase,"version")==0)))){

((*(p_tySServiceDescription)).tyAvl.bVersion=1);

if(((__AS__STRING_CMP(((*(tyXMLTableNxt)).sTitle),"AV")==0))){
{int zzIndex; plcstring* zzLValue=(plcstring*)((*(p_tySServiceDescription)).tyData.sVersion); plcstring* zzRValue=(plcstring*)((*(tyXMLTableNxt)).sValue); for(zzIndex=0; zzIndex<7l && zzRValue[zzIndex]!=0; zzIndex++) zzLValue[zzIndex] = zzRValue[zzIndex]; zzLValue[zzIndex] = 0;};
}

}else if((((__AS__STRING_CMP(((*(tyXMLTableCurr)).sTitle),"ST")==0))&((__AS__STRING_CMP(sCurrValueLowerCase,"supportedfeatures")==0)))){

((*(p_tySServiceDescription)).tyAvl.bSupportedFeatures=1);

}else if((((__AS__STRING_CMP(((*(tyXMLTableCurr)).sTitle),"ST")==0))&((__AS__STRING_CMP(sCurrValueLowerCase,"featureconfiguration")==0)))){

((*(p_tySServiceDescription)).tyAvl.tySupportedFeatures.bFeatureConfiguration=1);
((*(p_tySServiceDescription)).tyData.tySupportedFeatures.bFeatureConfiguration=1);

}else if((((__AS__STRING_CMP(((*(tyXMLTableCurr)).sTitle),"ST")==0))&((__AS__STRING_CMP(sCurrValueLowerCase,"featurecheckaliveresponse")==0)))){

((*(p_tySServiceDescription)).tyAvl.tySupportedFeatures.bFeatureCheckAliveResponse=1);
((*(p_tySServiceDescription)).tyData.tySupportedFeatures.bFeatureCheckAliveResponse=1);

}else if((((__AS__STRING_CMP(((*(tyXMLTableCurr)).sTitle),"ST")==0))&((__AS__STRING_CMP(sCurrValueLowerCase,"featureboardtracking")==0)))){

((*(p_tySServiceDescription)).tyAvl.tySupportedFeatures.bFeatureBoardTracking=1);
((*(p_tySServiceDescription)).tyData.tySupportedFeatures.bFeatureBoardTracking=1);

}else if((((__AS__STRING_CMP(((*(tyXMLTableCurr)).sTitle),"ST")==0))&((__AS__STRING_CMP(sCurrValueLowerCase,"featurequeryworkorderinfo")==0)))){

((*(p_tySServiceDescription)).tyAvl.tySupportedFeatures.bFeatureQueryWorkOrderInfo=1);
((*(p_tySServiceDescription)).tyData.tySupportedFeatures.bFeatureQueryWorkOrderInfo=1);

}else if((((__AS__STRING_CMP(((*(tyXMLTableCurr)).sTitle),"ST")==0))&((__AS__STRING_CMP(sCurrValueLowerCase,"featuresendworkorderinfo")==0)))){

((*(p_tySServiceDescription)).tyAvl.tySupportedFeatures.bFeatureSendWorkOrderInfo=1);
((*(p_tySServiceDescription)).tyData.tySupportedFeatures.bFeatureSendWorkOrderInfo=1);

}else if((((__AS__STRING_CMP(((*(tyXMLTableCurr)).sTitle),"ST")==0))&((__AS__STRING_CMP(sCurrValueLowerCase,"featurereplyworkorderinfo")==0)))){

((*(p_tySServiceDescription)).tyAvl.tySupportedFeatures.bFeatureReplyWorkOrderInfo=1);
((*(p_tySServiceDescription)).tyData.tySupportedFeatures.bFeatureReplyWorkOrderInfo=1);

}

}imp1_else0_8:imp1_end0_0:;return __AS__fHermesParseSServiceDescription;}
#line 60 "C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fHermesParseSServiceDescription.nodebug"

void __AS__ImplInitfHermesParseSServiceDescription_st(void){}
...
__asm__(".ascii \"iecfile \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XClamp_WShutter_/X20CP0483/NtHermes/fHermesParseSServiceDescription.st.var\\\" scope \\\"local\\\"\\n\"");
__asm__(".ascii \"plcreplace \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Temp/Objects/Inverter_XClamp_WShutter_/X20CP0483/NtHermes/fHermesParseSServiceDescription.st.c\\\" \\\"C:/Users/wongjl/Desktop/job/Hermes 1_5 29_8_2023/inverter/ipc-Hermes1.5/NAINV104C00R8L515F00/Logical/NtLibraries/NtHermes/fHermesParseSServiceDescription.st\\\"\\n\"");
