...
_BUR_PUBLIC plcbit fConvertUINTToHex(plcstring p_sHexOut[5], unsigned short uiDecimalIn);
_BUR_PUBLIC plcbit fConvertUSINTToHex(plcstring p_sHexOut[3], unsigned char usiDecimalIn);
