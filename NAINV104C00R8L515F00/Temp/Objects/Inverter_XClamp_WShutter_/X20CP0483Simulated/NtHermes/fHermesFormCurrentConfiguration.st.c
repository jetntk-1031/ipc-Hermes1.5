...
signed short fHermesFormCurrentConfiguration(struct tyXMLTableDat pa_tyXMLTable[200], struct DTStructure(* tyDTStructure), struct tyHermesCurrentConfiguration(* tyParameter)){signed short __AS__fHermesFormCurrentConfiguration=0;signed long zzIndex00000;signed short i=0;signed short iConfiguration1=0;signed short iConfiguration=0;signed short iTotalIdxWrite=0;plcstring sTimestamp[24]="";{
