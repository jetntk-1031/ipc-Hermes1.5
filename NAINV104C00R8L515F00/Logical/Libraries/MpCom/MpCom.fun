...
FUNCTION_BLOCK MpComConfigManager (*Export / Import configuration data*) (* $GROUP=mapp,$CAT=mapp Link,$GROUPICON=Icon_mapp.png,$CATICON=Icon_MpCom.png *)
	VAR_INPUT
...
FUNCTION_BLOCK MpComLoggerUI (*Get mapp logger information*) (* $GROUP=mapp,$CAT=mapp Link,$GROUPICON=Icon_mapp.png,$CATICON=Icon_MpCom.png *)
	VAR_INPUT
		MpLink : REFERENCE TO MpComIdentType; (*Incoming communication handle (map standard interface)*) (* *) (*#PAR#;*)
		Enable : BOOL; (*Enables/Disables the function block (mapp standard interface)*) (* *) (*#PAR#;*)
		ErrorReset : BOOL; (*Resets all function block errors (mapp standard interface)*) (* *) (*#PAR#;*)
...
FUNCTION MpComLink : DINT (*Creates a hierarchy for the mapp components*) (* $GROUP=mapp,$CAT=mapp Link,$GROUPICON=Icon_mapp.png,$CATICON=Icon_MpCom.png *)
	VAR_INPUT
...
FUNCTION_BLOCK MpComLinkToParent (*Creates a hierarchy for the mapp components*) (* $GROUP=mapp,$CAT=mapp Link,$GROUPICON=Icon_mapp.png,$CATICON=Icon_MpCom.png *)
	VAR_INPUT
		ParentLink : MpComIdentType; (*Link to parent*) (* *) (*#PAR#;*)
...
FUNCTION_BLOCK MpComDump (*Creates a mapp diagnostic dump file*) (* $GROUP=mapp,$CAT=mapp Link,$GROUPICON=Icon_mapp.png,$CATICON=Icon_MpCom.png *)
	VAR_INPUT
