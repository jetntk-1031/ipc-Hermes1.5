 ...
 * Author:  B+R
 ********************************************************************
 * Functions and function blocks of library AsOpcUac
 ********************************************************************)
                                                                      
FUNCTION_BLOCK UA_Connect
	VAR_INPUT
		Execute	           		: BOOL;
...
FUNCTION_BLOCK UA_GetNamespaceIndex
	VAR_INPUT
		Execute	           		: BOOL;
		ConnectionHdl      		: DWORD;
...
FUNCTION_BLOCK UA_TranslatePath
	VAR_INPUT
		Execute	           		: BOOL;
		ConnectionHdl      		: DWORD;
...
FUNCTION_BLOCK UA_NodeGetHandle
	VAR_INPUT
		Execute	           	 	: BOOL;
		ConnectionHdl      	 	: DWORD;
		NodeID					: UANodeID;
...
FUNCTION_BLOCK UA_NodeGetHandleList
	VAR_INPUT
		Execute	           	 	: BOOL;
		ConnectionHdl      	 	: DWORD;
		NodeIDCount				: UINT;
...
FUNCTION_BLOCK UA_NodeReleaseHandle
	VAR_INPUT
		Execute	           		: BOOL;
		ConnectionHdl      		: DWORD;
		NodeHdl      	 		: DWORD;
...
FUNCTION_BLOCK UA_NodeReleaseHandleList
	VAR_INPUT
		Execute	           		: BOOL;
		ConnectionHdl      		: DWORD;
		NodeHdlCount   	 		: UINT;
...
FUNCTION_BLOCK UA_SubscriptionCreate
	VAR_INPUT
		Execute	           		: BOOL;
		ConnectionHdl      		: DWORD;
...
FUNCTION_BLOCK UA_SubscriptionDelete
	VAR_INPUT
		Execute	           		: BOOL;
		SubscriptionHdl			: DWORD;
		Timeout            		: TIME;
...
FUNCTION_BLOCK UA_SubscriptionOperate
	VAR_INPUT
		Execute	           		: BOOL;
		SubscriptionHdl			: DWORD;
		PublishingEnable  		: BOOL;
...
FUNCTION_BLOCK UA_MonitoredItemAdd
	VAR_INPUT
		Execute	           		: BOOL;
		SubscriptionHdl			: DWORD;
		NodeHdl					: DWORD;
...
FUNCTION_BLOCK UA_MonitoredItemAddList
	VAR_INPUT
		Execute	           		: BOOL;
		SubscriptionHdl			: DWORD;
		NodeHdlCount			: UINT;
...
FUNCTION_BLOCK UA_MonitoredItemRemove
	VAR_INPUT
		Execute	           		: BOOL;
		MonitoredItemHdl		: DWORD;
		Timeout            		: TIME;
...
FUNCTION_BLOCK UA_MonitoredItemRemoveList
	VAR_INPUT
		Execute	           		: BOOL;
		SubscriptionHdl			: DWORD;
...
FUNCTION_BLOCK UA_MonitoredItemOperate
	VAR_INPUT
		Execute	           		: BOOL;
		MonitoredItemHdl		: DWORD;
		Timeout            		: TIME;
...
FUNCTION_BLOCK UA_MonitoredItemOperateList
	VAR_INPUT
		Execute	           		: BOOL;
		SubscriptionHdl			: DWORD;
		MonitoredItemHdlCount	: UINT;
...
FUNCTION_BLOCK UA_EventItemAdd
	VAR_INPUT
		Execute	           		: BOOL;
		SubscriptionHdl			: DWORD;
		NodeHdl					: DWORD;
...
FUNCTION_BLOCK UA_EventItemRemove
	VAR_INPUT
		Execute	           		: BOOL;
		SubscriptionHdl			: DWORD;
		EventItemHdl			: DWORD;
...
FUNCTION_BLOCK UA_EventItemOperate
	VAR_INPUT
		Execute	           		: BOOL;
		SubscriptionHdl			: DWORD;
		EventItemHdl			: DWORD;
...
FUNCTION_BLOCK UaClt_WriteBulk
	VAR_INPUT
		Execute	           		: BOOL;
		ConnectionHdl      		: DWORD;
		NodeIDCount				: UINT;
...
FUNCTION_BLOCK UA_MethodGetHandle
	VAR_INPUT
		Execute	           		: BOOL;
		ConnectionHdl      		: DWORD;
...
FUNCTION_BLOCK UA_MethodReleaseHandle
	VAR_INPUT
		Execute	           		: BOOL;
		ConnectionHdl      		: DWORD;
		MethodHdl				: DWORD;
...
FUNCTION_BLOCK UA_ConnectionGetStatus
	VAR_INPUT
		Execute	           		: BOOL;
		ConnectionHdl      		: DWORD;
		Timeout            		: TIME;
