...
<Program Version="1.00.0" xmlns="http://br-automation.co.at/AS/Program">
  <Files>
    ...
    <File Description="Do Not Change!!!">Act_Background_ChkRlsBrd.st</File>
    <File Description="Do Not Change!!!">Act_Background_UpdtData.st</File>
    <File Description="Do Not Change!!!">Act_Background_AccData.st</File>
